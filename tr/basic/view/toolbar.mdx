...
**Görünümü paylaş**, geçerli görünümü bağlantı olarak yayımlar. Ziyaretçiler bu görünümdeki verileri ve düzeni görür. Bu işlem, onları proje ortak çalışanı olarak davet etmekle aynı değildir.

<Note>Bir projenin tamamını, belirli bir tabloyu veya klasörü paylaşmak için [Proje](/tr/basic/base) sayfasındaki proje paylaşımını kullanın.</Note>
...
| Parolayla kısıtla | Tüm görünüm paylaşımları | Paylaşım bağlantısına parola ekler. Ziyaretçilerin bağlantıyı açmadan önce doğru parolayı girmesi gerekir. Açıldığında rastgele bir parola otomatik olarak oluşturulur ve **Bağlantıyı ve şifreyi kopyala** ile bağlantıyla birlikte kopyalanabilir |
...
- Görünümü paylaş, tam proje izinlerini değil geçerli görünümün sonucunu yayımlar. Sürekli iş birliği için üye izinlerini veya proje paylaşımını kullanın.
