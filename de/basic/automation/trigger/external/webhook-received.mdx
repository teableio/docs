...
Am einfachsten testen Sie den Webhook mit `curl` über die Befehlszeile. Kopieren Sie die echte URL aus dem Auslöserbereich, anstatt sie einzutippen; sie enthält die Projekt- und Workflow-IDs.
...
| Umfang | Begrenzung |
|---|---|
| Pro Projekt | 50 Anfragen/Sekunde |
