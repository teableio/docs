...
2. Kaydın oluşturulmasını istediğiniz **Tabloyu** seçin. Varsayılan olarak bu, aynı Projedeki bir tablodur; ancak başka bir Projedeki tabloyu hedeflemek için [Projeler Arası Erişim](/tr/basic/automation/actions/records/cross-base) özelliğini kullanabilirsiniz.
...
- Hedef tablo otomasyonun bulunduğu Projeden farklı bir Projedeyse [Projeler Arası Erişim](/tr/basic/automation/actions/records/cross-base) özelliğini kullanın.
...
- [Projeleri arası erişim](/tr/basic/automation/actions/records/cross-base) — geçerli Projenin dışındaki tablolarda kayıt oluşturun
