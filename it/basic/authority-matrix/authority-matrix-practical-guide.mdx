...
Questa guida utilizza un Progetto di vendita con tre Tabelle: `Clienti`, `Ordini di vendita`
e `Prodotti`. L'obiettivo è consentire a ogni ruolo di lavorare con i dati necessari
senza esporre l'intero Progetto.
...
<Steps>
  <Step title="Abilita la Matrice di autorità">
    Apri la pagina Matrice di autorità nel Progetto e attiva l'interruttore principale. L'utente
