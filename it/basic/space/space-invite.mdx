...
Quando condividi uno Spazio con un altro utente, quest'ultimo diventa collaboratore dello Spazio e può accedere a tutte i Progetti presenti al suo interno.
...
4. **Invito tramite email**: inserisci un indirizzo email o più indirizzi separati da virgole. Imposta quindi il livello di autorizzazione da assegnare agli utenti per tutte i Progetti dello Spazio. Infine, fai clic su Invia email per invitare gli utenti a collaborare.
...
5. **Invito tramite link**: fai clic sull'opzione «Invita tramite link». Imposta quindi il livello di autorizzazione che il link di invito concederà per tutte i Progetti dello Spazio. Infine, fai clic su Crea link. Ora puoi fare clic sull'icona degli appunti accanto al link creato per condividerlo nel modo che preferisci.
...
<Note>I collaboratori dello Spazio hanno accesso a tutte i Progetti dello Spazio. Se qualcuno deve lavorare soltanto in Progetti specifiche, valuta di aggiungerlo come [Collaboratore del Progetto](/it/basic/space/base-invite).</Note>
...
* **Ambito**: la rimozione di una persona dallo Spazio non rimuove le autorizzazioni che possiede nelle singole Progetti.
...
Ogni persona o reparto viene visualizzato una sola volta nell'elenco dei collaboratori dello Spazio, anche quando dispone di autorizzazioni per singole Progetti. Un badge **Autorizzazioni Progetto** accanto al ruolo mostra a quante Progetti è stata invitata. Chi non è mai stato aggiunto allo Spazio viene indicato come **Ha accesso soltanto ai Progetti selezionate**.

Espandi una riga per vedere tali Progetti e il ruolo ricoperto in ciascuna. Da qui, **Rimuovi accesso al Progetto** revoca una singola autorizzazione del Progetto, mentre **Rimuovi collaboratore** in una riga relativa soltanto ai Progetti revoca tutte le autorizzazioni possedute dalla persona nello Spazio.
