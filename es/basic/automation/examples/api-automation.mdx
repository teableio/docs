...
- El ID de tu Proyecto, el ID de la Tabla y los ID de los Campos. Consulta [Obtener ID](/es/api-doc/get-id).
...
- Utiliza el PAT con menos privilegios posibles: limítalo a los Espacios y los Proyectos que necesite.
