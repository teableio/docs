...
Apri il menu delle azioni di un utente e seleziona **Sessions** per vedere i dispositivi su cui l'utente ha effettuato l'accesso e la sua cronologia degli accessi. Fai clic su **Sign out** per un singolo dispositivo, oppure su **Sign out all devices**, per obbligare l'utente ad accedere di nuovo. Se l'account non è disattivato, l'utente può accedere di nuovo.
