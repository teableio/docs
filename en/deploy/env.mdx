...
<Note>
If you deploy with the full-featured assets (Docker all-in-one or the Helm
chart), the **AI & App Builder** variables below are set for you automatically.
Set them by hand only when attaching an existing standalone Teable to a
runtime plane.
</Note>
