...
- **Modèle** : utilisez le menu des modèles pour choisir le niveau de modèle de la conversation. Le menu liste **Ultra**, **Smart**, **Standard** et **Lite**, du plus capable au moins capable, en indiquant pour chacun le modèle associé ; votre administrateur peut remplacer ce modèle à tout moment ou ne proposer que certains niveaux, sans que vous ayez à choisir de nouveau. Utilisez un niveau plus bas pour les requêtes simples, le nettoyage ou la réécriture, et un niveau plus élevé pour la planification complexe, l’analyse inter-tables et la création d’applications.
