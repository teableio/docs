...
- Proje kimliğiniz, tablo kimliğiniz ve alan kimlikleriniz. Bkz. [Kimlikleri Alma](/tr/api-doc/get-id).
...
- En az ayrıcalığa sahip PAT'yi kullanın; erişimi yalnızca ihtiyaç duyduğu Alanlar ve Projelerle sınırlandırın.
