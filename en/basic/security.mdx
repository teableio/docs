...
import { Shield, Lock, Server, Users, Key, Database, FileCheck, Globe } from 'lucide-react';
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 my-8">
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <div className="text-sm text-gray-500">AES-256 & TLS</div>
      </div>
    </div>
  </Card>
  <Card>
  ...
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-semibold">AWS Hosted</div>
        <div className="text-sm text-gray-500">US-West Oregon</div>
      </div>
    </div>
  </Card>
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-semibold">SSO Ready</div>
        <div className="text-sm text-gray-500">OIDC Protocol</div>
      </div>
    </div>
  </Card>
</div>
...
<CardGroup cols={3}>
  <Card title="Auth0" icon="a" href="/basic/sso/auth0" />
  <Card title="Okta" icon="o" href="/basic/sso/okta" />
  <Card title="Azure Entra ID" icon="microsoft" href="/basic/sso/azure-entra-id" />
  <Card title="Google Workspace" icon="google" href="/basic/sso/google-workspace" />
  <Card title="OneLogin" icon="1" href="/basic/sso/onelogin" />
  <Card title="Authentik" icon="lock" href="/basic/sso/authentik" />
</CardGroup>
