...
<Steps>
  ...
  <Step title="Eliminar valores duplicados">
    Activa **Eliminar valores duplicados** y cada valor se muestra una sola vez, en su orden original. La eliminación ocurre después del filtro, la ordenación y el límite de Registros, así que el límite cuenta los Registros coincidentes y no los valores que quedan en el resultado.
  </Step>
</Steps>
