...
La méthode la plus simple consiste à utiliser `curl` depuis la ligne de commande. Copiez l’URL réelle depuis le panneau du déclencheur plutôt que de la saisir manuellement : elle contient les identifiants du projet et du flux de travail.
...
| Portée | Limite |
|---|---|
| Par projet | 50 requêtes/seconde |
