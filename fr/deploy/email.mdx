...
- **E-mail de notification** : utilisé pour la vérification des utilisateurs, la réinitialisation du mot de passe, les invitations, les notifications système et les e-mails similaires. C’est aussi lui qui rend **Se connecter avec un code e-mail** disponible sur la page de connexion.
