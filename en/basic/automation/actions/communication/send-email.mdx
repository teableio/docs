...
<Tip>You can also build this action by talking to AI — just describe what you want in plain language. If you build manually first, note that switching to AI-generated scripts later may require reconfiguring the action.</Tip>
