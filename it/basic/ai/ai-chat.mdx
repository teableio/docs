...
Fai clic su **Cronologia** in alto a destra nel pannello della chat per vedere le tue chat nella base corrente e cercarle per nome.
...
Archiviare toglie una chat dalla cronologia senza cancellare nulla. Apri il tuo avatar in basso a sinistra → **Impostazioni** → **Chat archiviate** per vedere le chat che hai archiviato nelle varie base. **Ripristina** ne riporta una nella cronologia della sua base, e da qui puoi anche eliminarla quando sei certo di non averne più bisogno.
