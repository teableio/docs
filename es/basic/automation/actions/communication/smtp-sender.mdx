...
- **Protege las credenciales.** Las contraseñas SMTP se almacenan cifradas en Teable, pero evita compartir configuraciones de Automatización que contengan credenciales confidenciales. Cuando una sola acción se configura con su propia cuenta SMTP, su contraseña es un secreto concedido a esa automatización; consulta [Enviar correo electrónico](/es/basic/automation/actions/communication/send-email-overview).
