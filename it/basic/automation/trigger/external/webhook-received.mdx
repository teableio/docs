...
Il modo più semplice per eseguire una prova consiste nell'usare `curl` dalla riga di comando. Copia l'URL effettivo dal pannello del trigger anziché digitarlo: contiene gli ID del Progetto e del workflow.
...
| Ambito | Limite |
|---|---|
| Per Progetto | 50 richieste al secondo |
