...
| App Builder 或 AI Chat Agent 无法使用自定义模型 | 自 2026 年 4 月 9 日起，这些功能当前仅支持 Anthropic 兼容端点。请切换至 Anthropic 兼容的提供商（如 Anthropic API、OpenRouter）、使用 Teable 默认模型，或等待后续 OpenAI 端点适配 |
