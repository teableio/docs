...
- Utilisez l’[Accès inter-projet](/fr/basic/automation/actions/records/cross-base) pour mettre à jour les enregistrements d’une table située dans un autre projet.
...
- [Accès inter-projet](/fr/basic/automation/actions/records/cross-base) — mettez à jour des enregistrements dans des tables extérieures au projet actuel
