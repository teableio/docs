...
<Warning>
**已弃用。**本页不再维护,已从文档目录中移除。当前的部署指引请从
[选择部署方式](/zh/deploy/choose)开始。
</Warning>
...
<Note>
本页介绍**基础版** Teable 应用的规模化部署。如需 AI 能力或 App Builder,
请改用[全功能平台](/zh/deploy/agent-runtime) —— 它包含应用与 AI 运行平面。
</Note>
...
<CardGroup cols={2}>
  <Card title="全功能平台（Kubernetes）" icon="dharmachakra" href="/zh/deploy/agent-runtime">
    应用 + AI 运行平面，一个 Helm chart 装进任意 K8s 集群。
  </Card>
