...
- **Richieste di credenziali**: quando l'IA ha bisogno di un account di terze parti o di un segreto, fissa nella conversazione una scheda di richiesta. Scegli **Collega il mio account** per avviare un flusso OAuth oppure concedi una credenziale che possiedi già. Con **Salta** non la fornisci e l'IA continua con le parti che può completare senza di essa.
