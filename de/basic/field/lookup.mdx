...
<Steps>
  ...
  <Step title="Doppelte Werte entfernen">
    Wenn die Verknüpfung auf mehrere Datensätze zeigt, kann derselbe Wert mehrfach zurückkommen. Aktivieren Sie **Doppelte Werte entfernen**, dann erscheint jeder Wert einmal, in der ursprünglichen Reihenfolge. Aus drei verknüpften Positionen mit den Kategorien Zubehör, Konsole, Zubehör wird Zubehör, Konsole.
  </Step>
</Steps>
