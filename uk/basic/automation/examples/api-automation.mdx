...
- Ідентифікатори Проєкту, таблиці й полів. Див. [Отримання ідентифікаторів](/uk/api-doc/get-id).
...
- Використовуйте PAT із мінімальними привілеями — обмежте його лише потрібними Просторами/Проєктами.
