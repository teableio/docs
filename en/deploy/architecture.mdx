...
are part of the platform, not optional add-ons. A self-hosted deployment
therefore runs the Teable app and its data services together with the
**runtime plane** — the set of services that powers those AI features. This
page explains the pieces and how they work together. The deployable assets
(compose files, Helm chart, values) live in
