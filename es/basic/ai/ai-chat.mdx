...
Haz clic en **Historial**, arriba a la derecha del panel de chat, para ver tus chats de la base actual y buscarlos por nombre.
...
Archivar saca un chat del historial sin borrar nada. Abre tu avatar de la esquina inferior izquierda → **Configuración** → **Chats archivados** para ver los chats que archivaste en distintas bases. **Restaurar** devuelve uno al historial de su base, y aquí también puedes eliminarlo cuando tengas claro que ya no lo necesitas.
