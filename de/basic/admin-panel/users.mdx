...
Öffnen Sie das Aktionsmenü eines Benutzers und wählen Sie **Sessions**, um die Geräte zu sehen, auf denen der Benutzer derzeit angemeldet ist, sowie seinen Anmeldeverlauf. Klicken Sie bei einem einzelnen Gerät auf **Sign out** oder auf **Sign out all devices**, um den Benutzer zu einer erneuten Anmeldung zu zwingen. Solange das Konto nicht deaktiviert ist, kann sich der Benutzer wieder anmelden.
