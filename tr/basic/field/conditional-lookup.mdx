...
<Steps>
  ...
  <Step title="Yinelenen değerleri kaldırın">
    **Yinelenen değerleri kaldır** seçeneğini açtığınızda her değer bir kez görünür. Yinelenenleri kaldırma son adımdır: Teable filtreden, sıralamadan ve kayıt sınırından geçen kayıtları alır, sonra bunların değerleri arasındaki tekrarları siler. Bu yüzden sonuçta izin verdiğiniz kayıt sayısından daha az değer kalabilir.
  </Step>
</Steps>
