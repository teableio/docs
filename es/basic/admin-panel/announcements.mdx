...
| Ajuste | Qué controla |
| --- | --- |
| **Formato** | Dónde aparece el anuncio: **Franja** en la parte superior de la aplicación, **Notificación emergente** como aviso transitorio, **Ventana modal** como cuadro de diálogo que interrumpe al usuario o **Tarjeta lateral** en las barras laterales de Espacios y Proyectos. |
