...
<Note>Поле пошуку не є окремим типом Поля. У пов’язаному Проєкті можна шукати Поле будь-якого типу. Тип Поля пошуку визначається вихідним Полем у пов’язаному Проєкті та має властивість isLookup. Поля пошуку не можна редагувати.</Note>
