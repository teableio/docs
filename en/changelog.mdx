...
# Settings Redesign, Navigation Improvements, and Bug Fixes

## Features

* Clicking a field name in the **Hidden Fields** panel now takes you directly to that column in the grid, so you can find and review hidden fields more quickly.

* After jumping from the **Hidden Fields** panel, the target column is now highlighted to help you confirm you’ve landed in the right place.

* We’ve combined **Personal** and **Workspace** settings into a single settings dialog, making it easier to find and manage key options in one place.

* The settings experience has been redesigned with clearer navigation and a more familiar two-pane layout, making sections like **Account**, **Preferences**, **Workspace**, **Members**, and **Billing** easier to browse.

* Settings pages now use more consistent titles and layouts, creating a cleaner and easier-to-scan experience across the entire settings area.

* Bases still running in the legacy environment now display a **V1** badge, so you can quickly tell them apart from default **V2** bases.

## Bug Fixes

* Fixed an issue where credit usage for AI image generation with the `openai/gpt-image-2` model could appear as **0**. Usage is now tracked correctly in the **Credit usage summary**.
