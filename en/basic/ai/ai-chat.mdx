...
Click **History** at the top right of the chat panel to see your chats in the current base, and search them by name.
...
Archiving takes a chat out of the history list without deleting anything. Open your avatar at the bottom left → **Settings** → **Archived chats** to see chats you archived across bases. **Restore** brings one back to its base's chat history, and you can delete it here once you are sure you no longer need it.
