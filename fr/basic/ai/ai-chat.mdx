...
- **Demandes d’identifiants** : lorsque l’IA a besoin d’un compte tiers ou d’un secret, elle épingle une carte de demande dans la conversation. Choisissez **Connecter mon compte** pour lancer un parcours OAuth, ou accordez un identifiant que vous possédez déjà. **Ignorer** ne le fournit pas ; l’IA poursuit les parties qu’elle peut réaliser sans lui.
