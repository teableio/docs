...
Mit **Ansicht teilen** wird die aktuelle Ansicht als Link veröffentlicht. Besucher sehen die Daten und das Layout dieser Ansicht. Dies ist nicht dasselbe, wie sie als Mitwirkende zu einem Projekt einzuladen.

<Note>Um ein gesamtes Projekt, eine bestimmte Tabelle oder einen Ordner zu teilen, verwenden Sie die Projekt-Freigabe unter [Projekt](/de/basic/base).</Note>
...
| Mit Passwort schützen | Alle Ansichtsfreigaben | Fügt dem Freigabelink ein Passwort hinzu. Besucher müssen das richtige Passwort eingeben, bevor sie ihn öffnen können. Nach dem Aktivieren wird automatisch ein zufälliges Passwort generiert, das Sie mit **Link und Passwort kopieren** zusammen mit dem Link kopieren können |
...
- „Ansicht teilen“ veröffentlicht das Ergebnis der aktuellen Ansicht, nicht die vollständigen Projekt-Berechtigungen. Verwenden Sie für eine dauerhafte Zusammenarbeit Mitgliederberechtigungen oder die Projekt-Freigabe.
