...
2. Choose the **Table** you want to query. Use [Cross-Project Access](/en/basic/automation/actions/records/cross-base) if the table is in a different project.
...
- When using Cross-Project Access, the query runs under the workflow creator's permissions. If the creator loses access to the target project, the step will fail.

## Related

- [Cross-project access](/en/basic/automation/actions/records/cross-base) — query tables in other projects
