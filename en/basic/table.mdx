...
Click the recycle bin button in the upper left of the base to enter the table recycle bin interface and perform the following operations.

> Table data in the recycle bin can still be accessed by database connections

* Empty Recycle Bin: Permanently delete all table data
