...
- **[Tablo Sorgusu İşlemleri](/tr/basic/admin-panel/table-query-ops)**: Tablo bazında arama kapsamını yapılandırın, dizin oluşturun ve sonuçları izleyin
...
- **[Schema integrity](/tr/basic/admin-panel/schema-integrity)**: Herhangi bir proje üzerinde şema kontrolü çalıştırın ve bulunanları onarın
