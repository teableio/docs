...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 my-8">
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-semibold">数据加密</div>
  ...
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <div className="text-sm text-gray-500">已认证</div>
      </div>
    </div>
  </Card>
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-semibold">AWS 托管</div>
        <div className="text-sm text-gray-500">美西俄勒冈</div>
      </div>
    </div>
  </Card>
  <Card>
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-semibold">SSO 支持</div>
        <div className="text-sm text-gray-500">OIDC 协议</div>
      </div>
    </div>
  </Card>
</div>
