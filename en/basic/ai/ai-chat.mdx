...
- **Skills**: Open the **+** menu and choose **Skills** to import, enable, disable, or try skills in the current chat context. Personal skills are only available to you. Base skills are shared with collaborators in the current base. Type `/` in the input box to choose an enabled skill.
