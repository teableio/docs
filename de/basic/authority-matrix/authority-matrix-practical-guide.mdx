...
Dieser Leitfaden verwendet eine Vertriebs-Projekt mit drei Tabellen: `Kunden`, `Verkaufsaufträge` und `Produkte`. Ziel ist es, jeder Rolle die Arbeit mit den benötigten Daten zu ermöglichen, ohne die gesamte Projekt offenzulegen.
...
<Steps>
  <Step title="Authority Matrix aktivieren">
    Öffnen Sie die Seite der Authority Matrix in dem Projekt und aktivieren Sie den Hauptschalter. Der Nutzer, der sie aktiviert, wird als Administrator hinzugefügt.
  </Step>
