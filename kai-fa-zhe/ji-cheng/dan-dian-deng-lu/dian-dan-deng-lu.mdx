...
OpenID Connect (OIDC) 是建立在 OAuth 2.0 协议之上的身份验证层。本指南将帮助您为 Teable 应用程序配置 OIDC 集成。
...
[上一页单点登录](/kai-fa-zhe/ji-cheng/dan-dian-deng-lu)[下一页组织管理面板配置 SSO （仅企业级版本)](/kai-fa-zhe/ji-cheng/dan-dian-deng-lu/zu-zhi-guan-li-mian-ban-pei-zhi-sso-jin-qi-ye-ji-ban-ben)
