...
description: "Learn how to buy, subscribe, and activate a Teable self-hosted license. Get your license key and unlock premium features for your self-hosted deployment."
keywords:
  - buy teable license
  - self-hosted license
  - purchase teable
...
- [Full-featured platform](/en/deploy/agent-runtime) (AI features and App Builder, Docker or Kubernetes)
...
<img
  ...
  alt="Copy the Instance ID from the Self-hosted License page"
  className="docs-screenshot"
/>
<img
...
<img
  ...
  alt="Enter the Instance ID during subscription"
  className="docs-screenshot"
/>
...
<img
  ...
  alt="License detail after subscription"
  className="docs-screenshot"
/>
...
<img
  ...
  alt="License activation confirmation"
  className="docs-screenshot"
/>
