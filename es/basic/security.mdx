...
Protege las Vistas, Proyectos o artefactos compartidos mediante una contraseña. Cuando esta opción está activada, las personas destinatarias deben introducir la contraseña correcta antes de acceder al contenido compartido.

Al activar la protección con contraseña, Teable genera una contraseña aleatoria que se aplica de inmediato. Haz clic en **Copiar enlace y contraseña**, junto a la contraseña, para copiar el enlace y la contraseña en una sola línea de texto y enviarla directamente a los visitantes. Para cambiarla, haz clic en el botón de edición e introduce una contraseña nueva, o haz clic en **Generar contraseña aleatoria** para obtener otra.

La contraseña solo se muestra en texto claro en el panel de uso compartido justo después de establecerla. Cuando vuelves a abrir los ajustes de uso compartido, la contraseña queda oculta; si necesitas copiarla de nuevo, establece una contraseña nueva.

## Cuenta e inicio de sesión

### Dispositivos con sesión iniciada

Abre tu avatar de la esquina inferior izquierda → **Configuración** → **Devices** para ver en qué dispositivos tiene la sesión iniciada tu cuenta, así como el **Login history** de los últimos 30 días. Cada dispositivo muestra el navegador o la app móvil, el sistema operativo, el método de inicio de sesión, la dirección IP y la última actividad.

Si ves un dispositivo que no reconoces, haz clic en **Sign out** en ese dispositivo y cambia tu contraseña. Haz clic en **Sign out all other devices** para cerrar la sesión en todos los dispositivos excepto el actual. Los dispositivos desconectados deben volver a iniciar sesión para seguir usando Teable.

### Bloqueo por intentos fallidos

Después de 5 intentos consecutivos con una contraseña incorrecta para el mismo correo electrónico, la cuenta se bloquea durante 15 minutos y se rechazan todos los intentos fallidos adicionales durante ese periodo.
...
|--------|-------------|----------|
| **[Exportar un Proyecto](/es/basic/base#export-base-backup-&-migration)** | Descarga un Proyecto completo como archivo `.tea` (estructura, datos y Automatizaciones) | Copia de seguridad completa y migración |
| **[Duplicar un Proyecto](/es/basic/base#duplicate-a-base-to-another-space)** | Crea una copia de un Proyecto dentro de Teable | Instantánea rápida |
...
<Tip>
Puedes crear copias de seguridad manuales de tus Proyectos exportando un Proyecto completo como archivo `.tea`, exportando Tablas concretas como archivos CSV u obteniendo tus datos mediante la API de Teable.
</Tip>
