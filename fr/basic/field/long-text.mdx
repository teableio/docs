...
- Les adresses web contenues dans le texte deviennent automatiquement des liens cliquables, sans aucun réglage. Dans un Enregistrement développé, un bouton situé près du champ de saisie répertorie toutes les adresses détectées dans la cellule.
- Texte long ne prend pas en charge l’affichage interactif E-mail ou Téléphone. Utilisez un Champ **Texte sur une seule ligne** lorsque vous voulez cliquer sur une adresse ou un numéro pour écrire ou appeler.
