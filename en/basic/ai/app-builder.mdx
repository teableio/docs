...
<AccordionGroup>
  ...
  <Accordion title="How do I download or import app code?">
    Switch to the **Code** tab in the editor, click the **`...`** menu in the tab bar, then choose **Download code** or **Import code**. When importing a ZIP, include source files only. Do not include `node_modules`, `.next`, or other build artifacts.
  </Accordion>
