...
2. Scegli la **Tabella** da interrogare. Usa [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) se la Tabella si trova in un Progetto diverso.
...
- Quando usi Accesso tra Progetti, la query viene eseguita con le autorizzazioni del creatore del workflow. Se quest'ultimo perde l'accesso al Progetto di destinazione, il passaggio non riuscirà.

## Contenuti correlati

- [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) — interroga Tabelle in altri Progetti
