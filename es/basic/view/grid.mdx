...
El mismo panel también puede informar de estos fallos:

| Mensaje | Qué significa | Qué hacer |
| --- | --- | --- |
| `La compilación de la fórmula supera el límite de cálculo; los resultados no se actualizaron` | La estructura expandida de la fórmula supera el límite | Simplifica la fórmula o lleva los resultados intermedios a campos propios; consulta [Fórmula](/es/basic/field/formula) |
| `Los resultados no se actualizaron por un límite de recursos` | El cálculo alcanzó un límite de recursos de la base de datos | Modifica menos registros a la vez; si se repite, contacta con un administrador |
| `El cálculo no terminó; algunos resultados no se actualizaron` | La cadena de cálculo es demasiado profunda para terminar de una vez | Reduce las referencias encadenadas entre campos y vuelve a editar los datos de origen para lanzar un nuevo cálculo |
