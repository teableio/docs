...
Webadressen in einer Zelle werden automatisch zu anklickbaren Links, ohne dass Sie etwas einstellen müssen. Erkannt werden Adressen, die mit `https://` oder `www.` beginnen, sowie gängige Domains wie `teable.ai`. Enthält ein Wert mehrere Adressen, wird jede einzeln verlinkt. Im geöffneten Datensatz listet eine Schaltfläche neben dem Eingabefeld alle Adressen der Zelle auf.

Dateinamen und Versionsnummern wie `readme.md` oder `v1.2.3` werden nicht als Adresse gewertet.

## Anzeigemodus

„Einzeiliger Text“ unterstützt drei Anzeigemodi:

| Anzeigemodus | Geeignet für | Verhalten beim Klicken |
| --- | --- | --- |
| Standard | Namen, Titel, IDs und sonstiger Nur-Text | Adressen werden zu Links und öffnen sich beim Anklicken |
...
- **Kundenkontakte verwalten**: Erstellen Sie ein Feld „Unternehmenswebsite“ und tragen Sie die Adresse ein, damit die Website beim Anklicken geöffnet wird. Erstellen Sie ein Feld „Telefon“ und legen Sie den Modus auf **Telefon** fest, damit Benutzer auf Mobilgeräten mit einmaligem Tippen anrufen können.
...
- E-Mail und Telefon sind Anzeigemodi. Das Feld bleibt vom Typ „Einzeiliger Text“ und kann weiterhin sortiert, gefiltert und mit Textfunktionen verarbeitet werden.
