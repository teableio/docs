...
- **Scraper**: Abre el menú **+**, elige **Scraper** y selecciona una plataforma y un tipo de dato, por ejemplo **perfil personal** en LinkedIn o **reseñas del producto** en Amazon. Teable rellena la instrucción correspondiente en la entrada del chat para que la completes con un enlace o una palabra clave. **Cualquier página web** acepta directamente un enlace pegado.
