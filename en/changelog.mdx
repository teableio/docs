...
<Banner title="🎉 v1.12.0 Released!" icon="sparkles">
  AI is now free for everyone! Viewers & Commenters no longer cost extra. [See what's new →](#free-ai-free-viewers--commenters)
</Banner>
<Update label="v1.12.0" description="2026-01-13">

## Free AI. Free viewers & commenters.

> We’ve removed the biggest blockers: AI is unlocked on Free, and stakeholder invites are free.
...
<CardGroup cols={3}>
  <Card title="App Builder" icon="browser">
    <Badge size="sm">Business</Badge> → <Badge size="sm" color="green">Free</Badge>
  </Card>
  <Card title="AI Chat" icon="message-bot">
    <Badge size="sm">Pro</Badge> → <Badge size="sm" color="green">Free</Badge>
  </Card>
  <Card title="AI Fields" icon="sparkles">
    <Badge size="sm">Pro</Badge> → <Badge size="sm" color="green">Free</Badge>
  </Card>
</CardGroup>
...
AI credits are now allocated per paid seat, so your monthly credits grow proportionally as your team scales.
...
<Update label="v1.11.0" description="2026-01-07">
