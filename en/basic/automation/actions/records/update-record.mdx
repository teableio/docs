...
- Consider using [When record matches conditions](/basic/automation/trigger/records/record-matches-conditions) instead, which only fires on state transitions.
