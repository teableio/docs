---
title: "Panoramica"
description: "Imposta gli ambiti di accesso per diversi team nello stesso Progetto, affinché i membri possano visualizzare, modificare o esportare soltanto i dati necessari."
---

{/* mintlify-resync: 2026-05-28 */}
<Tip>Disponibile per il piano Business e versioni successive</Tip>

Quando vendite, finanza, operazioni e dirigenza condividono lo stesso Progetto,
le autorizzazioni stabiliscono chi può accedere al Progetto, quali dati può visualizzare o modificare
...
| Campi sensibili in un Progetto condiviso | I membri possono visualizzare i Record degli ordini senza vedere i Campi relativi ai pagamenti o ai costi. |
...
- L'assegnazione di un ruolo tramite `Aggiungi utente` o `Aggiungi dall'organizzazione` può aggiungere i
  membri o i reparti selezionati come collaboratori del Progetto. La Matrice di autorità
  restringe quindi ciò a cui possono accedere all'interno del Progetto.

<Note>Per informazioni sui livelli di autorizzazione di progetto dello Spazio e del Progetto, consulta [Autorizzazioni di collaborazione](/it/basic/space/space-permission).</Note>
