...
Un'Automazione chiama i servizi esterni con le tue credenziali: una connessione OAuth o un segreto che salvi. Apri il flusso di lavoro nella scheda di modifica, fai clic su **Credenziali e configurazione** accanto ai controlli di test, concedi una credenziale a questa Automazione e assegnale un **Nome della variabile**.

Le azioni script leggono quel nome da una variabile di ambiente come `process.env.EXTERNAL_API_KEY`; nelle altre azioni, **Inserisci segreto** accanto a un campo di input aggiunge un riferimento. I valori non vengono mai mostrati in chiaro e i risultati dei test li mascherano.

Le credenziali si gestiscono in **Impostazioni** → **Integrazioni**; vedi [Credenziali e integrazioni](/it/basic/credential).
...
| Elemento | Limite |
|---|---|
| Frequenza di invio delle email | 5 / secondo / Progetto |
| Frequenza di ricezione dei webhook | 50 / secondo / Progetto, 2 / secondo / flusso di lavoro |
