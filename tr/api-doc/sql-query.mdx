...
1. **Bir Tablo Açın**: Önce bağlanmak istediğiniz Projedeki herhangi bir Tabloyu açın.
2. **Tasarım Sayfasına Girin**: Proje Tasarımı sayfasına girmek için sağ üst köşedeki ⚙️ simgesine tıklayın.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-open-design-page-en.png"
  alt="Proje Tasarımı sayfasını açma"
...
- **Şema adı (BaseId)**: `bse` ile başlayan Proje tanımlayıcısı
...
Teable'daki her Proje, PostgreSQL'deki bir **şemaya** karşılık gelir. BaseId, SQL sorgularında kullanılan şema adıdır.

**Yöntem 1:** URL'ye bakın; `bse` ile başlayan dize BaseId'dir.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-base-id-url.png"
  alt="URL'deki Proje kimliği"
  className="docs-screenshot"
/>

**Yöntem 2:** Proje Tasarımı arayüzünde gösterilen şema adı BaseId'dir.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-design-page-schema.png"
  alt="Proje Tasarımı sayfasındaki şema adı"
  className="docs-screenshot"
/>

### Tablo Adlarını Bulma

Teable arayüzündeki Tablo adları, fiziksel veritabanı Tablo adlarıyla otomatik olarak eşitlenmez. Gerçek veritabanı Tablo adını Proje Tasarımı arayüzünden kontrol edin.
...
Veritabanı bağlantısının kapsamı yalnızca geçerli Projeyle sınırlıdır. PostgreSQL şemaları izin yalıtımı sağlayarak yalnızca kendi Projenizdeki Tablolara erişebilmenizi güvence altına alır.
...
<img
  ...
  alt="TablePlus'taki Proje kimliği"
  className="docs-screenshot"
/>
