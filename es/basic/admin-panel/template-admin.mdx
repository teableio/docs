...
description: "Administra las plantillas de flujos de trabajo de tu organización para que los usuarios puedan comenzar rápidamente con Proyectos preconfiguradas."
---
...
* **Solution**: Si se marca, usar la plantilla abre primero la configuración de integraciones en lugar de copiar el proyecto directamente. La columna **Integrations** muestra las plataformas con las que se conecta
* **Origen**: El Proyecto original utilizada para crear esta plantilla

#### Operaciones de plantilla

* **Nueva plantilla**: Crea una configuración de plantilla
* **Publicar instantánea**: Captura el estado actual del Proyecto de origen. Debes publicar una instantánea antes de poder incluir la plantilla en el centro de plantillas.
...
2. **Importar**: Importa el archivo `.tea` como un Proyecto nueva en tu Espacio
3. **Crear plantilla**: Ve a Administración de plantillas > Nueva plantilla
4. **Seleccionar origen**: Elige el Proyecto importada como origen
