...
<Steps>
  ...
  <Step title="Yinelenen değerleri kaldırın">
    Bağlantı birden çok kaydı gösterdiğinde aynı değer birkaç kez dönebilir. **Yinelenen değerleri kaldır** seçeneğini açtığınızda her değer özgün sırasını koruyarak bir kez görünür. Kategorileri Aksesuar, Konsol, Aksesuar olan üç bağlı satır Aksesuar, Konsol olarak görünür.
  </Step>
</Steps>
