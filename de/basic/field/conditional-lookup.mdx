...
<Steps>
  ...
  <Step title="Doppelte Werte entfernen">
    Aktivieren Sie **Doppelte Werte entfernen**, dann erscheint jeder Wert einmal, in der ursprünglichen Reihenfolge. Die Duplikate fallen erst nach Filter, Sortierung und Datensatzbegrenzung weg, die Begrenzung zählt also die passenden Datensätze und nicht die verbleibenden Werte.
  </Step>
</Steps>
