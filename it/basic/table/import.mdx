...
<Steps>
  ...
  <Step title="Scegli come creare la Tabella">
    Quando crei una nuova Tabella, Teable propone **Importa con l’AI** oppure **Importa manualmente**. L’opzione con AI compare solo se AI Chat è disponibile per te in quella Base.
  </Step>
