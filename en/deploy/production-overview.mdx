...
<Warning>
**Deprecated.** This page is no longer maintained and has been removed from the
docs navigation. For current deployment guidance, start from
[Choose Your Path](/en/deploy/choose).
</Warning>
...
<Note>
This page covers scaling the **standalone** Teable app. If you need AI
features or App Builder, deploy the
[full-featured platform](/en/deploy/agent-runtime) instead — it includes the
app plus the AI runtime plane.
</Note>
...
<CardGroup cols={2}>
  <Card title="Full-featured platform (Kubernetes)" icon="dharmachakra" href="/en/deploy/agent-runtime">
    The app plus the AI runtime plane on any K8s cluster, via one Helm chart.
  </Card>
