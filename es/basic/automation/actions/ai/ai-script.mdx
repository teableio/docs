...
Si tu script necesita un servicio como Slack, Airtable o Google Sheets, haz clic en los botones de integración de la parte superior del panel de IA para conectar tus cuentas. La IA utilizará estas conexiones al generar el código.
