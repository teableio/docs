...
Les compétences ajoutées par les utilisateurs ailleurs restent dans leur propre périmètre. Consultez [Chat IA](/fr/basic/ai/ai-chat) pour les compétences personnelles, de Projet et d’Espace.
...
Une compétence publiée ici est la compétence par défaut de l’instance. Si une compétence de Projet, d’Espace, personnelle, d’Application ou de bot utilise le même nom, la compétence au périmètre plus restreint s’applique à cette conversation et la compétence de l’instance y est ignorée.
