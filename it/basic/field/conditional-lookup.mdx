...
<Steps>
  ...
  <Step title="Rimuovi valori duplicati">
    Attiva **Rimuovi valori duplicati** e ogni valore compare una sola volta. La deduplicazione è l'ultimo passaggio: Teable prende i Record che superano filtro, ordinamento e limite di Record, poi elimina i duplicati tra i loro valori, quindi il risultato può contenere meno valori dei Record che hai consentito.
  </Step>
</Steps>
