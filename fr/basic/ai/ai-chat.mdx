...
- **Scraper** : ouvrez le menu **+** et choisissez **Scraper**, puis une plateforme et un type de données, par exemple **profil personnel** sur LinkedIn ou **avis sur le produit** sur Amazon. Teable pré-remplit l’instruction correspondante dans la saisie du chat, que vous complétez par un lien ou un mot-clé. **Page web quelconque** accepte directement un lien collé.
