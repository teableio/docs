...
<Steps>
  ...
  <Step title="Supprimer les valeurs en double">
    Lorsque le lien pointe vers plusieurs Enregistrements, une même valeur peut revenir plusieurs fois. Activez **Supprimer les valeurs en double** : chaque valeur apparaît une seule fois, dans son ordre d’origine. Trois lignes de commande dont les catégories sont Accessoire, Console, Accessoire s’affichent Accessoire, Console.
  </Step>
</Steps>
