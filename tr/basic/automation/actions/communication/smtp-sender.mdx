...
- **Kimlik bilgilerini güvende tutun.** SMTP parolaları Teable'da şifreli olarak saklanır ancak hassas kimlik bilgileri içeren otomasyon yapılandırmalarını paylaşmayın. Tek bir eylem kendi SMTP hesabıyla yapılandırıldığında parolası, o otomasyona verilen bir gizli anahtardır; bkz. [E-posta gönder](/tr/basic/automation/actions/communication/send-email-overview).
