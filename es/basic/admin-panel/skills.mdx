...
Las habilidades que los usuarios añaden en otros lugares permanecen en su propio ámbito. Consulta [Chat de IA](/es/basic/ai/ai-chat) para obtener información sobre las habilidades personales, de Proyecto y de Espacio.
...
Una habilidad publicada aquí es la opción predeterminada de la instancia. Si una habilidad de Proyecto, Espacio, personal, de aplicación o de bot usa el mismo nombre, se aplica la de ámbito más específico en esa conversación y se ignora la habilidad de la instancia.
