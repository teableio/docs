...
[Choose Your Path](/en/deploy/choose). Storage now ships preconfigured with the deployment assets; the full-featured platform manages three buckets (public, private, and build artifacts) for you.
</Warning>
