...
Yeni tablo başlatmak, mevcut tabloya yeni veriler eklemek veya Airtable ya da Google E-Tablolar'daki tabloları bir Teable Projeye taşımak için içe aktarmayı kullanın. Projenin tamamını içe aktarırken Airtable ve Google E-Tablolar da kullanılabilir.
...
<Steps>
  ...
  <Step title="Tabloyu nasıl oluşturacağınızı seçin">
    Yeni bir tablo oluştururken Teable **AI ile içe aktar** ve **Manuel içe aktar** seçeneklerini sunar.
  </Step>
...
Dosya yüklendikten sonra Teable **AI ile optimize et ve içe aktar** seçeneğini sunar. **AI ile içe aktar**, dosyayı AI Chat’e verir: AI verileri analiz eder, tablo yapısını, ilişkileri ve alan türlerini düzenler ve içe aktarmayı çalıştırır. İçe aktarma penceresi kapanır, sohbet paneli açılır; ilerlemeyi izleyebilir ve yanıt yazarak sonucu yönlendirebilirsiniz. AI ile içe aktarma AI kredisi harcar ve yalnızca yeni bir tablo oluştururken sunulur, mevcut bir tabloya aktarımda sunulmaz.

**Manuel içe aktar** ise alan önizlemesine gider; önizlemedeki **Geri** bu seçime döndürür.
...
- Yeni bir Teable Proje oluşturmak için hedef Alan menüsünü açın, **İçe Aktar**'a tıklayın ve **Airtable'dan içe aktar**'ı seçin.
- Görüntülediğiniz Teable Projeye tablolar aktarmak için Proje kaynak menüsünü kullanın:

1. Hedef Teable Projeyi açın.
...
<img
  ...
  alt="Proje menüsündeki Airtable içe aktarma girişi"
  className="docs-screenshot"
/>
...
- Yeni bir Teable Proje oluşturmak için hedef Alan menüsünü açın, **İçe Aktar**'a tıklayın ve **Google E-Tablolar'dan içe aktar**'ı seçin.
- Görüntülediğiniz Projeye tablo eklemek için sol dizinin üst kısmındaki `+` simgesine tıklayın ve **Diğer kaynaklardan ekle** bölümünden **Google E-Tablolar**'ı seçin.
...
<Steps>
  ...
  <Step title="İçe aktarmayı başlatın">
    **İçe aktarmayı başlat**'a tıklayıp iletişim kutusunu açık tutun. İlerlemeyi tablo tablo, işlem tamamlandığında ise her tabloya kaç kayıt eklendiğini bildirir. Yeni Proje içe aktarmasından sonra doğrudan sonuca gitmek için **Projeyi aç**'ı kullanın.
  </Step>
</Steps>
