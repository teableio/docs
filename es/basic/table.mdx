...
Cuando otras Tablas enlazan con la Tabla que estás eliminando, el cuadro de diálogo de confirmación enumera los Campos afectados y el Proyecto y la Tabla a las que pertenece cada uno. Al eliminar la Tabla, esos Campos de enlace se convierten en Campos de texto de una línea que conservan los títulos de los Registros enlazados; los Campos de búsqueda o acumulación creados a partir de ellos dejan de funcionar.
