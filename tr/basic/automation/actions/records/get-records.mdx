...
2. Sorgulamak istediğiniz **Tabloyu** seçin. Tablo farklı bir Projedeyse [Projeler Arası Erişim](/tr/basic/automation/actions/records/cross-base) özelliğini kullanın.
...
- Projeler Arası Erişim kullanılırken sorgu, iş akışını oluşturan kişinin izinleriyle çalışır. Oluşturan kişi hedef Projeye erişimini kaybederse adım başarısız olur.

## İlgili konular

- [Projeleri arası erişim](/tr/basic/automation/actions/records/cross-base) — diğer Projelerdeki tabloları sorgulayın
