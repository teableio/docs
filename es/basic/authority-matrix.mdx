...
description: "Define ámbitos de acceso para distintos equipos de un mismo Proyecto, de modo que los miembros solo puedan ver, editar o exportar los datos que necesitan."
---

{/* mintlify-resync: 2026-05-28 */}
<Tip>Disponible para el plan Business y los planes superiores</Tip>

Cuando los equipos de ventas, finanzas, operaciones y dirección comparten un mismo Proyecto,
...
| Campos confidenciales en un Proyecto compartido | Los miembros pueden ver los Registros de pedidos sin consultar los Campos de pagos o costes. |
...
- Al asignar un rol desde `Añadir usuario` o `Añadir desde la organización`, se pueden añadir determinados
  miembros o departamentos como colaboradores del Proyecto. La Matriz de Autoridad limita después
  a qué contenido pueden acceder dentro del Proyecto.

<Note>Para obtener información sobre los niveles básicos de permisos de Espacios y Proyectos, consulta [Permisos de colaboración](/es/basic/space/space-permission).</Note>
