...
El registro de auditoría abarca las actividades habituales de administración y colaboración, incluidos los Espacios, los Proyectos, las Tablas, las Vistas, los Campos, los Registros, el uso compartido, las invitaciones, los tokens de acceso y la Matriz de permisos.

Cada entrada del registro muestra la hora de la operación, el operador, el tipo de acción, el Proyecto o el Espacio relacionado y el origen de la solicitud. Abre una entrada del registro para consultar sus detalles.
...
- **Seleccionar Proyecto**: Muestra la actividad de un Proyecto concreto.
- **Seleccionar acción**: Filtra por tipo de operación, como Registros, Campos, Vistas, Tablas, Proyectos, uso compartido, Matriz de permisos, roles de la Matriz de permisos, Espacios, invitaciones, usuarios y tokens de acceso.

Si se ha eliminado un usuario, un Proyecto o un Espacio, la entrada permanece en el registro y el recurso aparece marcado como eliminado.
