...
---
<Note>Teable provides more granular permission control at table/field/record levels. Please refer to the [Permission Matrix](/en/basic/authority-matrix) section.</Note>
