...
Usa l'importazione per inizializzare una nuova Tabella, aggiungere nuovi dati a una Tabella esistente o trasferire Tabelle da Airtable o Fogli Google in un Progetto Teable. Airtable e Fogli Google sono disponibili anche durante l'importazione di un'intera Progetto.
...
<Steps>
  ...
  <Step title="Scegli come creare la Tabella">
    Quando crei una nuova Tabella, Teable propone **Importa con l’AI** oppure **Importa manualmente**.
  </Step>
...
Dopo il caricamento del file, Teable propone **Ottimizza e importa con l’AI**. **Importa con l’AI** passa il file ad AI Chat, che analizza i dati, adatta la struttura della Tabella, le relazioni e i tipi di Campo ed esegue l’importazione. La finestra di importazione si chiude e si apre il pannello della chat, così puoi seguire l’avanzamento e rispondere per indirizzare il risultato. Un'importazione con AI consuma crediti AI ed è disponibile quando crei una nuova Tabella, non quando importi in una Tabella esistente.

**Importa manualmente** apre invece l’anteprima dei Campi e **Indietro** nell’anteprima riporta a questa scelta.
...
- Per creare una nuovo Progetto Teable, apri il menu dello Spazio di destinazione, fai clic su **Importa**, quindi scegli **Importa da Airtable**.
- Per importare Tabelle nel Progetto Teable che stai visualizzando, usa il menu delle risorse del Progetto:

1. Apri il Progetto Teable desiderata.
...
<img
  ...
  alt="Punto di accesso all'importazione Airtable nel menu del Progetto"
  className="docs-screenshot"
/>
...
- Per creare una nuovo Progetto Teable, apri il menu dello Spazio di destinazione, fai clic su **Importa**, quindi scegli **Importa da Fogli Google**.
- Per aggiungere Tabelle al Progetto visualizzata, fai clic su `+` nella parte superiore della directory a sinistra e scegli **Fogli Google** sotto **Aggiungi da altre origini**.
...
<Steps>
  ...
  <Step title="Avvia l'importazione">
    Fai clic su **Avvia importazione** e mantieni aperta la finestra. Viene mostrato l'avanzamento Tabella per Tabella e, al termine, quanti Record ha ricevuto ciascuna Tabella. Dopo l'importazione di una nuovo Progetto, usa **Apri Progetto** per passare direttamente al risultato.
  </Step>
</Steps>
