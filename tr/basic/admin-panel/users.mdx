...
Bir kullanıcının eylem menüsünü açıp **Sessions**'ı seçerek kullanıcının şu anda oturum açık olan cihazlarını ve giriş geçmişini görüntüleyebilirsiniz. Tek bir cihaz için **Sign out**'a veya **Sign out all devices**'a tıklayarak kullanıcıyı yeniden oturum açmaya zorlayabilirsiniz. Hesap devre dışı bırakılmadıysa kullanıcı yeniden oturum açabilir.
