...
- Идентификаторы Проекта, Таблицы и Полей. См. [Получение идентификаторов](/ru/api-doc/get-id).
...
- Используйте PAT с минимальными полномочиями — ограничьте его только необходимыми Пространствами и Проектами.
