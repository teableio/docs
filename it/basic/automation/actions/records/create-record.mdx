...
2. Scegli la **Tabella** in cui vuoi creare il Record. Per impostazione predefinita è una Tabella della stessa Progetto, ma puoi usare l'[Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) per scegliere una Tabella di un'altra Progetto.
...
- Usa [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) quando la Tabella di destinazione si trova in un Progetto diversa da quella dell'automazione.
