...
Utilisez l’importation pour initialiser une nouvelle Table, ajouter de nouvelles données à une Table existante ou importer des Tables depuis Airtable ou Google Sheets dans un Projet Teable. Airtable et Google Sheets sont également disponibles lorsque vous importez un Projet entier.
...
<Steps>
  ...
  <Step title="Choisir le mode de création de la Table">
    Lors de la création d’une nouvelle Table, Teable propose **Importer avec l’IA** ou **Importer manuellement**.
  </Step>
...
Une fois le fichier téléversé, Teable propose **Optimiser et importer avec l’IA**. **Importer avec l’IA** confie le fichier à AI Chat, qui analyse les données, ajuste la structure de la Table, les relations et les types de Champs, puis lance l’importation. La boîte de dialogue d’importation se ferme et le panneau de chat s’ouvre : vous suivez la progression et répondez pour orienter le résultat. Une importation avec l’IA consomme des crédits IA et n’est proposée qu’à la création d’une nouvelle Table, pas lors d’une importation dans une Table existante.

**Importer manuellement** ouvre l’aperçu des Champs, et **Retour** dans l’aperçu ramène à ce choix.
...
- Pour créer un nouveau Projet Teable, ouvrez le menu de l’Espace cible, cliquez sur **Importer**, puis choisissez **Importer depuis Airtable**.
- Pour importer des Tables dans le Projet Teable que vous consultez, utilisez le menu des ressources du Projet :

1. Ouvrez le Projet Teable cible.
...
<img
  ...
  alt="Point d’entrée de l’importation Airtable dans le menu du Projet"
  className="docs-screenshot"
/>
...
- Pour créer un nouveau Projet Teable, ouvrez le menu de l’Espace cible, cliquez sur **Importer**, puis choisissez **Importer depuis Google Sheets**.
- Pour ajouter des Tables au Projet que vous consultez, cliquez sur `+` en haut du répertoire de gauche et choisissez **Google Sheets** sous **Ajouter depuis d’autres sources**.
...
<Steps>
  ...
  <Step title="Démarrer l’importation">
    Cliquez sur **Démarrer l’importation** et laissez la boîte de dialogue ouverte. Elle indique la progression Table par Table et, à la fin, le nombre d’Enregistrements reçus par chaque Table. Après l’importation d’un nouveau Projet, utilisez **Ouvrir le Projet** pour accéder directement au résultat.
  </Step>
</Steps>
