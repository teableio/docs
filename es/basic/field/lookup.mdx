...
<Steps>
  ...
  <Step title="Eliminar valores duplicados">
    Cuando el vínculo apunta a varios Registros, el mismo valor puede aparecer más de una vez. Activa **Eliminar valores duplicados** y cada valor se muestra una sola vez, en su orden original. Tres líneas de pedido con las categorías Accesorio, Consola, Accesorio se muestran como Accesorio, Consola.
  </Step>
</Steps>
