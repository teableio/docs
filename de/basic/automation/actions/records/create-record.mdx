...
2. Wählen Sie die **Tabelle**, in der der Datensatz erstellt werden soll. Standardmäßig handelt es sich um eine Tabelle in demselben Projekt. Mit [Projekt-übergreifendem Zugriff](/de/basic/automation/actions/records/cross-base) können Sie jedoch eine Tabelle in einem anderen Projekt als Ziel festlegen.
...
- Verwenden Sie [Projekt-übergreifenden Zugriff](/de/basic/automation/actions/records/cross-base), wenn sich die Zieltabelle in einem anderen Projekt als die Automatisierung befindet.
...
- [Projekt-übergreifender Zugriff](/de/basic/automation/actions/records/cross-base) – Datensätze in Tabellen außerhalb des aktuellen Projekts erstellen
