...
2. Scegli la **Tabella** in cui vuoi creare il Record. Per impostazione predefinita è una Tabella dello stesso Progetto, ma puoi usare l'[Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) per scegliere una Tabella di un altro Progetto.
...
- Usa [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) quando la Tabella di destinazione si trova in un Progetto diverso da quello dell'automazione.
...
- [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) — crea Record in Tabelle esterne al Progetto corrente
