...
Dasselbe Feld kann auch diese Fehler melden:

| Meldung | Bedeutung | Vorgehen |
| --- | --- | --- |
| `Die Formelkompilierung überschreitet das Berechnungslimit; die Ergebnisse wurden nicht aktualisiert` | Die entfaltete Struktur der Formel liegt über der Grenze | Formel vereinfachen oder Zwischenergebnisse in eigene Felder auslagern, siehe [Formel](/de/basic/field/formula) |
| `Berechnungsergebnisse wurden wegen eines Ressourcenlimits nicht aktualisiert` | Die Berechnung ist an eine Ressourcengrenze der Datenbank gestoßen | Weniger Datensätze auf einmal ändern; bei wiederholtem Auftreten an eine Administratorin oder einen Administrator wenden |
| `Die Berechnung wurde nicht abgeschlossen; einige Ergebnisse wurden nicht aktualisiert` | Die Berechnungskette ist zu tief für einen Durchlauf | Verkettete Verweise zwischen Feldern reduzieren und die Quelldaten erneut ändern, um eine neue Berechnung auszulösen |
