...
- **Protégez vos identifiants.** Les mots de passe SMTP sont stockés sous forme chiffrée dans Teable, mais évitez de partager des configurations d’automatisation contenant des identifiants sensibles. Lorsqu’une action reçoit son propre compte SMTP, son mot de passe est un secret accordé à cette automatisation ; voir [Envoyer un e-mail](/fr/basic/automation/actions/communication/send-email-overview).
