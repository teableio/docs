...
<Steps>
  ...
  <Step title="Rimuovi valori duplicati (facoltativo)">
    Attiva **Rimuovi valori duplicati** per conservare ogni valore solo alla prima occorrenza. Teable rimuove i duplicati dopo filtro, ordinamento e limite di Record, quindi il limite continua a contare i Record corrispondenti e non i valori rimasti nel risultato.
  </Step>
</Steps>
