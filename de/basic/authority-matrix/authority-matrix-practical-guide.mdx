...
Dieser Leitfaden verwendet ein Vertriebs-Projekt mit drei Tabellen: `Kunden`, `Verkaufsaufträge` und `Produkte`. Ziel ist es, jeder Rolle die Arbeit mit den benötigten Daten zu ermöglichen, ohne das gesamte Projekt offenzulegen.
