---
title: "Genel Bakış"
description: "Aynı projedeki farklı ekipler için erişim kapsamları belirleyerek üyelerin yalnızca ihtiyaç duydukları verileri görmesini, düzenlemesini veya dışa aktarmasını sağlayın."
---

{/* mintlify-resync: 2026-05-28 */}
<Tip>Business planı ve üzerindeki planlarda kullanılabilir</Tip>

Satış, finans, operasyon ve yönetim ekipleri aynı projeyi paylaştığında izinler; kimlerin projeye girebileceğini, hangi verileri görebileceğini veya düzenleyebileceğini ve verileri içe ya da dışa aktarıp aktaramayacağını belirler. Yetki Matrisi, ekiplerin verileri tek yerde tutarken erişimi sorumluluklara göre ayırmasına yardımcı olur.
...
| Paylaşılan bir projedeki hassas alanlar | Üyeler ödeme veya maliyet alanlarını görmeden sipariş kayıtlarını görüntüleyebilir. |
...
Özel bir rol oluşturmak için `Rol ekle` seçeneğini kullanın. Rol ayrıntıları sayfasında ortak çalışanları atayın, kısa bir açıklama yazın ve projedeki her düğüm için erişimi yapılandırın:
...
- `Kullanıcı ekle` veya `Kuruluştan ekle` seçeneğinden rol atamak, seçilen üyeleri veya departmanları proje ortak çalışanı olarak ekleyebilir. Ardından Yetki Matrisi, proje içindeki erişim kapsamlarını daraltır.

<Note>Temel Alan ve proje izin düzeyleri hakkında bilgi edinmek için [İş Birliği İzinleri](/tr/basic/space/space-permission) sayfasına bakın.</Note>
