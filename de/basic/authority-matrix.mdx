---
title: "Übersicht"
description: "Legen Sie Zugriffsbereiche für verschiedene Teams in demselben Projekt fest, damit Mitglieder nur die benötigten Daten sehen, bearbeiten oder exportieren können."
---

{/* mintlify-resync: 2026-05-28 */}
<Tip>Verfügbar ab dem Business-Plan</Tip>

Wenn Vertrieb, Finanzen, Betrieb und Führung dasselbe Projekt nutzen, bestimmen Berechtigungen, wer das Projekt betreten kann, welche Daten angezeigt oder bearbeitet werden können und ob Daten importiert oder exportiert werden dürfen. Die Authority Matrix hilft Teams, Daten an einem Ort zu halten und den Zugriff gleichzeitig nach Verantwortlichkeiten zu trennen.
...
| Sensible Felder in einem gemeinsam genutzten Projekt | Mitglieder können Bestelldatensätze anzeigen, ohne Zahlungs- oder Kostenfelder zu sehen. |
...
Verwenden Sie `Rolle hinzufügen`, um eine benutzerdefinierte Rolle zu erstellen. Weisen Sie auf der Detailseite der Rolle Mitarbeitende zu, verfassen Sie eine kurze Beschreibung und konfigurieren Sie den Zugriff für jeden Knoten in dem Projekt:
...
- Das Zuweisen einer Rolle über `Nutzer hinzufügen` oder `Aus Organisation hinzufügen` kann ausgewählte Mitglieder oder Abteilungen als Mitarbeitende des Projekts hinzufügen. Die Authority Matrix schränkt anschließend ein, worauf sie innerhalb des Projekts zugreifen können.

<Note>Informationen zu grundlegenden Berechtigungsebenen für Spaces und Projekte finden Sie unter [Berechtigungen für die Zusammenarbeit](/de/basic/space/space-permission).</Note>
