...
- **[Operazioni sulle query delle Tabelle](/it/basic/admin-panel/table-query-ops)**: configura la copertura di ricerca per Tabella, crea indici e segui i risultati
...
- **[Schema integrity](/it/basic/admin-panel/schema-integrity)**: esegui controlli dello schema su qualsiasi progetto e ripara quanto emerge
