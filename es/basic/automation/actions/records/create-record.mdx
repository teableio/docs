...
2. Elige la **Tabla** en la que quieres crear el Registro. De forma predeterminada, es una Tabla del mismo Proyecto, pero puedes utilizar [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) para seleccionar una Tabla de otro Proyecto.
...
- Utiliza [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) cuando la Tabla de destino esté en un Proyecto distinto del de la Automatización.
...
- [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) — crea Registros en Tablas que se encuentran fuera del Proyecto actual
