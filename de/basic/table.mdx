...
Wenn andere Tabellen auf die Tabelle verweisen, die Sie löschen, listet der Bestätigungsdialog die Felder auf, die vom Löschen betroffen sind, sowie die jeweilige Projekt und Tabelle. Beim Löschen der Tabelle werden diese Verknüpfungsfelder in einzeilige Textfelder umgewandelt, die die Titel der verknüpften Datensätze beibehalten; darauf aufbauende Lookup- oder Rollup-Felder funktionieren anschließend nicht mehr.
