...
- L'ID del Progetto, l'ID della Tabella e gli ID dei Campi. Consulta [Ottenere gli ID](/it/api-doc/get-id).
...
- Usa il PAT con i privilegi minimi: limitalo agli Spazi e ai Progetti necessari.
