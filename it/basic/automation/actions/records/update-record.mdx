...
- Usa [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) per aggiornare Record in una Tabella appartenente a un Progetto diversa.
...
- [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) — aggiorna Record in Tabelle esterne al Progetto corrente
