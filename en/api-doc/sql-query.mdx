...
<img alt="pg connection" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/dd60fcb2becb23c5.png" />
...
<img alt="baseId" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/e8ef17c59ac0c067.png" />

1. 进入数据库设计界面（表格右上角的 ⚙ 图标），里面的 schema 名就是 baseId。

<img alt="Design page" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/64fbddbd0f5519c4.png" />

### 连接数据库

在不同的产品上，连接数据库的方式略有不同，但大同小异，我们这里进行一个简单的示例

<img alt="Connection example" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/ceef01dd644628f4.png" />
...
<img alt="table info" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/ba2fdb846b2062ce.png" />
...
<img alt="db field name" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/7609033391e8e7c1.png" />
...
<img alt="base id in TablePlus" style={{ maxWidth: '50%' }} src="/images/kai-fa-zhe/093aebb4bc8cf732.png" />
