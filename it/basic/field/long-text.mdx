...
- Gli indirizzi web contenuti nel testo diventano link cliccabili in automatico, senza impostare nulla. Nel Record espanso, un pulsante accanto al campo di inserimento elenca tutti gli indirizzi trovati nella cella.
- Testo lungo non supporta la visualizzazione interattiva Email o Telefono. Usa un Campo **Testo su una riga** quando vuoi fare clic su un indirizzo o un numero per scrivere o chiamare.
