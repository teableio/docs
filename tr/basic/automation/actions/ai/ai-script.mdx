...
Komut dosyanız Slack, Airtable veya Google Sheets gibi bir hizmete ihtiyaç duyuyorsa hesaplarınızı bağlamak için AI panelinin üst kısmındaki entegrasyon düğmelerine tıklayın. AI, kod oluştururken bu bağlantıları kullanır.
