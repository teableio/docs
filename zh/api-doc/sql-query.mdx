...
![](/images/api/sql-query/2026-05-29-sql-query-open-design-page-zh.png)

3. **找到数据库连接面板**：在设计页面中，找到「数据库连接」面板。
4. **创建连接**：点击创建，系统将自动生成一个只读的 PostgreSQL 连接，包括用户名、密码和连接地址。

![](/images/api/sql-query/2026-05-29-sql-query-database-connection-panel-zh.png)
