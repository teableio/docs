...
- **[Opérations de requête de Table](/fr/basic/admin-panel/table-query-ops)** : configurez la couverture de recherche par Table, créez des index et suivez les résultats
...
- **[Schema integrity](/fr/basic/admin-panel/schema-integrity)** : lancez des vérifications de schéma sur n’importe quelle base et réparez ce qu’elles trouvent
