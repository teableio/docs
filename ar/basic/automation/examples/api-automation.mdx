...
- معرّف المشروع ومعرّف الجدول ومعرّفات الحقول. راجع [الحصول على المعرّفات](/ar/api-doc/get-id).
...
- استخدم رمز PAT بأقل قدر من الصلاحيات، واقصره على المساحات والمشاريع التي يحتاج إليها.
