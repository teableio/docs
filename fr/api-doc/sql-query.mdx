...
1. **Ouvrir une Table** : commencez par ouvrir une Table du Projet auquel vous souhaitez vous connecter.
2. **Accéder à la page de conception** : cliquez sur l’icône ⚙️ en haut à droite pour accéder à la page de conception du Projet.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-open-design-page-en.png"
  alt="Ouvrir la page de conception du Projet"
...
- **Nom du schéma (BaseId)** : l’identifiant du Projet commençant par `bse`
...
Chaque Projet dans Teable correspond à un **schéma** dans PostgreSQL. Le BaseId est le nom du schéma utilisé dans les requêtes SQL.
...
<img
  ...
  alt="ID du Projet dans l’URL"
  className="docs-screenshot"
/>

**Méthode 2 :** dans l’interface de conception du Projet, le nom de schéma affiché est le BaseId.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-design-page-schema.png"
  alt="Nom du schéma dans la page de conception du Projet"
  className="docs-screenshot"
/>

### Trouver les noms de Tables

Les noms de Tables dans l’interface Teable ne se synchronisent pas automatiquement avec les noms des Tables physiques de la base de données. Consultez l’interface de conception du Projet pour connaître le nom réel de la Table de base de données.
...
La connexion à la base de données est limitée au Projet actuel. Les schémas PostgreSQL assurent l’isolation des autorisations, garantissant que vous ne pouvez accéder qu’aux Tables de votre Projet.
...
<img
  ...
  alt="ID du Projet dans TablePlus"
  className="docs-screenshot"
/>
