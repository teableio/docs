...
<Steps>
  ...
  <Step title="Aufbau der Tabelle wählen">
    Beim Erstellen einer neuen Tabelle bietet Teable **Mit KI importieren** oder **Manuell importieren** an. Die KI-Variante erscheint nur, wenn AI Chat in dieser Base für Sie verfügbar ist.
  </Step>
...
Nach dem Upload bietet Teable **Mit KI optimieren und importieren** an. **Mit KI importieren** übergibt die Datei an AI Chat: Die KI analysiert die Daten, passt Tabellenstruktur, Verknüpfungen und Feldtypen an und führt den Import aus. Der Importdialog schließt sich, das Chat-Panel öffnet sich, sodass Sie den Fortschritt verfolgen und das Ergebnis per Antwort steuern können. Das verbraucht KI-Guthaben und setzt die Berechtigung zum Erstellen von Tabellen voraus. Deshalb erscheint das Angebot nur, wenn AI Chat für Sie verfügbar ist, und nie beim Import in eine bestehende Tabelle.
