...
| **Projet** | `base\|read`, `base\|read_all`, `base\|update`, `base\|table_import`, `base\|table_export`, `base\|query_data` |
...
En général, la première étape après l’obtention d’un jeton consiste à récupérer toutes les Projets accessibles à l’utilisateur actuel :
...
Ce point de terminaison renvoie toutes les Projets auxquelles l’utilisateur actuel est autorisé à accéder. Vous pouvez utiliser le `baseId` de la réponse pour les appels API suivants.
