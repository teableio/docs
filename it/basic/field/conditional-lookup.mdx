...
<Steps>
  ...
  <Step title="Rimuovi valori duplicati">
    Attiva **Rimuovi valori duplicati**: ogni valore compare una sola volta, nell’ordine originale. La deduplicazione avviene dopo filtro, ordinamento e limite di Record, quindi il limite conta i Record corrispondenti e non i valori rimasti nel risultato.
  </Step>
</Steps>
