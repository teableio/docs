...
This update brings formula enhancements, search behavior updates, App Builder preview improvements, and a set of V2 database engine stability improvements.

<AccordionGroup>
<Accordion title="Field & Data Updates (4)">
...
<Accordion title="App Builder & AI Experience Improvements (3)">
...
<Accordion title="V2 Database Engine Upgrade — Invite-only Beta (3)">
...
- Improved progress handling during large undo/redo replays, with more stable feedback for long-running operations.
