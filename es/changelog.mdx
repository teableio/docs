...
<Update label="24 sep 2026">

# GPT-6 Sol y Luna ya están en Teable

<img alt="GPT-6 Sol y Luna ya están en Teable" src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/cc6ba26109a1a94ebeef51dde4864a8b.png" />

**GPT-6 Sol y Luna** sustituyen a GPT-5.6 Sol y Luna y ofrecen mejores capacidades de programación, respuestas más fiables y un mayor rendimiento en tareas empresariales complejas. En la evaluación de exactitud factual de OpenAI, GPT-6 Sol cometió **aproximadamente un 50 % menos de errores factuales** que su predecesor. Ambos modelos también se comunican con más claridad, con menos jerga y detalles innecesarios.

Estas mejoras ayudan a Teable AI a realizar tareas que van desde **analizar datos empresariales y resumir documentos hasta crear aplicaciones y ejecutar flujos de trabajo de varios pasos**. Como parte de esta actualización de modelos, **GPT-5.6 Terra se retira**.

Ya puedes probar GPT-6 Sol y Luna en **AI Chat, App Builder, los campos de IA y las automatizaciones** de Teable.

</Update>

<Update label="21 sep 2026">

# Conecta más de 1500 aplicaciones a Teable AI

Llega una gran actualización: Teable ahora se conecta con más de 1500 aplicaciones, como YouTube, X, LinkedIn, Attio, Gmail, n8n y Zapier. Importa los datos de tu negocio a Teable y deja que la IA realice acciones en tus aplicaciones conectadas, todo mediante una conversación.

<img loading="lazy" alt="Conecta más de 1500 aplicaciones a Teable AI" src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png" />

Aquí tienes algunos ejemplos de cómo esta actualización puede transformar tu forma de trabajar.

## 1. Convierte las consultas de Gmail en oportunidades de venta

Pide: «Busca en Gmail los correos con consultas de clientes de esta semana. Añade a esta tabla el nombre, la dirección de correo electrónico, la empresa y las necesidades de cada remitente, y sugiere una acción de seguimiento para cada uno».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Convierte las consultas de Gmail en oportunidades de venta","description":"Pide: «Busca en Gmail los correos con consultas de clientes de esta semana. Añade a esta tabla el nombre, la dirección de correo electrónico, la empresa y las necesidades de cada remitente, y sugiere una acción de seguimiento para cada uno».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/d1303a026ac1f7f2f50ebafec680914d.mp4"}) }} />
...
## 2. Importa contactos de Attio a Teable

Pide: «Importa a esta tabla los nuevos contactos de esta semana desde Attio, con su nombre, empresa, correo electrónico, origen del lead y estado del lead. Resume el número de contactos por origen y estado del lead».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Importa contactos de Attio a Teable","description":"Pide: «Importa a esta tabla los nuevos contactos de esta semana desde Attio, con su nombre, empresa, correo electrónico, origen del lead y estado del lead. Resume el número de contactos por origen y estado del lead».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/170a2b241f177ba21e32ee8efeff3308.mp4"}) }} />
...
## 3. Redacta, publica y haz seguimiento de publicaciones de LinkedIn

Pide: «Redacta un borrador de una publicación de LinkedIn a partir de esta tabla. Cuando lo apruebe, publícalo y guarda el enlace y el estado de la publicación en la tabla».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Redacta, publica y haz seguimiento de publicaciones de LinkedIn","description":"Pide: «Redacta un borrador de una publicación de LinkedIn a partir de esta tabla. Cuando lo apruebe, publícalo y guarda el enlace y el estado de la publicación en la tabla».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/afeb048ddf990631cfc581095521e27c.mp4"}) }} />
...
<Update label="20 sep 2026">

# Integraciones con X, cálculos y optimización del rendimiento

## Nuevas funciones

* **Compatibilidad con la integración OAuth de X**: conecta servicios como X que requieren una aplicación OAuth propia del despliegue; configura las integraciones por clave API mediante formularios de credenciales.

## Correcciones y mejoras

* **Interacciones con las tarjetas del chat mejoradas**: las tarjetas pendientes de autorización, conexión, selección, credenciales y preguntas ya no bloquean los mensajes nuevos; sus diseños y acciones son más claros.

* **Coherencia de los cálculos entre tablas mejorada**: las fórmulas encadenadas, las búsquedas, el inventario y las asignaciones se actualizan rápidamente cuando cambian los registros vinculados.

* **Corregido el desplazamiento inesperado al seleccionar un responsable**: el campo que se está editando permanece visible en los detalles del registro.

* **Conexiones de integraciones mejoradas**: indicadores de carga y estados vacíos más claros, junto con mejores controles móviles, facilitan la comprensión de las conexiones.

* **Estabilidad de las operaciones de tablas mejorada**: se reducen los errores falsos de «Tabla no encontrada» durante los cambios de campos y se mejora la gestión de importaciones pendientes o fallidas.

* **Rendimiento de la eliminación de registros vinculados mejorado**: eliminación de vínculos más rápida y fiable en relaciones obligatorias, autorreferenciales, unidireccionales, bidireccionales, calculadas y enviadas a la papelera.

* **Corregidos los fallos de la cola de mensajes de App Builder**: los mensajes en cola ahora entran en el proceso de generación; los mensajes afectados anteriormente deben volver a enviarse.

* **Corregida la desalineación de la vista de cuadrícula al desplazarse rápidamente**: los registros vistos anteriormente ya no aparecen brevemente en una posición incorrecta.

* **Reconexión de tablas inactivas mejorada**: se muestra el progreso de recuperación, evitando mensajes prematuros de «tabla no disponible».

- **Disponibilidad de las funciones de Sheet ajustada**: debido a limitaciones de compatibilidad, el diseñador de formularios, la vista previa y el panel para compartir de Sheet no están disponibles en esta versión.

- **Corregida la carga de vistas personales**: las vistas personales ya no se quedan ocasionalmente en blanco con un marcador de carga; el contenido aparece sin actualizar la página.

- **Redirecciones de plantillas públicas mejoradas**: los enlaces obsoletos a plantillas públicas ahora redirigen a la página de plantillas de Teable en lugar de devolver un error 404.

- **Rendimiento de las operaciones de datos mejorado**: las operaciones de tablas, registros, campos y consultas SQL son más rápidas y mejoran la respuesta con grandes conjuntos de datos.

- **Corregido el contenido desplegable**: el contenido desplegable cuyas dimensiones se acaban de medir ahora se abre correctamente, mejorando la estabilidad de las interacciones en la página.

- **Rendimiento de la colaboración en tiempo real mejorado**: se reducen las actualizaciones y consultas periódicas innecesarias durante los cambios de configuración de las vistas para una colaboración más fluida.

- **Coherencia de la lista de tablas mejorada**: la lista refleja los cambios estructurales, incluidas las actualizaciones de campos, con mayor rapidez y precisión.

- **Corregido el desplazamiento del menú de miembros**: las listas de miembros de los registros expandidos vuelven a desplazarse, facilitando la búsqueda y selección de miembros.

</Update>


<Update label="18 sep 2026">

# Mejoras de ejecución continua, rendimiento y estabilidad

## Nuevas funciones

* **Orientación ante fallos de guardado en App Builder**: ofrece consejos de limpieza y envía los detalles del fallo a la IA cuando no se pueden guardar versiones demasiado grandes.

* **Ejecución continua de Routines**: las Routines se ejecutan hasta completarse, fallar o detenerse manualmente; los historiales ahora muestran las horas de inicio y finalización.

## Correcciones y mejoras

* **Flujo de vista previa de plantillas mejorado**: crea una copia nueva y abre la configuración, como en el Centro de plantillas; corrige la carga de registros de la cuadrícula.

* **Inicio del chat de App Builder mejorado**: los chats se abren en modo de vista previa por defecto, con etiquetas más claras para la información del entorno copiada al portapapeles.

* **Guardado de Bases compartidas más fiable**: corrige los fallos cuando faltan tablas o campos vinculados.

* **Ordenación de campos de fecha más precisa**: ordena por marcas de tiempo completas aunque las horas estén ocultas; los grupos de fechas siguen respetando el formato de visualización.

* **Notificaciones de asignación masiva de colaboradores mejoradas**: reduce los correos duplicados, resume varios registros y añade textos más claros y enlaces a las tablas.

* **Flujo de eliminación de cuentas mejorado**: enumera claramente los espacios en propiedad y las acciones necesarias; corrige las confirmaciones que se borraban en escritorio y los enlaces rotos en móviles.

* **Notificaciones de mensajes no leídos en chats compartidos mejoradas**: los marcadores de no leído y las alertas de respuesta siguen a la última persona que hizo una pregunta, evitando estados que no se borran para otros lectores.

* **Mejor rendimiento de Bases complejas**: acelera las Bases con registros vinculados complejos y cálculos Lookup para una navegación y unas operaciones más fluidas.

* **Rotación de Secrets mejorada**: conserva las vinculaciones de credenciales existentes para evitar reconfiguraciones; los nuevos permisos de acceso siguen requiriendo aprobación.

* **Inicio de sesión por código de verificación de correo más seguro**: añade comprobaciones de seguridad antes de enviar o reenviar códigos; las integraciones relacionadas deben realizar la verificación cuando esté habilitada.

* **Publicación de aplicaciones más fiable**: optimiza la publicación de proyectos con muchos Secrets vinculados, mejorando la velocidad y la tasa de éxito.

* **Guardado y cálculos de fórmulas más seguros**: comprueba los cambios antes de guardarlos; los cambios fallidos se mantienen como borradores, conservando las definiciones y los valores válidos sin sobrescribir los resultados.

* **Corregidos los paneles vacíos del historial de registros**: el historial ahora se muestra después de modificar campos Formula, Rollup y Conditional Rollup.

* **Registros de auditoría más precisos**: distingue los tokens de acceso personal creados por usuarios de las renovaciones automáticas de tokens, ayudando a los administradores a seguir las acciones con precisión.

* **Conexiones fiables con aplicaciones externas**: corrige las conexiones de Gmail y por clave API, evita que las conexiones canceladas reutilicen cuentas ajenas a ellas y garantiza el acceso del Agent.

</Update>


<Update label="17 sep 2026">

# Recopila datos de más de 800 sitios web con Teable AI

> Describe los datos que necesitas. Teable Agent los extrae de más de 800 sitios web y plataformas públicos, incluidos LinkedIn, Amazon, Google Maps, Instagram, TikTok, X (Twitter) y YouTube, todo en un solo lugar.

![Menú de extracción web de Teable AI con los sitios y plataformas compatibles](https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7a2d4ff8a1d9104e8aa3fa794c02a621.png)

## 1. Encuentra influencers de belleza y cuidado de la piel en YouTube

Pide: «Encuentra 50 influencers de belleza y cuidado de la piel en YouTube de Estados Unidos con entre 100.000 y 1 millón de suscriptores. Añade el nombre del canal, el número de suscriptores, la URL del canal y el correo de contacto a esta tabla».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Encuentra influencers de belleza y cuidado de la piel en YouTube","description":"Pide: «Encuentra 50 influencers de belleza y cuidado de la piel en YouTube de Estados Unidos con entre 100.000 y 1 millón de suscriptores. Añade el nombre del canal, el número de suscriptores, la URL del canal y el correo de contacto a esta tabla».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/487a8e5aeccbc5fc7fc42845d8003ca3.mp4"}) }} />
...
## 2. Encuentra negocios locales en Google Maps

Pide: «Encuentra 50 de las cafeterías mejor valoradas de Nueva York. Añade su nombre, puntuación, número de reseñas, dirección, teléfono, sitio web y URL de Google Maps a esta tabla».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Encuentra negocios locales en Google Maps","description":"Pide: «Encuentra 50 de las cafeterías mejor valoradas de Nueva York. Añade su nombre, puntuación, número de reseñas, dirección, teléfono, sitio web y URL de Google Maps a esta tabla».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/3aa2ad6bf1c17f9c006db20190b215c7.mp4"}) }} />
...
## 3. Compara productos en Amazon

Pide: «Encuentra 100 auriculares inalámbricos populares en Amazon. Añade el nombre del producto, el precio, la puntuación, el número de reseñas y la URL del producto a esta tabla».

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Compara productos en Amazon","description":"Pide: «Encuentra 100 auriculares inalámbricos populares en Amazon. Añade el nombre del producto, el precio, la puntuación, el número de reseñas y la URL del producto a esta tabla».","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/1878daa1adacb92d1f07c5f47eeb5bf0.mp4"}) }} />
...
<Update label="16 sep 2026">

# Mejoras en la generación de imágenes, las cuentas y la experiencia de uso

## Nuevas funciones

* **Generación de imágenes en cola**: sigue y cancela tareas, elige modelos y envía imágenes a las galerías desde el chat, la CLI, App Builder y Routines; solo se cobran las imágenes entregadas.

## Correcciones y mejoras

* **Eliminación de cuentas mejorada**: los flujos web unificados guían la transferencia de espacios o su envío a la papelera, sin tener que vaciarla ni salir manualmente de los espacios. Se mantienen las protecciones de las suscripciones.

* **Importación de proyectos `.tea` mejorada**: se conservan los marcadores de integraciones y secretos sin credenciales para facilitar la autorización; las exportaciones antiguas siguen siendo compatibles.

* **Gestión de integraciones y automatizaciones mejorada**: administra las autorizaciones en el diálogo Integrations y activa la automatización por flujo de trabajo.

* **Vistas previas de App Builder mejoradas**: al iniciar se muestra la última vista previa guardada, se conservan las utilizables tras fallos de configuración y se reducen los estados erróneos de detención o fallo.

* **API de generación multimedia actualizadas**: cada solicitud crea, consulta o cancela una tarea; ya no se admiten los flujos por lotes, de continuación ni de reintento.

* **Generación de imágenes más fiable**: una mejor gestión de fallos, solicitudes rechazadas, tareas atascadas y resultados duplicados aumenta la fiabilidad de los resultados y de la facturación.

* **Legibilidad del chat mejorada**: adjuntos y menciones más claros, contenido largo limitado a su área y filas de herramientas e imágenes contraídas reducen los saltos del diseño; los fallos siguen pudiendo desplegarse.

* **Estados de Routines mejorados**: estados de ejecución más precisos reducen los indicadores de error transitorios durante la carga.

* **Visibilidad de vistas restringidas mejorada**: las vistas inaccesibles ya no aparecen entre las vistas de tabla ni en las listas de visitas recientes.

* **Seguridad de cuentas y enlaces compartidos reforzada**: mejoras en las protecciones de cuentas, autenticación y enlaces; los enlaces existentes protegidos pueden pedir que se vuelva a introducir la contraseña.

* **Inicio de sesión mejorado**: los usuarios que vuelven sin sesión acceden a la página de inicio de sesión; cambiar de pestaña de autenticación conserva el correo y la contraseña introducidos.

* **Eliminación permanente mejorada**: eliminar tablas o bases permanentemente también borra sus comentarios y suscripciones a comentarios, evitando contenido huérfano.

* **Visibilidad de la opción de importación corregida**: la opción se muestra y abre correctamente cuando importar es la única acción disponible.

* **Acceso a adjuntos corregido**: se restauran los enlaces de adjuntos de Aliyun OSS y se mantienen las descargas mediante otros servicios de almacenamiento compatibles.

* **Referencias de campos importados corregidas**: los campos de clasificación y generación con IA ya no apuntan a los proyectos originales, evitando errores engañosos de referencias circulares al copiar o publicar plantillas.

* **Favicons más nítidos**: mayor claridad en pestañas del navegador, vistas previas de enlaces y pantallas de alta densidad.

* **Permisos de campo corregidos**: aplicar permisos ya no oculta ni bloquea campos incorrectamente, ni restringe de forma inesperada registros sin restricciones de campo.

</Update>


<Update label="15 sep 2026">

# Optimización del inicio de sesión, la automatización y el rendimiento

## Nuevas funciones

* **Inicio de sesión con código de verificación por correo**: tras configurar el correo, los usuarios registrados pueden acceder fácilmente con un código.

* **Inicio de sesión con Apple**: una vez configurado, el acceso web admite Apple junto con Google, GitHub y OIDC.

* **Ámbitos de autorización para Routines**: los tokens de acceso personal y las apps OAuth pueden autorizar el acceso a Routines para facilitar la integración de automatizaciones.

* **Gestión de Routines por CLI**: permite actualizar, activar, desactivar o iniciar Routines desde la CLI dentro de los permisos existentes.

* **Visualización de resultados de Routines**: los detalles de ejecución muestran la respuesta final del asistente cuando está disponible, para revisar el resultado rápidamente.

## Correcciones y mejoras

* **Carga de imágenes optimizada**: la compatibilidad se ajusta a las capacidades del nivel de modelo de IA seleccionado, garantizando funciones de imagen compatibles.

* **Gestión de archivos de App Builder corregida**: se resolvieron problemas de enlaces y descargas; los archivos generados se abren en el visor adecuado.

* **Edición de scripts de automatización mejorada**: los cambios se conservan al cerrar los diálogos y las pruebas usan la última configuración guardada para ofrecer resultados coherentes.

* **Visualización de notificaciones mejorada**: las notificaciones apiladas permanecen claramente visibles cuando aparecen varios mensajes a la vez.

* **Botón del chat de IA corregido**: el botón de envío ya no se comprime en diseños estrechos, mejorando la usabilidad.

* **Experiencia en chino de Routines mejorada**: se ajustaron la terminología en chino simplificado, el estilo del editor y la coherencia de los formularios para facilitar la configuración.

* **Documentación del producto y la API mejorada**: se sustituyó «Base» por «Project» y se aclararon los títulos de las rutas y los ejemplos de autenticación.

* **Aislamiento de permisos de apps y automatizaciones reforzado**: impide el acceso entre proyectos, espacios, integraciones o tenants; los flujos con permisos heredados amplios requieren revisión.

* **Estabilidad de consultas mejorada**: las consultas lentas de registros, recuentos y agregaciones admiten tiempos de espera y errores más claros para evitar el uso excesivo de recursos.

* **Rendimiento de consultas optimizado**: se omiten los recuentos totales innecesarios por defecto y se mantienen cuando hacen falta, reduciendo la carga de la base de datos.

* **Paginación más fiable**: eliminar registros usados como cursor ya no causa resultados incompletos o truncados; los cursores inválidos o incompatibles muestran errores.

* **Filtrado de valores múltiples corregido**: «Contiene» y «No contiene» funcionan cuando los campos JSON o de valores múltiples incluyen apóstrofos.

* **Estabilidad de campos calculados mejorada**: cálculos más fiables y eficientes; las advertencias solo desaparecen tras recalcular los campos relacionados.

* **Actualizaciones de vistas optimizadas**: las vistas restauradas al deshacer, rehacer o recuperar de la papelera aparecen inmediatamente, con menos actualizaciones innecesarias de tablas y vistas.

</Update>



<Update label="14 sep 2026">

# Mejor compatibilidad con la escritura de derecha a izquierda

Teable ahora admite **el hebreo como idioma de la interfaz**, junto con mejoras integrales en **la experiencia de derecha a izquierda (RTL) en árabe y hebreo**. Desde el diseño de las páginas y la navegación hasta la presentación del contenido, estos ajustes hacen que la interfaz resulte más natural e intuitiva para quienes leen y trabajan en estos idiomas.

Creemos que la localización debe estar presente en cada interacción, para que personas de distintas lenguas y culturas puedan convertir sus ideas en realidad de una forma que les resulte familiar.
...
- **Diseños que siguen tu idioma.** Las barras laterales, los menús y los cuadros de diálogo se adaptan al uso de derecha a izquierda.
- **Mejor escritura en AI Chat y App Builder.** Los campos de entrada del chat siguen la dirección del texto del idioma de tu interfaz.
- **Contenido multilingüe más claro.** Los valores de las celdas y los nombres de los registros detectan automáticamente la dirección del texto, facilitando la lectura del árabe o el hebreo junto al inglés.

</Update>


<Update label="13 sep 2026">

# Imágenes con IA, rendimiento y optimización de la experiencia

## Correcciones y mejoras

* **Estado de las rutinas más preciso**: Las rutinas se muestran como completadas de inmediato tras la generación del chat, lo que reduce los retrasos al cambiar de servicio durante el despliegue.

* **Mejor validación de los disparadores de automatización de correo electrónico**: Los errores de campos obligatorios aparecen solo después de editar los campos de conexión, lo que reduce las advertencias prematuras.

* **Mejor ayuda de la CLI**: Se han aclarado las opciones de alcance de Skill y los valores predeterminados del entorno para facilitar un uso más preciso de los comandos.

* **Mejor visualización de las llamadas a herramientas en el chat**: Las llamadas a herramientas permanecen agrupadas visualmente entre los pasos y el razonamiento posterior, lo que mejora la claridad y la trazabilidad.

* **Compatibilidad ampliada con imágenes de IA**: Se han añadido opciones específicas y capacidades de transformación de imagen a imagen para GPT Image, Gemini, Seedream, Recraft, Muse, Grok Imagine y Arrow.

* **Menú de extracción de datos mejorado**: Los iconos y el diseño renovados evitan el truncamiento y permiten configurar las opciones dentro del panel para una configuración más clara y sencilla.

* **Mejor rendimiento de carga de las cuadrículas**: Se han reducido las solicitudes innecesarias al abrir cuadrículas, lo que agiliza las actualizaciones de estado durante los cálculos de fórmulas, Lookup y Rollup.

* **Mejor validación de formularios**: Los errores permanecen dentro del formulario en lugar de aparecer sin gestionar; los campos que faltan muestran siempre «Obligatorio» para resolverlos más rápido.

* **Mayor estabilidad de la generación de imágenes con IA**: Se han mejorado la validación, la gestión de resultados, la salida SVG de Arrow y la conservación de los tipos y extensiones de los archivos subidos.

* **Cambios en las conexiones del disparador de correo electrónico**: «Cuando se recibe un nuevo correo electrónico» bloquea la configuración o la reautorización de Gmail/Outlook; se conservan los registros existentes e IMAP.

</Update>


<Update label="12 sep 2026">

# Mejoras en las tareas de automatización, el chat y la estabilidad

## Actualizaciones de funciones

* **Se han añadido rutinas programadas**: Crea, programa, ejecuta, pausa y supervisa tareas del Agente con plantillas, historial de ejecuciones, navegación en la barra lateral y herramientas del Agente y de la CLI.

## Correcciones de errores y mejoras

* **Mejor programación de rutinas**: Se han perfeccionado las zonas horarias, el horario de verano, las reglas de recurrencia, las programaciones de una sola ejecución y la sincronización para garantizar una ejecución fiable.

* **Mejor gestión de las cuotas de las rutinas**: Las rutinas se pausan automáticamente tras cinco fallos consecutivos por cuota y cancelan las ejecuciones futuras para evitar el desperdicio de recursos.

* **Mayor fiabilidad de las rutinas**: Se han mejorado la recuperación, la limpieza tras la eliminación, las ejecuciones manuales y la navegación a la actividad y al historial de ejecuciones.

* **Gestión del chat mejorada**: Las versiones web y móvil ahora permiten fijar, renombrar, archivar y eliminar chats, muestran indicadores de actividad y admiten la ordenación manual por parte del usuario.

* **Mayor coherencia del chat**: Se han perfeccionado el historial de mensajes, la salida de herramientas, los comentarios, los mensajes en cola, los reintentos y la recuperación de la transmisión en tiempo real.

* **Mejor renderizado de mensajes largos**: Se ha aumentado la eficiencia de las respuestas en tiempo real, especialmente para la lectura en dispositivos móviles.

* **Mejores permisos y estado de lectura del chat**: Las acciones no autorizadas muestran mensajes claros; las respuestas en segundo plano permanecen sin leer después de cambiar de conversación.

* **Mejores resúmenes de cambios del chat**: Los recursos eliminados ahora aparecen como no disponibles en lugar de enlazar a destinos no válidos.

* **Corregida la duplicación de imágenes adjuntas**: Se ha resuelto la duplicación de imágenes al pegar contenido en el área de carga.

* **Mejor edición y recuperación de archivos adjuntos**: Se han corregido los bloqueos al reemplazar imágenes y la recuperación tras cargas fallidas, para que los archivos adjuntos puedan editarse, eliminarse y enviarse.

* **Mejores interacciones con los registros expandidos**: Se ha corregido el desplazamiento de los menús desplegables de selección única y se ha evitado el cierre accidental al pulsar Escape.

* **Mayor estabilidad al ajustar campos**: Eliminar o reordenar campos mientras se cambia el tamaño de las columnas ya no bloquea la cuadrícula ni aplica anchos incorrectos.

* **Mejores resultados de búsqueda global**: La búsqueda ahora respeta la visibilidad de los campos y excluye el contenido de los campos ocultos de las coincidencias y del recuento de resultados.

* **Mejor autorización de conexiones alojadas**: Se han agilizado los reintentos cuando la autorización se deniega, cancela, bloquea o falla; las autorizaciones existentes de Gmail alojado siguen siendo compatibles.

* **Mejor limpieza de campos vinculados**: Al eliminar campos vinculados o datos de vínculos almacenados, ahora se limpian de forma más completa los vínculos relacionados.

* **Mejores comprobaciones de integridad del esquema**: Se restauran las tablas que faltan cuando aún existen datos de esquema válidos y se gestionan de forma segura los campos vinculados eliminados parcialmente.

* **Mejor rendimiento de las tablas con mucho tráfico**: Se han reducido las operaciones duplicadas y mejorado la visualización simultánea, manteniendo los permisos y los requisitos de actualización de los datos.

* **Mayor estabilidad del inicio de sesión y la navegación en dispositivos móviles**: Se han añadido el inicio de sesión mediante el navegador del sistema con PKCE, el consentimiento, las sesiones reutilizables y la autenticación compartida, y se han agilizado el cambio de cuenta y las experiencias integradas.

* **Mejores páginas integradas en dispositivos móviles**: Se han simplificado los encabezados de las tablas, destacado la Configuración y mostrado en modo de solo lectura la información del plan, el uso, la facturación, los límites y la licencia de la versión autoalojada.

* **Mejores resúmenes de problemas de cálculo**: Se han añadido errores más claros, contexto de la base de datos, recuentos de campos afectados y de incidencias, e identificadores completos de los campos.

* **Documentación de referencia de la API pública actualizada**: Solo se muestran los endpoints que admiten autenticación mediante token de acceso, para que los desarrolladores encuentren más rápido las API disponibles.

* **Enlaces unificados de ayuda y documentación de complementos**: Se han estandarizado los enlaces en `help.teable.ai`, conservando los enlaces profundos compatibles.

</Update>


<Update label="11 sep 2026">

# Actualizaciones de seguridad, rendimiento y estabilidad

## Actualizaciones de funciones
- **Se ha añadido compatibilidad con credenciales seguras para las automatizaciones de correo electrónico**: Los disparadores de correo electrónico pueden usar credenciales autorizadas, evitando almacenar contraseñas y exponerlas en los diagnósticos.
- **Se han añadido resúmenes de cambios en los recursos del Chat**: Después de cada conversación, el Chat resume los recursos creados o modificados por el Agente.

## Correcciones de errores y mejoras
- **Mejor rendimiento y estabilidad de las tablas grandes**: Se han reducido los retrasos, los tiempos de espera agotados y los fallos al editar, insertar, pegar o reordenar registros en vistas antiguas.
- **Mayor fiabilidad del recuento de comentarios**: Los recuentos de comentarios ahora se actualizan con mayor rapidez y precisión al editar registros.
- **Mayor estabilidad de la actualización de la actividad de cálculo**: Se han mejorado las actualizaciones durante las reconexiones y los periodos de mucha actividad, respetando los permisos de acceso.
- **Búsqueda en tablas optimizada**: Solo se muestran los índices publicados y disponibles; se recurre correctamente al método alternativo cuando no existe ninguno y se mejoran los tiempos de respuesta en tablas grandes.
- **Corregida la configuración de visualización del campo Número**: La configuración de gráficos de barras o anillos ahora se borra al volver a la visualización numérica estándar.
- **Corregido el progreso de las operaciones del Agente**: Las tarjetas de progreso ahora se muestran correctamente al crear una aplicación y realizar otras acciones simultáneamente.
- **Mayor estabilidad de la navegación del Chat**: Se evita que los recursos creados en otras Bases provoquen redirecciones inesperadas o estados de procesamiento persistentes.
- **Corregido el cambio de modo del campo Usuario**: Las vistas de cuadrícula se cargan correctamente y las asignaciones existentes se conservan al cambiar entre selección única y múltiple.
- **Mayor seguridad de las exportaciones de App Builder**: Las copias y descargas excluyen las credenciales autorizadas y los secretos de conexión; los propietarios deben proporcionarlos por separado.

</Update>


<Update label="10 sep 2026">

# Ampliación de Scraper y mejoras de estabilidad

## Actualizaciones de funciones

* **Capacidades de Scraper ampliadas**: Se ha añadido la búsqueda de perfiles de X, contenido de Facebook, vendedores de Amazon, reseñas de Walmart y personas de Crunchbase, con etiquetas localizadas.

## Correcciones de errores y mejoras

* **Mejor acceso a conjuntos de datos menos habituales de Scraper**: La búsqueda muestra los modos de descubrimiento y admite identificadores de conjuntos de datos sin procesar con `discoverBy`.

* **Mejor flujo de trabajo de Scraper en la CLI**: `teable scrape run` devuelve los identificadores de las instantáneas de inmediato; usa `teable scrape status --wait` para esperar a que finalice la ejecución.

* **Mayor seguridad y precisión de facturación de Scraper**: Se han perfeccionado los límites y la reutilización de solicitudes pendientes para evitar cargos duplicados durante las consultas simultáneas de estado.

* **Mayor estabilidad del análisis de tablas en espacios de trabajo grandes**: Se han reducido los bloqueos de la base de datos y los errores 503 temporales para que el análisis sea más fiable.

* **Mejor seguimiento de las tareas de cálculo**: Se ha garantizado la coherencia de las reejecuciones por lotes dentro de cada etapa y se han aclarado los reintentos en serie para facilitar la resolución de problemas.

* **Nombre de la métrica de complejidad aclarado**: «Registros sucios» pasa a llamarse «Complejidad estimada», lo que facilita evaluar la carga de trabajo de cálculo.

* **Mejor terminología de las credenciales en aplicaciones y automatizaciones**: La acción «Rotar» de los secretos pasa a llamarse «Editar», sin cambiar el funcionamiento de las actualizaciones.

* **Corregidos los avatares de usuario en credenciales y configuraciones**: Los avatares de los propietarios se muestran correctamente y aparecen las iniciales cuando no hay avatar.

* **Mejores listas de uso de credenciales**: Solo se muestran los recursos adicionales, se truncan los nombres largos con información emergente, se conservan las acciones y se muestran las fechas y horas de concesión del acceso.

* **Mejores actualizaciones de campos calculados con alta concurrencia**: Se ha mejorado el procesamiento de datos para reducir los tiempos de espera agotados y los fallos de actualización.

* **Corregidas las incoherencias de los campos Lookup y Rollup**: Se ha unificado la gestión de las opciones guardadas y transformadas, las referencias entre Bases y los cambios de versión.

* **Mayor estabilidad de la carga de tablas y de las conexiones**: Se han reducido las solicitudes innecesarias durante las cargas iniciales, las reconexiones y las operaciones frecuentes para ofrecer un uso más fluido.

* **Corregidas las notificaciones de actividad de cálculo**: Se ha evitado que los errores de suscripción activen notificaciones globales no relacionadas.

* **Corregidos los filtros del campo Usuario tras los cambios de tipo**: Se conservan los filtros y los valores entre los modos de selección, evitando fallos y problemas de carga de la cuadrícula.

* **Corregidos los problemas de carga con búsquedas vacías**: Abrir la búsqueda con `Cmd+F` ya no provoca un bucle de carga de filas de la cuadrícula ni restablece los filtros, la ordenación y la agrupación.

* **Mayor fiabilidad de la carga de vistas compartidas**: Una carga más coherente de campos y registros reduce los datos ausentes o desincronizados.

</Update>


<Update label="9 sep 2026">

# Reconocimiento de URL, credenciales y optimización de la búsqueda

## Actualizaciones de funciones

* **Detección automática de URL**: Los enlaces clicables funcionan en los campos de texto, incluidos Fórmula, Rollup y Texto largo, con compatibilidad con caracteres chinos, japoneses y coreanos (CJK) y controles táctiles.

* **Enlaces automáticos en los campos de URL creados por IA**: Las nuevas columnas de sitios web y URL usan campos de texto sin formato con enlaces automáticos; las configuraciones existentes siguen siendo compatibles.

* **Gestión centralizada de credenciales**: Gestiona claves de API personales reutilizables y conexiones de terceros en Configuración › Integraciones, con permisos sobre los recursos y seguimiento del uso.

* **Vinculación segura de credenciales**: Las aplicaciones, las automatizaciones y los recursos transferidos conservan los marcadores de posición; los colaboradores vinculan las credenciales y usan alias para varios usuarios.

* **Confirmación de credenciales por la IA**: La creación asistida por IA solicita confirmación antes de usar credenciales y oculta las claves en la salida de las pruebas.

* **Acceso a datos de Scraper**: El menú «+» del chat incorpora una opción de Scraper para acceder a conjuntos de datos seleccionados, indicaciones localizadas y acceso basado en permisos.

* **Descubrimiento de Scraper en lenguaje natural**: Encuentra conjuntos de datos fuera del catálogo seleccionado y consulta con mayor claridad los datos de entrada necesarios para recopilar datos más rápido.

## Correcciones y mejoras

* **Mejor alcance de la búsqueda en todos los campos**: Se usan los índices configurados, se incluyen los campos recién añadidos y se limitan las búsquedas ILIKE sin índice a 20 campos aptos.

* **Mayor compatibilidad de la búsqueda de texto**: Los registros con valores de fecha incoherentes o no compatibles ya no se omiten ni provocan fallos.

* **Cronologías de cálculo más claras**: Las etiquetas de estado y las relaciones entre tareas mejoradas muestran el progreso desde las actualizaciones de origen hasta el procesamiento y la finalización.

* **Corregido el estado de cálculo de las tablas inactivas**: Las tablas inactivas ya no permanecen en «Comprobando el estado del cálculo» cuando otras tablas tienen tareas en cola.

* **Mejor visualización del uso de credenciales**: Los resúmenes ahora cuentan solo los recursos ocultos y truncan mejor los nombres largos de recursos y los alias.

* **Mayor fiabilidad de Scraper**: Las publicaciones no disponibles ya no aparecen como fallos de verificación y la extracción de datos de LinkedIn evita tiempos de espera agotados prematuros.

* **Mayor fiabilidad de las consultas de tablas**: Se aplican valores predeterminados adecuados cuando se omiten las opciones de consulta, evitando errores relacionados con los parámetros.

* **Vista general de Table Query Ops más rápida**: Solo se muestran datos recientes de forma predeterminada, lo que mejora los tiempos de carga de la página y la capacidad de respuesta de las funciones administrativas.

* **Cálculos y agregaciones condicionales más rápidos**: Se mejora el procesamiento con cargas elevadas para actualizar los datos y obtener resultados estadísticos más rápido.

* **Actividad de tablas en tiempo real más estable**: Se gestionan mejor los picos de carga y los retrasos en la actividad de cálculo, reduciendo los errores de conexión y los reintentos repetidos.

* **Mejor uso compartido y solicitudes por lotes**: Se ignoran los datos de actividad privada inaccesibles para evitar que un problema de permisos haga fallar toda la solicitud.

* **Corregida la autorización OAuth**: Las integraciones de App Builder siempre muestran las solicitudes de autorización y Google Sheets continúa más allá de la selección después de la autorización.

* **Compatibilidad uniforme con servicios OAuth**: Se ha armonizado la compatibilidad en App Builder Chat, General Chat, App Builder Agent Computer y los comandos relacionados de la CLI.

* **Mayor resistencia ante interrupciones breves de la base de datos**: Se reducen los errores intermitentes en tablas, registros, comentarios, uso compartido y chat durante la recuperación de la conexión.

* **Corregidos los resúmenes agrupados por fecha**: Los valores de los grupos ahora coinciden con los grupos diarios y mensuales visibles, en lugar de aparecer incorrectos o vacíos.

* **Corregidos los recuentos de comentarios filtrados**: Se han corregido los campos Lookup de fecha antiguos de un solo valor, conservando los permisos, la paginación, los grupos contraídos y la búsqueda por subcadenas.

</Update>


<Update label="8 sep 2026">

# Optimización de los cálculos, la búsqueda y la estabilidad

## Correcciones y mejoras

* **Mayor estabilidad de los campos calculados**: Se ha corregido el bloqueo de las tablas inactivas en «Comprobando el estado del cálculo» tras las actualizaciones de Lookup o de registros vinculados.

* **Mayor precisión de los cálculos de varios niveles**: Se han corregido las actualizaciones de fórmulas dependientes ausentes o retrasadas durante el recálculo de Lookup de varios pasos y de campos calculados.

* **Rendimiento de los campos calculados optimizado**: Se han reducido los cálculos y las actualizaciones de Lookup y Rollup innecesarios cuando no cambian los registros ni los resultados.

* **Mejores mensajes de estado de cálculo**: Se han evitado las advertencias falsas, aclarado las tareas vacías y conservado los errores sin resolver para un seguimiento preciso del progreso.

* **Mayor fiabilidad de la actividad de cálculo**: Los errores se muestran con claridad y el estado existente se conserva cuando las comprobaciones fallan o agotan el tiempo de espera.

* **Prevención de tareas no válidas redundantes**: Se han detenido los reintentos de tareas asociadas a Bases eliminadas o inexistentes para mejorar la estabilidad.

* **Mayor estabilidad de los documentos compartidos**: Se ha mejorado la gestión de errores de colaboración, carga y reproducción de actividad, con mensajes de permisos más claros.

* **Mejor configuración de IA**: Se han corregido los bloqueos cuando faltan datos del proveedor y se permite a los administradores guardar configuraciones vacías de proveedores personalizados.

* **Mejor rendimiento de la búsqueda en todos los campos**: Se han optimizado las búsquedas en tablas grandes para listas, recuentos, grupos y agregaciones, incluidos números, valores redondeados y palabras clave cortas.

* **Mayor capacidad de respuesta de las tareas de búsqueda**: Las consultas estadísticas ahora se detienen cuando los usuarios cambian o cancelan las búsquedas, reduciendo el tiempo y los recursos desperdiciados.

* **Mejor acceso para usuarios con restricciones**: Se han corregido los errores de permisos falsos en campos calculados que se pueden leer y se ha mejorado la fiabilidad tras los cambios de permisos o la reconexión.

</Update>


<Update label="7 sep 2026">

# GPT-6 ya está en Teable

<img src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/37090b20c8a36af0f383b011dfd7c48b.png" alt="GPT-6 ya está en Teable" />

GPT-6 Astra supone un gran avance en la resolución de tareas empresariales complejas. En comparación con GPT-5.6 Sol, completa **2,3 veces más flujos de trabajo empresariales de varios pasos** en AutomationBench, con puntuaciones aproximadamente **un 34 % superiores en tareas de ciencia de datos** y **un 50 % superiores en tareas de migración de bases de datos** en las evaluaciones de OpenAI.

Para los usuarios de Teable, esto significa una IA más capaz de analizar datos, crear aplicaciones y diseñar flujos de trabajo. Entiende mejor tus requisitos, mantiene el rumbo durante tareas largas y produce resultados más ajustados a las necesidades de tu negocio.

Ya puedes probarlo en Teable.

</Update>

<Update label="5 sep 2026">

# Eliminación de duplicados en Lookup y optimización de la importación con IA

## Actualizaciones de funciones

* **Se añade la eliminación de duplicados en campos Lookup**: Elimina valores duplicados de varios registros vinculados para obtener resultados más claros y legibles.

* **Se añaden recomendaciones de importación con IA**: Prioriza la importación con IA al crear tablas a partir de contenido existente para organizarlo de forma más rápida y precisa.

## Correcciones y mejoras

* **Mejora del indicador de ventana de contexto de Cuppy**: Un anillo de progreso gris neutro indica con mayor claridad la compresión automática del contexto.

* **Mejora del diseño de los filtros**: Los campos de entrada aprovechan el ancho disponible de la fila, con mejoras en los filtros de Usuario actual y de campos estadísticos.

* **Mejora de la estabilidad de los Webhooks públicos de automatización**: Corrige errores 429 persistentes por debajo de los límites de frecuencia documentados y garantiza que la limitación se recupere y restablezca correctamente.

* **Mejora de la fiabilidad de la importación con IA**: Gestiona mejor los rechazos por cuotas y los casos límite para ofrecer resultados más estables y coherentes.

* **Optimización de la búsqueda en tablas grandes**: Mejora la búsqueda en todos los campos para listas, recuentos, grupos, agregaciones, vistas compartidas y consultas simultáneas.

* **Optimización de la cancelación de consultas estadísticas**: Reduce el procesamiento innecesario cuando cambian los criterios de búsqueda o se cancelan consultas, mejorando la capacidad de respuesta.

* **Mejora de la estabilidad de las conversiones Rollup**: Corrige el cambio de «Matriz única» a «Contar todos» y valida los formatos según el nuevo tipo de resultado.

* **Mejora de la estabilidad y el rendimiento de las fórmulas anidadas**: Optimiza las comprobaciones repetidas de campos Adjuntos, Usuario o Lookup vacíos, reduciendo los tiempos de espera agotados al actualizar campos calculados.

* **Corrección del filtrado de campos Lookup**: «Contiene cualquiera → Usuario actual» ahora filtra correctamente los campos Usuario referenciados.
