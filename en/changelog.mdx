...
# GPT-6 Sol and Luna Are Now in Teable

<img alt="GPT-6 Sol and Luna Are Now in Teable" src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/cc6ba26109a1a94ebeef51dde4864a8b.png" />

**GPT-6 Sol and Luna** replace GPT-5.6 Sol and Luna, bringing stronger coding skills, more reliable answers, and better performance on complex business tasks. In OpenAI's factuality evaluation, GPT-6 Sol made **about 50% fewer factual errors** than its predecessor. Both models also communicate more clearly, with less jargon and fewer unnecessary details.

These improvements help Teable AI handle work from **analyzing business data and summarizing documents to building apps and running multi-step workflows**. As part of this model upgrade, **GPT-5.6 Terra is being retired**.

You can try GPT-6 Sol and Luna now in **AI Chat, App Builder, AI Fields, and automation** in Teable.
...
# Automation, Billing, and Stability Updates

## Feature Updates

* **Added custom domain renewal grace period**: Domains remain active seven days after Business expiration; owners receive expiration and deactivation notices.

* **Added connected-app event triggers**: Automations and Routines can use event data; copied workflows support reconnection during credential setup.

* **Added third-party app tool billing**: Calls use provider-priced credits shown in credit history; failures, searches, and blocked calls are free.

## Fixes & Improvements

* **Improved connector stability**: Expired, deleted, or replaced connections show disconnected, notify editors, and retain enabled status for reconnection.

* **Improved connector events and Routines**: Fixed event discovery, delayed runs, template installation, expired subscriptions, credit checks, and trigger test results.

* **Improved lookup and rollup display**: Lookup-based rollups show text and preserve numeric and Boolean types in standard and conditional rollups.

* **Improved connected app credential stability**: Fixed imports failing despite valid authorization and streamlined credential replacement and disconnection.

* **Improved billing accuracy for long-running jobs**: Prevented completed jobs from being charged repeatedly.

* **Improved numeric lookup sorting and grouping**: Values now sort numerically, with corrected grouping order for referenced linked records.

* **Improved AI session stability**: Enhanced model switching and recovery, especially for long-running Routines using non-default models.

* **Improved real-time linked record titles**: After bulk updates, many-to-one and one-to-one fields show saved titles without refreshing.

* **Improved application security and reliability**: Strengthened system protection and runtime stability for a more reliable experience.

</Update>

<Update label="Sep 21, 2026">

# Connect 1,500+ apps to Teable AI

A major update is here: Teable now connects to over 1,500 apps, including YouTube, X, LinkedIn, Attio, Gmail, n8n, and Zapier. Bring your business data into Teable and let AI take action across your connected apps—all through conversation.

<img loading="lazy" alt="Connect 1,500+ apps to Teable AI" src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png" />

Here are a few examples of how this update can transform the way you work.

## 1. Turn Gmail Inquiries into Sales Leads

Ask: "Find this week's customer inquiry emails in Gmail. Add the sender's name, email address, company, and requirements to this table, and suggest a follow-up for each."

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Turn Gmail Inquiries into Sales Leads","description":"Ask: \"Find this week's customer inquiry emails in Gmail. Add the sender's name, email address, company, and requirements to this table, and suggest a follow-up for each.\"","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/d1303a026ac1f7f2f50ebafec680914d.mp4"}) }} />
...
## 2. Bring Attio contacts into Teable

Ask: "Import this week's new contacts from Attio into this table, including name, company, email, lead source, and lead status. Summarize the number of contacts by source and lead status."

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Bring Attio contacts into Teable","description":"Ask: \"Import this week's new contacts from Attio into this table, including name, company, email, lead source, and lead status. Summarize the number of contacts by source and lead status.\"","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/170a2b241f177ba21e32ee8efeff3308.mp4"}) }} />
...
## 3. Draft, publish, and track LinkedIn posts

Ask: "Draft a LinkedIn post from this table. After I approve, publish it and save the post link and status back to the table."

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Draft, publish, and track LinkedIn posts","description":"Ask: \"Draft a LinkedIn post from this table. After I approve, publish it and save the post link and status back to the table.\"","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/5bf0078b379edd96d77b92041034e704.png"],"uploadDate":"2026-09-21T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/afeb048ddf990631cfc581095521e27c.mp4"}) }} />
...
# X integrations, calculations, and performance optimization

## Feature Updates

* **Added X OAuth integration support**: Connect services like X that require the deployment's own OAuth app; configure API key integrations through credential forms.

## Fixes & Improvements

* **Improved chat card interactions**: Pending authorization, connection, selection, credential, and question cards no longer block new messages; layouts and actions are clearer.

* **Improved cross-table calculation consistency**: Chained formulas, lookups, inventory, and allocations now update promptly when linked records change.

* **Fixed unexpected scrolling when selecting an Assignee**: The field being edited stays visible in record details.

* **Improved integration connections**: Clearer loading indicators and empty states, plus better mobile controls, make connections easier to understand.

* **Improved table operation stability**: Reduced false “Table not found” errors during field changes and improved pending or failed imports.

* **Improved linked-record deletion performance**: Faster, more reliable link removal across required, self-referencing, one-way, two-way, calculated, and recycled relationships.

* **Fixed App Builder message queue failures**: Queued messages now enter the generation process; previously affected messages must be resent.

* **Fixed grid view misalignment during fast scrolling**: Previously viewed records no longer briefly appear in the wrong position.

* **Improved reconnection for idle tables**: Recovery progress is shown, avoiding premature “table unavailable” messages.

- **Adjusted Sheet feature availability**: Due to compatibility limitations, the Sheet form designer, preview, and sharing panel are unavailable in this release.

- **Fixed personal view loading**: Personal views no longer occasionally remain blank with a loading placeholder; content appears without refreshing.

- **Improved public template redirects**: Outdated public template links now redirect to the Teable template page instead of returning a 404 error.

- **Improved data operation performance**: Faster table, record, field, and SQL query operations improve responsiveness with large datasets.

- **Fixed expandable content**: Recently measured expandable content now opens properly, improving page interaction stability.

- **Improved real-time collaboration performance**: Fewer unnecessary refreshes and polling requests during view configuration changes make collaboration smoother.

- **Improved table list consistency**: The table list reflects structural changes, including field updates, more promptly and accurately.

- **Fixed member dropdown scrolling**: Member lists in expanded records scroll again, making it easier to find and select members.
...
# Continuous operation, performance, and stability upgrades

## Feature Updates

* **App Builder save failure guidance**: Offers cleanup tips and sends failure details to AI when oversized versions cannot be saved.

* **Continuous Routine execution**: Routines run until completion, failure, or manual termination; histories now show start and end times.

## Fixes & Improvements

* **Improved template preview workflow**: Creates a new copy and opens settings, matching Template Center; fixes grid record loading.

* **Improved App Builder chat startup**: Chats open in preview mode by default, with clearer environment clipboard labels.

* **More reliable shared Base saving**: Fixes failures when linked tables or fields are missing.

* **More accurate Date field sorting**: Sorts by full timestamps despite hidden times; date groups still follow display formatting.

* **Improved bulk collaborator assignment notifications**: Reduces duplicate emails, summarizes multiple records, and adds clearer wording and table links.

* **Improved account deletion flow**: Clearly lists owned spaces and required actions; fixes cleared desktop confirmations and broken mobile links.

* **Improved shared chat unread notifications**: Unread markers and reply alerts follow the latest questioner, preventing uncleared states for other viewers.

* **Better complex Base performance**: Speeds up Bases with complex linked records and Lookup calculations for smoother browsing and operations.

* **Improved Secret rotation**: Preserves existing credential bindings to avoid reconfiguration; new access permissions still require approval.

* **Safer email verification code login**: Adds security checks before sending or resending codes; related integrations must verify when enabled.

* **More reliable app publishing**: Optimizes publishing for projects with many bound Secrets, improving speed and success rates.

* **Safer Formula saving and calculations**: Checks edits before saving; failures remain drafts, preserving valid definitions and values without overwriting results.

* **Fixed blank Record History panels**: History now displays after changes to Formula, Rollup, and Conditional Rollup fields.

* **More accurate audit logs**: Distinguishes user-created personal access tokens from automatic token refreshes, helping administrators track actions accurately.

* **Reliable external app connections**: Fixes Gmail and API Key connections, prevents canceled connections reusing unrelated accounts, and ensures Agent access.
...
# Collect data from 800+ websites with Teable AI

> Describe the data you need. Teable Agent scrapes it from 800+ public websites and platforms—including LinkedIn, Amazon, Google Maps, Instagram, TikTok, X (Twitter), and YouTube—all in one place.

![Teable AI Web Scraper menu with supported websites and platforms](https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7a2d4ff8a1d9104e8aa3fa794c02a621.png)

## 1. Find Beauty & Skincare Influencers on YouTube

Ask: “Find 50 YouTube beauty and skincare influencers in the US with 100K–1M subscribers. Add their channel name, subscriber count, channel URL, and contact email to this table.”

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Find Beauty & Skincare Influencers on YouTube","description":"Ask: “Find 50 YouTube beauty and skincare influencers in the US with 100K–1M subscribers. Add their channel name, subscriber count, channel URL, and contact email to this table.”","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/487a8e5aeccbc5fc7fc42845d8003ca3.mp4"}) }} />
...
## 2. Find Local Businesses on Google Maps

Ask: “Find 50 top-rated coffee shops in New York City. Add their name, rating, review count, address, phone number, website, and Google Maps URL to this table.”

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Find Local Businesses on Google Maps","description":"Ask: “Find 50 top-rated coffee shops in New York City. Add their name, rating, review count, address, phone number, website, and Google Maps URL to this table.”","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/3aa2ad6bf1c17f9c006db20190b215c7.mp4"}) }} />
...
## 3. Compare Products on Amazon

Ask: “Find 100 popular wireless headphones on Amazon. Add the product name, price, rating, review count, and product URL to this table.”

<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoObject","name":"Compare Products on Amazon","description":"Ask: “Find 100 popular wireless headphones on Amazon. Add the product name, price, rating, review count, and product URL to this table.”","thumbnailUrl":["https://dxshyegpql0u3hra.public.blob.vercel-storage.com/7578bb0b7da70ce0adbcb12aa6d95253.png"],"uploadDate":"2026-09-17T00:00:00+08:00","contentUrl":"https://dxshyegpql0u3hra.public.blob.vercel-storage.com/1878daa1adacb92d1f07c5f47eeb5bf0.mp4"}) }} />
...
# Image Generation, Account and Experience Upgrades

## Feature Updates

* **Added queued image generation**: Track, cancel, select models, and deliver images to galleries across chat, CLI, App Builder, and routines; pay only for delivered images.

## Fixes & Improvements

* **Improved account deletion**: Unified web flows guide space transfers or trashing; no trash emptying or manual exits required. Subscription safeguards remain.

* **Improved** **`.tea`** **project imports**: Preserve integration and secret placeholders without credentials for easy authorization; legacy exports remain supported.

* **Improved integration and automation management**: Manage authorization in the Integrations dialog and enable automation per workflow.

* **Improved App Builder previews**: Show last-saved previews on startup, preserve usable previews after setup failures, and reduce incorrect stopped/failed statuses.

* **Updated media generation APIs**: Create, retrieve, and cancel one task per request; batch, continuation, and retry flows are no longer supported.

* **Improved image generation reliability**: Better handling of failures, rejected requests, stalled tasks, and duplicate results improves output and billing reliability.

* **Improved chat readability**: Clearer attachments and mentions, contained long content, and collapsed tool/image rows reduce layout shifts; failures remain expandable.

* **Improved routine status displays**: More accurate execution statuses reduce transient error indicators during loading.

* **Improved restricted view visibility**: Inaccessible views no longer appear in table views or recently visited lists.

* **Improved account and shared-link security**: Strengthened account, authentication, and shared-link protections; existing password-protected links may require password re-entry.

* **Improved login experience**: Returning signed-out users reach the login page; switching authentication tabs preserves entered email addresses and passwords.

* **Improved permanent deletion**: Permanently deleting tables or bases also removes related comments and comment subscriptions, preventing orphaned content.

* **Fixed import entry visibility**: The import entry now displays and opens correctly when importing is the only available action.

* **Fixed attachment access**: Restored Aliyun OSS attachment links while preserving downloads through other supported storage services.

* **Fixed imported field references**: AI classification and generation fields no longer reference source projects, preventing misleading circular-reference errors when copying/publishing templates.

* **Improved favicon clarity**: Sharper favicons in browser tabs, link previews, and high-density displays.

* **Fixed field-level permissions**: Applying permissions no longer incorrectly hides/locks fields or unexpectedly restricts records without field restrictions.
...
# Login, Automation, and Performance Optimization

## Feature Updates

* **Added email verification code sign-in**: After email setup, registered users can sign in with a code for easier access.

* **Added Sign in with Apple**: Once configured, web sign-in supports Apple alongside Google, GitHub, and OIDC.

* **Added Routine authorization scopes**: Personal access tokens and OAuth apps can authorize Routine access for easier automation integration.

* **Added Routine CLI management**: Use the CLI to update, enable, disable, or start Routines within existing permissions.

* **Added Routine result display**: Run details show the assistant’s final response when available for quick result review.

## Fixes & Improvements

* **Optimized image uploads**: Upload support now matches the selected AI model tier’s capabilities, ensuring compatible image features.

* **Fixed App Builder file handling**: Resolved file link and download issues, ensuring generated files open in the appropriate previewer.

* **Improved automation script editing**: Edits persist after closing dialogs, and workflow tests use the latest saved configuration for consistent results.

* **Improved notification display**: Stacked notifications now remain clearly visible when multiple messages appear simultaneously.

* **Fixed AI chat button display**: Prevented the send button from being compressed in constrained layouts, improving chat usability.

* **Improved Routine’s Chinese experience**: Refined Simplified Chinese terminology, editor styling, and form consistency for easier configuration.

* **Improved product and API documentation**: Replaced “Base” with “Project” and refined API route titles and authentication examples.

* **Strengthened app and automation permission isolation**: Prevents cross-project, space, integration, or tenant access; workflows using broad inherited permissions require review.

* **Improved record query stability**: Supports timeouts for slow record, count, and aggregation queries, with clearer errors to prevent resource overuse.

* **Optimized record query performance**: Skips unnecessary total counts by default while retaining them when required, reducing database load.

* **Improved record pagination reliability**: Deleting cursor records no longer causes missing or truncated results; invalid or mismatched cursors show errors.

* **Fixed multi-value filtering**: “Contains” and “does not contain” now work when JSON or multi-value field content includes apostrophes.

* **Improved calculated field stability**: Enhances calculation reliability and efficiency, clearing calculation warnings only after related fields finish recalculating.

* **Optimized view updates**: Views restored through undo, redo, or trash appear immediately, with fewer unnecessary table and view refreshes.

</Update>


<Update label="Sep 14, 2026">

# Improved right-to-left support

Teable now supports **Hebrew as an interface language**, alongside comprehensive improvements to the **right-to-left (RTL) experience for Arabic and Hebrew**. From page layouts and navigation to how content is displayed, these refinements make the interface feel more natural and intuitive for users who read and work in these languages.

We believe localization should extend to every interaction, so people across languages and cultures can turn their ideas into reality in ways that feel familiar.
...
- **Layouts that follow your language.** Sidebars, menus, and dialogs adapt to right-to-left use.
- **Better typing in AI Chat and App Builder.** Chat inputs follow your interface language’s text direction.
- **Clearer mixed-language content.** Cell values and record names automatically detect text direction, making Arabic or Hebrew easier to read alongside English.

</Update>


<Update label="Sep 13, 2026">

# AI imaging, performance, and experience optimization

## Fixes & Improvements

* **More accurate Routine status**: Routines show completed promptly after chat generation, reducing service-switching delays during deployment.

* **Improved email automation trigger validation**: Required-field errors appear only after editing connection fields, reducing premature warnings.

* **Improved CLI help**: Clarified Skill scope options and environment defaults for easier, more accurate command usage.

* **Improved chat tool call display**: Tool calls remain visually grouped across steps and subsequent reasoning, improving clarity and traceability.

* **Expanded AI image support**: Added tailored options and image-to-image capabilities for GPT Image, Gemini, Seedream, Recraft, Muse, Grok Imagine, and Arrow.

* **Improved Scrape Data menu**: Redesigned icons and layout prevent truncation and enable in-panel configuration for clearer, easier setup.

* **Improved Grid loading performance**: Reduced unnecessary requests when opening Grids, smoothing status updates during formula, lookup, and rollup calculations.

* **Improved form validation**: Errors remain in-form instead of appearing unhandled; missing fields consistently show “Required” for quicker resolution.

* **Improved AI image generation stability**: Enhanced validation, result handling, Arrow SVG output, and preservation of uploaded file types and extensions.

* **Email trigger connection changes**: “When a new email is received” blocks Gmail/Outlook setup or reauthorization; existing records and IMAP remain.

</Update>


<Update label="Sep 12, 2026">

# Automation tasks, chat, and stability upgrades

## Feature Updates

* **Added Scheduled Routines**: Create, schedule, run, pause, and monitor Agent tasks with templates, run history, sidebar navigation, Agent, and CLI tools.

## Bug Fixes & Improvements

* **Improved Routine scheduling**: Refined time zones, daylight saving time, recurrence rules, one-time schedules, and synchronization for reliable execution.

* **Improved Routine quota handling**: Routines automatically pause after five consecutive quota failures and cancel future runs to prevent waste.

* **Improved Routine reliability**: Enhanced recovery, deletion cleanup, manual runs, and navigation to activity and run history.

* **Enhanced chat management**: Web and mobile now support pinning, renaming, archiving, deleting, activity indicators, and manual user sorting.

* **Improved chat consistency**: Refined message history, tool output, feedback, queued messages, retries, and streaming recovery.

* **Improved long-message rendering**: Increased streaming response efficiency, especially for mobile reading.

* **Improved chat permissions and read status**: Unauthorized actions show clear messages; background replies remain unread after switching conversations.

* **Improved chat change summaries**: Deleted resources now appear unavailable instead of linking to invalid destinations.

* **Fixed duplicate image attachments**: Resolved duplicate images when pasting content into the upload area.

* **Improved attachment editing and recovery**: Fixed stuck image replacement and failed-upload recovery, ensuring attachments can be edited, removed, and sent.

* **Improved expanded-record interactions**: Fixed Single-select dropdown scrolling and prevented accidental closure when pressing Escape.

* **Improved field adjustment stability**: Deleting or reordering fields while resizing columns no longer crashes the grid or misapplies widths.

* **Improved global search results**: Search now respects field visibility, excluding hidden-field content from matches and result counts.

* **Improved Hosted Connection authorization**: Added smoother retries for denied, canceled, blocked, or failed authorization; existing Hosted Gmail authorizations remain supported.

* **Improved linked-field cleanup**: Deleting linked fields or stored link data now cleans up related links more completely.

* **Improved Schema integrity checks**: Restored missing tables when valid schema data remains and safely handled partially deleted linked fields.

* **Improved performance for high-traffic tables**: Reduced duplicate operations and improved concurrent viewing while preserving permissions and fresh-data requirements.

* **Improved mobile login and navigation stability**: Added system-browser login with PKCE, consent, reusable sessions, shared authentication, and smoother account switching and embedded experiences.

* **Improved mobile embedded pages**: Simplified table headers, highlighted Settings, and displayed plan, usage, billing, limits, and self-hosted license information read-only.

* **Improved calculation issue summaries**: Added clearer errors, database context, affected-field counts, occurrence counts, and complete field identifiers.

* **Updated Public API reference documentation**: Show only endpoints supporting access-token authentication, helping developers find available APIs faster.

* **Unified help and plugin documentation links**: Standardized links on `help.teable.ai` while preserving supported deep links.
...
<img src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/37090b20c8a36af0f383b011dfd7c48b.png" alt="GPT-6 now in Teable" />
...
<img loading="lazy" alt="Teable Cloud yearly pricing with Pro and Business credit allocations" src="/images/changelog/2026-09-04-new-pricing-more-ai-credits.png" />
...
Since the beginning of the year, <strong>Teable’s paid user base has grown more than 60×.</strong> Teams are increasingly relying on Teable AI for important workflows, applications, and day-to-day operations, raising expectations for product quality, reliability, and model capability.
...
<img loading="lazy" alt="GPT 5.6 Price Cuts in Teable" src="https://dxshyegpql0u3hra.public.blob.vercel-storage.com/41519c3797fe4af5170508a1a15d5d74.png" />
...
<iframe
  ...
  title="Introducing Teable 3.0: The AI Spreadsheet for Business"
  frameBorder="0"
