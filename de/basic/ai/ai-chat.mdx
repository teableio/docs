...
Über **Verlauf** oben rechts im Chatbereich sehen Sie Ihre Chats in der aktuellen Base und können sie nach Namen durchsuchen.
...
Archivieren nimmt einen Chat aus dem Verlauf, ohne etwas zu löschen. Über Ihr Profilbild unten links → **Einstellungen** → **Archivierte Chats** sehen Sie die Chats, die Sie in verschiedenen Bases archiviert haben. **Wiederherstellen** bringt einen Chat in den Verlauf seiner Base zurück; hier können Sie ihn auch löschen, sobald Sie sicher sind, dass Sie ihn nicht mehr brauchen.
