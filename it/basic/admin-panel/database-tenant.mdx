...
<AccordionGroup>
  ...
  <Accordion title="Un tenant di database collega a Teable un database aziendale esistente?">
    No. Modifica la posizione in cui Teable archivia e gestisce i propri dati dello Spazio. Tu fornisci un database PostgreSQL ospitato altrove e Teable crea e gestisce al suo interno i propri dati. Le Tabelle e i Record esistenti in tale database non vengono collegati a Teable né importati automaticamente come Progetti.
  </Accordion>
</AccordionGroup>
