---
title: "Overview"
description: "Teable integrates powerful AI across the platform to help you work smarter with data"
---

AI powers Teable across the platform, turning your data into intelligent, fully automated workflows in seconds. From smart field processing to end-to-end automation, AI handles every step so you can focus on what matters.

Teable Automation lets anyone build powerful workflows without writing code. Just tell AI what you need in plain language.

## Build automation from scratch with AI
...
AI creates the entire automation for you — trigger, actions, and field mappings. Review it in the Automation panel and enable.

## Build automation from triggers with AI
