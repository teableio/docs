...
<AccordionGroup>
  ...
  <Accordion title="Veritabanı kiracısı, mevcut bir iş veritabanını Teable'a bağlar mı?">
    Hayır. Teable'ın kendi Alan verilerini nerede saklayıp yönettiğini değiştirir. Başka bir yerde barındırılan PostgreSQL veritabanını sağlarsınız; Teable da kendi verilerini burada oluşturup yönetir. Bu veritabanındaki mevcut Tablolar ve Kayıtlar Teable'a bağlanmaz veya otomatik olarak Projelere aktarılmaz.
  </Accordion>
</AccordionGroup>
