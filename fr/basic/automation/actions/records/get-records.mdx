...
2. Choisissez la **Table** à interroger. Utilisez l’[Accès inter-projet](/fr/basic/automation/actions/records/cross-base) si la table se trouve dans un autre projet.
...
- Lors de l’utilisation de l’Accès inter-projet, la requête s’exécute avec les autorisations du créateur du workflow. Si celui-ci perd l’accès au projet cible, l’étape échoue.

## Pages connexes

- [Accès inter-projet](/fr/basic/automation/actions/records/cross-base) — interrogez des tables situées dans d’autres projets
