...
Wenn Ihr Skript einen Dienst wie Slack, Airtable oder Google Sheets benötigt, klicken Sie oben im KI-Bereich auf die Integrationsschaltflächen, um Ihre Konten zu verbinden. Die KI verwendet diese Verbindungen beim Generieren des Codes.
