...
For step-by-step instructions on configuring your identity provider, see these guides:
...
<Note>
The linked guides show Admin Panel configuration for Cloud users. For self-hosted, follow the IdP setup steps, then use the environment variables above instead of the Admin Panel.
</Note>
