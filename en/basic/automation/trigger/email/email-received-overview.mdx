...
- **Gmail: "Less secure app" error:** Gmail does not allow plain password login. Use an **App Password** instead. See [Set up Gmail IMAP](/en/basic/automation/trigger/email/gmail-imap) for instructions.
