...
description: "Manage workflow templates for your organization, enabling users to quickly start with pre-configured projects."
---
...
* **Solution**: When marked, using this template opens the integration setup first instead of copying the project straight away. The **Integrations** column lists the platforms it connects to
* **Source**: The original project used to create this template

#### Template Operations

* **New Template**: Create a new template configuration
* **Publish Snapshot**: Capture the current state of the source project. You must publish a snapshot before you can list the template.
...
2. **Import**: Import the `.tea` file as a new project in your space
3. **Create Template**: Go to Template Admin > New Template
4. **Select Source**: Choose the imported project as the source
