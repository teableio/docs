...
<Steps>
  ...
  <Step title="Choisir le mode de création de la Table">
    Lors de la création d’une nouvelle Table, Teable propose **Importer avec l’IA** ou **Importer manuellement**. L’option IA n’apparaît que si AI Chat est disponible pour vous dans la Base.
  </Step>
