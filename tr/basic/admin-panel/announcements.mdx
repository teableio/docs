...
| --- | --- |
| **Biçim** | Duyurunun göründüğü yer: Uygulamanın üst kısmında **Başlık şeridi**, geçici bildirim olarak **Bildirim**, işlemi kesintiye uğratan iletişim kutusu olarak **Modal** veya Alan ve Proje kenar çubuklarında **Kenar çubuğu kartı**. |
