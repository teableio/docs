...
Lorsque vous partagez un Espace avec un autre utilisateur, celui-ci devient un collaborateur d'Espace ayant accès à toutes les Projets de cet Espace.
...
4. **Invitation par e-mail** : saisissez une adresse e-mail ou plusieurs adresses (séparées par des virgules). Définissez ensuite le niveau d'autorisation que vous souhaitez accorder aux utilisateurs pour toutes les Projets de l'Espace. Enfin, cliquez sur envoyer l'e-mail pour inviter les utilisateurs à collaborer.
...
<Note>Les collaborateurs d'Espace ont accès à toutes les Projets de l'Espace. Si une personne doit travailler uniquement sur des Projets spécifiques, envisagez de l'ajouter comme [collaborateur de Projet](/fr/basic/space/base-invite).</Note>
...
* **Portée** : retirer une personne de l'Espace ne supprime pas les autorisations qu'elle détient sur des Projets individuelles.
...
Chaque personne ou service apparaît une fois dans la liste des collaborateurs d'Espace, même lorsqu'elle détient également des autorisations sur des Projets individuelles. Un badge **Autorisations de Projet** à côté du rôle indique le nombre de Projets auxquelles elle a été invitée. Une personne qui n'a jamais été ajoutée à l'Espace lui-même est indiquée comme **A accès uniquement aux Projets sélectionnées**.

Développez une ligne pour voir ces Projets et le rôle détenu pour chacune. À partir de là, **Retirer l'accès au Projet** retire une autorisation sur un Projet, et **Retirer le collaborateur** sur une ligne réservée aux Projets retire toutes les autorisations de Projet détenues par cette personne dans cet Espace.
