...
<Steps>
  ...
  <Step title="Supprimer les valeurs en double">
    Activez **Supprimer les valeurs en double** : chaque valeur apparaît une seule fois. Le dédoublonnage est la dernière étape : Teable récupère les Enregistrements qui passent le filtre, le tri et la limite d’Enregistrements, puis supprime les doublons parmi leurs valeurs. Le résultat peut donc contenir moins de valeurs que le nombre d’Enregistrements autorisé.
  </Step>
</Steps>
