...
Each run's conversation also appears in the chat history, owned by whoever last updated the routine, and carries the routine's name. Deleting a routine does not delete these conversations: they keep their names and become ordinary chats.
