...
You can now configure and verify a custom domain for your App directly in Teable.

In App Builder, click **Publish** in the top right, enter your custom domain, Add the CNAME in your DNS provider, and return to Teable to verify and complete the binding. This feature is available on the Business Plan.
