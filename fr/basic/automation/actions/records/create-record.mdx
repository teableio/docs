...
2. Choisissez la **Table** dans laquelle créer l’enregistrement. Par défaut, il s’agit d’une table de le même projet, mais vous pouvez utiliser l’[Accès inter-projet](/fr/basic/automation/actions/records/cross-base) pour cibler une table d’un autre projet.
...
- Utilisez l’[Accès inter-projet](/fr/basic/automation/actions/records/cross-base) lorsque la table cible se trouve dans un autre projet que l’automatisation.
...
- [Accès inter-projet](/fr/basic/automation/actions/records/cross-base) — créez des enregistrements dans des tables extérieures au projet actuel
