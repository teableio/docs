...
<Steps>
  ...
  <Step title="Rimuovi valori duplicati">
    Quando il collegamento punta a più Record, lo stesso valore può tornare più volte. Attiva **Rimuovi valori duplicati**: ogni valore compare una sola volta, nell’ordine originale. Tre righe d’ordine con le categorie Accessorio, Console, Accessorio vengono mostrate come Accessorio, Console.
  </Step>
</Steps>
