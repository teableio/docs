...
Kopyalanan içerik, uygulamanın Teable'ın kendi korumalı alanında aldığı değerlerle eşleşir: uygulamaya verilen kimlik bilgileri ve platformun uygulamanın API uç noktası, erişim token'ı ve AI erişimi için eklediği değişkenler.
...
Bir kimlik bilgisi eklemek veya değiştirmek için yerel dosya yerine Teable'daki **Kimlik bilgileri ve yapılandırma** bölümünü kullanın. GitHub'a commit edilen bir `.env` dosyası kimlik bilgisi oluşturmaz veya güncellemez. Bir kimlik bilgisini değiştirdikten sonra yerel `.env` dosyanızı yenilemek için değişkenleri tekrar kopyalayın.
