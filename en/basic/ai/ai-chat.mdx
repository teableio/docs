...
- **Wait for active Agents**: Each user can run up to 3 Agents at the same time, including AI Chat and App Builder. If you see `Agent is busy in another conversation. Please wait.`, wait for the previous task to finish before retrying.
