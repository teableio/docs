...
<AccordionGroup>
  ...
  <Accordion title="Why do I need to confirm when adding a collaborator or changing a role?">
  ...
  <Accordion title="What are credits used for?">
    AI-powered features in Teable use credits. See the credit usage details on the Billing page for the specific usage. Each plan includes a monthly credit allocation:
    - **Free**: 200 credits
