...
| **Progetto** | `base\|read`, `base\|read_all`, `base\|update`, `base\|table_import`, `base\|table_export`, `base\|query_data` |
...
In genere, il primo passaggio dopo aver ottenuto un token consiste nel recuperare tutte i Progetti accessibili all'utente corrente:
...
Questo endpoint restituisce tutte i Progetti a cui l'utente corrente è autorizzato ad accedere. Puoi utilizzare il `baseId` presente nella risposta per le chiamate API successive.
