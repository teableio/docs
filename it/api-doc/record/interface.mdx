...
<Note>Il Campo lookup non è un tipo di Campo specifico. È possibile eseguire il lookup di qualsiasi tipo di Campo da un Progetto collegata. Il tipo di un Campo lookup è determinato dal Campo originale nel Progetto collegata e dispone della proprietà isLookup. I Campi lookup non possono essere modificati.</Note>
