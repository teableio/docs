...
Test etmenin en kolay yolu komut satırından `curl` kullanmaktır. Proje ve iş akışı kimliklerini içerdiğinden URL'yi elle yazmak yerine tetikleyici panelindeki gerçek URL'yi kopyalayın.
...
| Kapsam | Sınır |
|---|---|
| Proje başına | Saniyede 50 istek |
