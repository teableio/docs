...
Le skill aggiunte dagli utenti altrove rimangono nel rispettivo ambito. Consulta [AI Chat](/it/basic/ai/ai-chat) per le skill personali, del Progetto e dello Spazio.
...
Una skill pubblicata qui è l'impostazione predefinita dell'istanza. Se una skill del Progetto, dello Spazio, personale, dell'app o del bot utilizza lo stesso nome, per quella conversazione ha effetto quella con l'ambito più ristretto e la skill dell'istanza viene ignorata.
