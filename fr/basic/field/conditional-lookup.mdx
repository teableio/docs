...
<Steps>
  ...
  <Step title="Supprimer les valeurs en double (facultatif)">
    Activez **Supprimer les valeurs en double** pour ne conserver chaque valeur qu’à sa première apparition. Teable supprime les doublons après le filtre, le tri et la limite d’Enregistrements : la limite porte donc toujours sur les Enregistrements correspondants, pas sur les valeurs restantes.
  </Step>
</Steps>
