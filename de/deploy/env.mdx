...
| BACKEND_SIGNIN_VERIFICATION_EXPIRES_IN     | Gültigkeitsdauer des Anmelde-Bestätigungscodes. Ohne Wert gilt BACKEND_EMAIL_CODE_EXPIRES_IN | 10m              | -    | 10m                                              |
| BACKEND_SIGNIN_VERIFICATION_MAX_ATTEMPTS   | Zulässige Fehlversuche pro Anmeldecode; danach wird der Code verworfen und ein neuer muss angefordert werden | 5                | -    | 5                                                |
...
| BACKEND_MAIL_INVITE_SPACE_NAME_MAX_LENGTH  | Maximale Länge des Space- oder Projekt-Namens in Betreffzeilen von Einladungs-E-Mails. Leer oder 0 deaktiviert das Kürzen | - | - | 32 |
...
| TABLE_LIMIT_TABLES_PER_BASE_MAX            | Maximale Anzahl von Tabellen pro Projekt                                                   | 1000            | -        | 1000                                              |
...
| V2_TABLE_QUERY_OPS_ENABLED                 | Ob Tabellenabfrage-Operationen aktiviert werden; deaktiviert zeigt die Admin-Seite **Tabellenabfrage-Operationen** keine Daten. Nach der Änderung neu starten        | false           | -        | true                                              |
...
| PUBLIC_DATABASE_PROXY                      | Extern erreichbare Datenbankadresse (host:port), die in den im Projekt-Panel „Datenbankverbindung“ erzeugten Anmeldedaten verwendet wird; setzen Sie sie, um externen schreibgeschützten SQL-Zugriff zu aktivieren | -               | -        | db.example.com:42345                              |
...
| BIG_TRANSACTION_TIMEOUT                    | Timeout (ms) für große interne Transaktionen, z. B. den Export großer Projekte | 600000          | -        | 1200000                                           |
