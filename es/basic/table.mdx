...
description: "Crea, importa, comparte y administra Tablas en un Proyecto."
---

{/* mintlify-resync: 2026-05-14 */}
Cada Proyecto puede contener varias Tablas para almacenar y administrar datos relacionados. Las Tablas de Teable equivalen a las tablas de una base de datos; comprender [en qué se diferencian de las hojas de cálculo](/es/compare/teable-vs-excel) te ayudará a aprovechar Teable al máximo.

## Crear y administrar Tablas

### Añadir Tablas

En un Proyecto, haz clic en el botón `+` del directorio y elige una opción:
...
Cuando otras Tablas enlazan con la Tabla que estás eliminando, el cuadro de diálogo de confirmación enumera los Campos afectados y el Proyecto y la Tabla a los que pertenece cada uno. Al eliminar la Tabla, esos Campos de enlace se convierten en Campos de texto de una línea que conservan los títulos de los Registros enlazados; los Campos de búsqueda o acumulación creados a partir de ellos dejan de funcionar.

### Papelera

Haz clic en el icono de la Papelera situado en la esquina superior izquierda del Proyecto para administrar las Tablas eliminadas.
...
- **Restaurar**: devuelve la Tabla al Proyecto con todos sus datos intactos
...
- Desactiva **Buscar por Campo** para realizar una búsqueda aproximada en los Campos visibles en la Vista actual; los Campos ocultos en esa Vista no se tienen en cuenta. La búsqueda global no incluye Campos de fecha, casilla de verificación ni botón. Tu instancia también puede limitar el número de Campos que abarca la búsqueda global.
