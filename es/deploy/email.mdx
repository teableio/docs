...
- **Correo de notificaciones**: se utiliza para verificar usuarios, restablecer contraseñas, enviar invitaciones y notificaciones del sistema y otros correos similares. También es lo que habilita **Iniciar sesión con código por correo** en la página de inicio de sesión.
