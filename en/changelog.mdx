...
In App Builder, click **Publish** in the top right. Enter your custom domain, complete the DNS setup, then return to Teable to verify and finish the binding. This feature is available on the Business Plan only.
...
<AccordionGroup>
<Accordion title="Agent Architecture Upgrade — Beta Only (4)">
- Fixed CuppyClaw Bot permission and i18n issues in the management panel.
- Fixed the chat usage query causing a full table scan on the credit history table due to a missing scope filter.
- Improved AI automation stability and visibility, enabling faster issue detection and recovery.
- Enhanced Agent runtime lifecycle management for more reliable long-running tasks.
</Accordion>
