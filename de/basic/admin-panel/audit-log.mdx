...
Jeder Protokolleintrag zeigt Operationszeit, Ausführenden, Aktionstyp, zugehörige Projekt oder zugehörigen Space sowie die Anfragequelle. Öffnen Sie einen Protokolleintrag, um seine Details anzuzeigen.
