...
<Note>Lookup field is not a specific field type. We can look up any type of field from a linked project. The type of a lookup field is determined by the original field in the linked project and has the isLookup property. Lookup fields cannot be edited.</Note>
