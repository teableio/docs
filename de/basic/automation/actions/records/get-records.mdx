...
2. Wählen Sie die abzufragende **Tabelle**. Verwenden Sie [Projekt-übergreifenden Zugriff](/de/basic/automation/actions/records/cross-base), wenn sich die Tabelle in einer anderen Projekt befindet.
...
- Bei Projekt-übergreifendem Zugriff wird die Abfrage mit den Berechtigungen des Workflow-Erstellers ausgeführt. Verliert dieser den Zugriff auf die Ziel-Projekt, schlägt der Schritt fehl.
