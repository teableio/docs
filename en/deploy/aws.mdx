...
<Tip>
For detailed production recommendations including resource sizing, high availability, and scaling strategies, see [Self-Hosted Overview](/en/deploy/architecture).
</Tip>
...
- [Self-Hosted Overview](/en/deploy/architecture) — Architecture, sizing, and scaling
