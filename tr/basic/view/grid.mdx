...
Aynı panelde şu hatalar da görünebilir:

| İleti | Anlamı | Ne yapmalı |
| --- | --- | --- |
| `Formül derlemesi hesaplama sınırını aşıyor; sonuçlar güncellenmedi` | Formülün açılmış yapısı sınırın üzerinde | Formülü sadeleştirin ya da ara sonuçları ayrı alanlara taşıyın; bkz. [Formül](/tr/basic/field/formula) |
| `Kaynak sınırı nedeniyle hesaplama sonuçları güncellenmedi` | Hesaplama, veritabanının kaynak sınırına takıldı | Tek seferde daha az kayıt değiştirin; yinelenirse bir yöneticiye başvurun |
| `Hesaplama tamamlanmadı; bazı sonuçlar güncellenmedi` | Hesaplama zinciri tek turda bitirilemeyecek kadar derin | Alanlar arasındaki zincirleme başvuruları azaltın, sonra kaynak veriyi yeniden değiştirerek hesaplamayı tetikleyin |
