...
- **Manually added context**: Type `@` or use the add menu to insert tables, views, apps, workflows, folders, attachments, or selected rows as inline context chips.
...
You can paste or drop files directly into the chat input. Uploaded files appear as inline chips before you send the message.
