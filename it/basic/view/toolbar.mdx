...
**Condividi Vista** pubblica la Vista corrente come link. I visitatori vedono i dati e il layout di tale Vista. Non equivale a invitarli come collaboratori del Progetto.

<Note>Per condividere un intero Progetto, una Tabella specifica o una cartella, usa la condivisione del Progetto descritta in [Progetto](/it/basic/base).</Note>
...
| Limita con password | Tutte le condivisioni di Viste | Aggiunge una password al link di condivisione. I visitatori devono inserire la password corretta prima di aprirlo. Una volta attivata, viene generata automaticamente una password casuale che puoi copiare insieme al link con **Copia link e password** |
...
- Condividi Vista pubblica il risultato della Vista corrente, non tutte le autorizzazioni del Progetto. Per la collaborazione continuativa, usa le autorizzazioni dei membri o la condivisione del Progetto.
