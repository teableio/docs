...
- **Email di notifica**: utilizzata per la verifica degli utenti, la reimpostazione della password, gli inviti, le notifiche di sistema e altre email simili. È anche ciò che rende disponibile **Accedi con codice via email** nella pagina di accesso.
