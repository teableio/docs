...
| BACKEND_SIGNIN_VERIFICATION_EXPIRES_IN     | Durata del codice di verifica per l'accesso. Se non impostato vale BACKEND_EMAIL_CODE_EXPIRES_IN | 10m              | -    | 10m                                              |
| BACKEND_SIGNIN_VERIFICATION_MAX_ATTEMPTS   | Tentativi errati consentiti per ogni codice di accesso; oltre tale soglia il codice viene annullato e va richiesto di nuovo | 5                | -    | 5                                                |
...
| BACKEND_MAIL_INVITE_SPACE_NAME_MAX_LENGTH  | Lunghezza massima del nome dello Spazio o del Progetto negli oggetti delle email di invito. Un valore vuoto o 0 disabilita il troncamento | - | - | 32 |
...
| TABLE_LIMIT_TABLES_PER_BASE_MAX            | Numero massimo di Tabelle per Progetto                                                   | 1000            | -        | 1000                                              |
...
| V2_TABLE_QUERY_OPS_ENABLED                 | Indica se abilitare le operazioni sulle query delle Tabelle; da disabilitate, la pagina **Operazioni sulle query delle Tabelle** non ha dati. Riavvia dopo la modifica        | false           | -        | true                                              |
...
| PUBLIC_DATABASE_PROXY                      | Indirizzo del database raggiungibile dall'esterno (host:porta) usato nelle credenziali generate dal pannello "Connessione database" del Progetto; impostalo per abilitare l'accesso SQL esterno in sola lettura | -               | -        | db.example.com:42345                              |
...
| BIG_TRANSACTION_TIMEOUT                    | Timeout (ms) per le transazioni interne di grandi dimensioni, come l'esportazione di Progetti di grandi dimensioni | 600000          | -        | 1200000                                           |
