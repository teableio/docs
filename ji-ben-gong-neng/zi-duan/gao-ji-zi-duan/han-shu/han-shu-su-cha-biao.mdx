...
4. [公式](/ji-ben-gong-neng/zi-duan/gao-ji-zi-duan/han-shu)
...
如果逻辑参数为真，则返回`value1`，否则返回`value2`。还可用于制作嵌套的IF语句，以及检查单元格是否为空。
...
[上一页公式语法](/ji-ben-gong-neng/zi-duan/gao-ji-zi-duan/han-shu/gong-shi-yu-fa)[下一页关联](/ji-ben-gong-neng/zi-duan/gao-ji-zi-duan/guan-lian)
