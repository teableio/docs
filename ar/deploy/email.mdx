...
- **بريد الإشعارات**: يُستخدم للتحقق من المستخدم، وإعادة تعيين كلمة المرور، والدعوات، وإشعارات النظام، والرسائل المشابهة. وهو أيضًا ما يتيح **تسجيل الدخول برمز البريد الإلكتروني** في صفحة تسجيل الدخول.
