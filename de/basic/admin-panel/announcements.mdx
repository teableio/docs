...
| --- | --- |
| **Formular** | Wo die Ankündigung angezeigt wird: **Banner** oben in der App, **Toast** als vorübergehende Benachrichtigung, **Modal** als unterbrechender Dialog oder **Seitenleistenkarte** in den Seitenleisten von Space und Projekt. |
