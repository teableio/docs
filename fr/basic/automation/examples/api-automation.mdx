...
- L’ID de votre projet, l’ID de votre table et les ID de vos champs. Consultez [Obtenir les ID](/fr/api-doc/get-id).
...
- Utilisez le PAT disposant des privilèges minimaux : limitez-le aux espaces et projets nécessaires.
