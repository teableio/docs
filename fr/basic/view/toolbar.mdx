...
**Partager la Vue** publie la Vue actuelle sous forme de lien. Les visiteurs voient les données et la mise en page de cette Vue. Cela ne revient pas à les inviter en tant que collaborateurs du Projet.

<Note>Pour partager un Projet entier, une Table précise ou un dossier, utilisez le partage de Projet dans [Projet](/fr/basic/base).</Note>
...
| Limiter par mot de passe | Tous les partages de Vue | Ajoute un mot de passe au lien de partage. Les visiteurs doivent saisir le bon mot de passe avant de l’ouvrir. Un mot de passe aléatoire est généré à l’activation ; **Copier le lien et le mot de passe** copie les deux ensemble |
...
- Partager la Vue publie le résultat de la Vue actuelle, et non l’ensemble des autorisations du Projet. Pour une collaboration continue, utilisez les autorisations des membres ou le partage de Projet.
