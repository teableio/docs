...
* fieldId (string): 要上传到的附件字段 ID [(如何获取)](/kai-fa-zhe/api/huo-qu-id#fieldid)

附件字段可以上传多个附件，该 API 每次允许上传一个附件到单元格最末尾

如需删除或调整附件顺序请使用[更新记录 API](/kai-fa-zhe/api/ji-lu/geng-xin-ji-lu)
...
[上一页删除记录](/kai-fa-zhe/api/ji-lu/shan-chu-ji-lu)[下一页记录字段值类型](/kai-fa-zhe/api/ji-lu/ji-lu-zi-duan-zhi-lei-xing)
