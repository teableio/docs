...
![](/images/ji-ben-gong-neng/8e0f0b62392c4d11.png)

### Copying a Base to Another Space

Step 1: In the workspace, select the base you want to move;

Step 2: Click the menu icon and select the Copy Base option;

Step 3: A popup window will appear with a dropdown menu of available spaces where you can copy the base to. You need Creator permissions in the target space to move the base there.

![](/images/ji-ben-gong-neng/8acd3a13937871cc.png)
