...
<Note>ルックアップフィールドは、特定のフィールド型ではありません。リンクされたプロジェクトから、任意の型のフィールドを参照できます。ルックアップフィールドの型はリンク先プロジェクトの元フィールドによって決まり、isLookupプロパティを持ちます。ルックアップフィールドは編集できません。</Note>
