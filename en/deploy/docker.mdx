...
Not sure this is the right path? Start from [Choose Your Path](/en/deploy/choose). Need AI features or App Builder? Deploy the [full-featured platform](/en/deploy/architecture) instead.
</Callout>
