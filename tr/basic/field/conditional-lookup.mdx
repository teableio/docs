...
<Steps>
  ...
  <Step title="Yinelenen değerleri kaldırın (isteğe bağlı)">
    **Yinelenen değerleri kaldır** seçeneğini açtığınızda her değer yalnızca ilk göründüğü yerde kalır. Teable yinelenenleri filtre, sıralama ve kayıt sınırı uygulandıktan sonra kaldırır; bu nedenle sınır, sonuçta kalan değerleri değil eşleşen kayıtları saymaya devam eder.
  </Step>
</Steps>
