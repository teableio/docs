...
1. **Eine Tabelle öffnen**: Öffnen Sie zunächst eine beliebige Tabelle im Projekt, mit dem Sie sich verbinden möchten.
2. **Zur Designseite wechseln**: Klicken Sie auf das ⚙️-Symbol oben rechts, um zur Seite „Projekt-Design“ zu gelangen.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-open-design-page-en.png"
  alt="Seite „Projekt-Design“ öffnen"
...
- **Schemaname (BaseId)**: Die mit `bse` beginnende Kennung des Projekts
...
Jedes Projekt in Teable entspricht einem **Schema** in PostgreSQL. Die BaseId ist der in SQL-Abfragen verwendete Schemaname.
...
<img
  ...
  alt="Projekt-ID in der URL"
  className="docs-screenshot"
/>

**Methode 2:** In der Oberfläche „Projekt-Design“ ist der angezeigte Schemaname die BaseId.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-design-page-schema.png"
  alt="Schemaname auf der Seite „Projekt-Design“"
  className="docs-screenshot"
/>

### Tabellennamen finden

Tabellennamen in der Teable-Oberfläche werden nicht automatisch mit physischen Datenbanktabellennamen synchronisiert. Prüfen Sie in der Oberfläche „Projekt-Design“ den tatsächlichen Datenbanktabellennamen.
...
Die Datenbankverbindung ist auf das aktuelle Projekt beschränkt. PostgreSQL-Schemas bieten eine Berechtigungsisolation und stellen sicher, dass Sie nur auf Tabellen innerhalb Ihres Projekts zugreifen können.
