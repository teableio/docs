...
- Verwenden Sie [Projekt-übergreifenden Zugriff](/de/basic/automation/actions/records/cross-base), um Datensätze in einer Tabelle zu aktualisieren, die sich in einer anderen Projekt befindet.
...
- [Projekt-übergreifender Zugriff](/de/basic/automation/actions/records/cross-base) – Datensätze in Tabellen außerhalb des aktuellen Projekts aktualisieren
