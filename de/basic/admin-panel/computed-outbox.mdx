...
- Filtern Sie nach **Space**, **Projekt**, **Ursache** oder **Ergebnis**, suchen Sie nach einer Aufgabe, Projekt, einem Space oder Fehler oder legen Sie eine Mindestverarbeitungszeit fest, um langsame Aufgaben anzuzeigen.
...
Eine als **Projekt gelöscht** markierte Gruppe gehört zu einem Projekt, die nicht mehr existiert. Ihre Wiederherstellung würde sofort erneut fehlschlagen, daher ist **Gruppe verwerfen** die einzige angebotene Aktion.
