...
<Note>Поле пошуку не є окремим типом Поля. У пов’язаній Проєкті можна шукати Поле будь-якого типу. Тип Поля пошуку визначається вихідним Полем у пов’язаній Проєкті та має властивість isLookup. Поля пошуку не можна редагувати.</Note>
