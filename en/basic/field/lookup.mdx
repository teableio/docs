...
<Steps>
  ...
  <Step title="Remove duplicate values">
    When the link points to several records, the same value can come back more than once. Turn on **Remove duplicate values** and each value is shown once, in its original order. Three linked line items with the categories Accessory, Console, Accessory show as Accessory, Console.
  </Step>
</Steps>
