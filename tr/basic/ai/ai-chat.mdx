...
- **Kazıyıcı**: **+** menüsünü açıp **Kazıyıcı**'yı seçin, ardından bir platform ve veri türü belirleyin; örneğin LinkedIn'de **kişisel profil** veya Amazon'da **ürün yorumları**. Teable ilgili talimatı sohbet girişine önceden doldurur, siz de bir bağlantı ya da anahtar kelimeyle tamamlarsınız. **Herhangi bir web sayfası** seçeneği yapıştırdığınız bağlantıyı doğrudan alır.
