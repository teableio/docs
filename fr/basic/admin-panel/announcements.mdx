...
| --- | --- |
| **Formulaire** | L’emplacement de l’annonce : une **Bannière** en haut de l’application, un **Toast** sous forme de notification temporaire, une **Fenêtre modale** sous forme de boîte de dialogue interrompant le travail, ou une **Carte latérale** dans les barres latérales de l’Espace et du Projet. |
