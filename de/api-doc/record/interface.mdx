...
<Note>Ein Lookup-Feld ist kein spezifischer Feldtyp. Sie können jeden Feldtyp aus einer verknüpften Projekt nachschlagen. Der Typ eines Lookup-Felds wird durch das ursprüngliche Feld in dem verknüpften Projekt bestimmt und verfügt über die Eigenschaft isLookup. Lookup-Felder können nicht bearbeitet werden.</Note>
