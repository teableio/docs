...
- Verwenden Sie [Projekt-übergreifenden Zugriff](/de/basic/automation/actions/records/cross-base), um Datensätze in einer Tabelle zu aktualisieren, die sich in einem anderen Projekt befindet.
