...
The easiest way to test is with `curl` from the command line. Copy the real URL from the trigger panel rather than typing it out; it carries the project and workflow ids.
...
| Scope | Limit |
|---|---|
| Per project | 50 requests / second |
