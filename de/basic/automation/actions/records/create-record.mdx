...
2. Wählen Sie die **Tabelle**, in der der Datensatz erstellt werden soll. Standardmäßig handelt es sich um eine Tabelle in derselben Projekt. Mit [Projekt-übergreifendem Zugriff](/de/basic/automation/actions/records/cross-base) können Sie jedoch eine Tabelle in einer anderen Projekt als Ziel festlegen.
...
- Verwenden Sie [Projekt-übergreifenden Zugriff](/de/basic/automation/actions/records/cross-base), wenn sich die Zieltabelle in einer anderen Projekt als die Automatisierung befindet.
