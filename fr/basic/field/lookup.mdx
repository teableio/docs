...
<Steps>
  ...
  <Step title="Supprimer les valeurs en double (facultatif)">
    Si le lien pointe vers plusieurs Enregistrements, activez **Supprimer les valeurs en double** : une valeur répétée n’est conservée qu’à sa première apparition.
  </Step>
</Steps>
