...
- **Почта для уведомлений**: используется для подтверждения пользователей, сброса пароля, приглашений, системных уведомлений и подобных писем. Именно она делает доступным вариант **Войти по коду из письма** на странице входа.
