...
<Steps>
  ...
  <Step title="Eliminar valores duplicados">
    Activa **Eliminar valores duplicados** y cada valor se muestra una sola vez. La eliminación es el último paso: Teable toma los Registros que pasan el filtro, la ordenación y el límite de Registros, y después quita los duplicados entre sus valores, así que el resultado puede tener menos valores que Registros permitiste.
  </Step>
</Steps>
