...
<Steps>
  ...
  <Step title="Supprimer les valeurs en double">
    Activez **Supprimer les valeurs en double** : chaque valeur apparaît une seule fois, dans son ordre d’origine. Le dédoublonnage intervient après le filtre, le tri et la limite d’Enregistrements ; la limite porte donc sur les Enregistrements correspondants, pas sur les valeurs restantes.
  </Step>
</Steps>
