...
- **Anfragen nach Zugangsdaten**: Wenn die KI ein Drittanbieterkonto oder ein Secret benötigt, heftet sie eine entsprechende Karte an die Unterhaltung. Wählen Sie **Mein Konto verbinden** für einen OAuth-Vorgang oder geben Sie vorhandene Zugangsdaten frei. Mit **Überspringen** stellen Sie sie nicht bereit; die KI fährt mit den Teilen fort, die sie auch ohne erledigen kann.
