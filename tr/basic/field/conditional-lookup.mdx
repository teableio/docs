...
<Steps>
  ...
  <Step title="Yinelenen değerleri kaldırın">
    **Yinelenen değerleri kaldır** seçeneğini açtığınızda her değer özgün sırasını koruyarak bir kez görünür. Yinelenenler filtre, sıralama ve kayıt sınırı uygulandıktan sonra kaldırılır; bu nedenle sınır, sonuçta kalan değerleri değil eşleşen kayıtları sayar.
  </Step>
</Steps>
