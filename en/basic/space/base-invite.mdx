...
description: "Manage permissions at the base level. Invite members to a specific base without granting access to the entire space for more granular and secure data collaboration."
---
