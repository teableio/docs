...
7. **Configure Model Preferences:** After adding the provider, configure which models to use for different tasks:
   - **Advanced chat model** - For planning, coding, and other complex reasoning tasks. Recommended: `claude-sonnet-4.5` (**required to enable custom model**)
   - **Medium chat model** - For AI formula generation. Recommended: `claude-haiku-4.5`
   - **Small chat model** - For auto-generating chat titles and base names. Recommended: `claude-haiku-4.5`
