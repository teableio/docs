...
Usa l'importazione per inizializzare una nuova Tabella, aggiungere nuovi dati a una Tabella esistente o trasferire Tabelle da Airtable o Fogli Google in un Progetto Teable. Airtable e Fogli Google sono disponibili anche durante l'importazione di un intero Progetto.
...
- Per creare un nuovo Progetto Teable, apri il menu dello Spazio di destinazione, fai clic su **Importa**, quindi scegli **Importa da Airtable**.
- Per importare Tabelle nel Progetto Teable che stai visualizzando, usa il menu delle risorse del Progetto:

1. Apri il Progetto Teable desiderato.
...
- Per creare un nuovo Progetto Teable, apri il menu dello Spazio di destinazione, fai clic su **Importa**, quindi scegli **Importa da Fogli Google**.
- Per aggiungere Tabelle al Progetto visualizzato, fai clic su `+` nella parte superiore della directory a sinistra e scegli **Fogli Google** sotto **Aggiungi da altre origini**.
...
<Steps>
  ...
  <Step title="Avvia l'importazione">
    Fai clic su **Avvia importazione** e mantieni aperta la finestra. Viene mostrato l'avanzamento Tabella per Tabella e, al termine, quanti Record ha ricevuto ciascuna Tabella. Dopo l'importazione di un nuovo Progetto, usa **Apri Progetto** per passare direttamente al risultato.
  </Step>
</Steps>
