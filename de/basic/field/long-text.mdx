...
- Webadressen im Text werden automatisch zu anklickbaren Links, ohne dass Sie etwas einstellen müssen. Im geöffneten Datensatz listet eine Schaltfläche neben dem Eingabefeld alle Adressen der Zelle auf.
- „Langtext“ unterstützt keine interaktive Anzeige für E-Mail oder Telefon. Verwenden Sie ein Feld vom Typ **Einzeiliger Text**, wenn eine Adresse oder Nummer zum Schreiben oder Anrufen anklickbar sein soll.
