...
- **Process in a script:** Pass the array to an [Run Script](/en/basic/automation/ai/scripting/ai-script-guide) step for custom processing, filtering, or transformation.
