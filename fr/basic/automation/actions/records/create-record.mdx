...
2. Choisissez la **Table** dans laquelle créer l’enregistrement. Par défaut, il s’agit d’une table du même projet, mais vous pouvez utiliser l’[Accès inter-projet](/fr/basic/automation/actions/records/cross-base) pour cibler une table d’un autre projet.
