...
<CodeGroup>
  ...
  const response = await fetch('https://app.teable.io/table/__tableId__/record/__recordId__/__fieldId__/uploadAttachment', {
    method: 'POST',
    headers: {
  ...
  const responseUrl = await fetch('https://app.teable.io/table/__tableId__/record/__recordId__/__fieldId__/uploadAttachment', {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer __token__',
  ...
  with open(file_path, 'rb') as file:
      ...
      response = requests.post(
          'https://app.teable.io/table/__tableId__/record/__recordId__/__fieldId__/uploadAttachment',
          headers={
              'Authorization': 'Bearer __token__'
          },
          files=files
