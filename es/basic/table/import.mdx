...
- Para crear un Proyecto de Teable nuevo, abre el menú del Espacio de destino, haz clic en **Importar** y elige **Importar desde Airtable**.
...
- Para crear un Proyecto de Teable nuevo, abre el menú del Espacio de destino, haz clic en **Importar** y elige **Importar desde Google Sheets**.
...
<Steps>
  ...
  <Step title="Inicia la importación">
    Haz clic en **Iniciar importación** y mantén abierto el cuadro de diálogo. Este muestra el progreso Tabla por Tabla y, al finalizar, cuántos Registros ha recibido cada una. Después de importar un Proyecto nuevo, usa **Abrir Proyecto** para ir directamente al resultado.
  </Step>
</Steps>
