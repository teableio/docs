...
La forma más sencilla de probarlo es usar `curl` desde la línea de comandos. Copia la URL real del panel del disparador en lugar de escribirla: contiene los ID del Proyecto y del flujo de trabajo.
...
| Ámbito | Límite |
|---|---|
| Por Proyecto | 50 solicitudes/segundo |
