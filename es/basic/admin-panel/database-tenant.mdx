...
<AccordionGroup>
  ...
  <Accordion title="¿Un inquilino de base de datos conecta una base de datos empresarial existente con Teable?">
    No. Cambia el lugar donde Teable almacena y administra los datos de su propio Espacio. Tú proporcionas una base de datos PostgreSQL alojada en otro lugar, y Teable crea y administra sus propios datos en ella. Las Tablas y los Registros existentes en esa base de datos no se conectan con Teable ni se importan automáticamente como Proyectos.
  </Accordion>
</AccordionGroup>
