...
- Use [Cross-Project Access](/en/basic/automation/actions/records/cross-base) to update records in a table that lives in a different project.
...
- [Cross-project access](/en/basic/automation/actions/records/cross-base) — update records in tables outside the current project
