...
2. Choose the **Table** where you want the record created. By default this is a table in the same project, but you can use [Cross-Project Access](/en/basic/automation/actions/records/cross-base) to target a table in another project.
...
- Use [Cross-Project Access](/en/basic/automation/actions/records/cross-base) when the target table is in a different project than the automation.
...
- [Cross-project access](/en/basic/automation/actions/records/cross-base) — create records in tables outside the current project
