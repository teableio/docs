...
<Steps>
  ...
  <Step title="Eliminar valores duplicados (opcional)">
    Activa **Eliminar valores duplicados** para conservar cada valor solo en su primera aparición. Teable elimina los duplicados después de aplicar el filtro, la ordenación y el límite de Registros, así que el límite sigue contando los Registros coincidentes y no los valores que quedan en el resultado.
  </Step>
</Steps>
