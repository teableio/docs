...
- **Scraper**: apri il menu **+**, scegli **Scraper** e seleziona una piattaforma e un tipo di dato, ad esempio **profilo personale** su LinkedIn o **recensioni del prodotto** su Amazon. Teable precompila l'istruzione corrispondente nell'input della chat, che completi con un link o una parola chiave. **Qualsiasi pagina web** accetta direttamente un link incollato.
