...
> We've made a major upgrade to the Teable Agent engine — dramatically improving AI Chat's ability to handle complex tasks, while reducing credit consumption to as low as 20%, or even 5% of previous levels.
...
- **Credit consumption drastically reduced** — in our complex task benchmarks, efficiency improved 5–20x, or even higher.
...
- Fixed internal server error interruptions during AI Chat conversations.
- Task execution time now displayed at the end of each conversation turn.
- More compact, responsive conversation UI that highlights high-value information.
- Support for parallel sub-tasks (sub agents) to improve completion efficiency on complex tasks.
- Introduced **CuppyClaw** — use Teable Agent in Slack, Telegram, and Feishu.
- You can now send additional prompts while the Agent is still executing.
- Added detailed credit usage breakdown in Settings → Billing.
