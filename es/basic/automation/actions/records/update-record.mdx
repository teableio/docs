...
- Utiliza [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) para actualizar Registros de una Tabla que se encuentre en otro Proyecto.
...
- [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) — actualiza Registros en Tablas que se encuentran fuera del Proyecto actual
