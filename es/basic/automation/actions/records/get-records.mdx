...
2. Elige la **Tabla** que quieres consultar. Utiliza [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) si la Tabla está en otro Proyecto.
...
- Al utilizar Acceso entre Proyectos, la consulta se ejecuta con los permisos del creador del flujo de trabajo. Si el creador pierde el acceso al Proyecto de destino, el paso fallará.

## Contenido relacionado

- [Acceso entre Proyectos](/es/basic/automation/actions/records/cross-base) — consulta Tablas de otros Proyectos
