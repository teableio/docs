...
| Item | Limit |
|---|---|
| Email sending rate | 5 / second / project |
| Webhook receiving rate | 50 / second / project, 2 / second / workflow |
...
<AccordionGroup>
  <Accordion title="Why did I receive an automation run usage alert?">
    ...
    The notification opens **Space Settings** → **Billing**. When available, it shows which workflow and Project contributed the most runs. Quota reminders are based on runs counted toward your plan limit; unusual usage checks may also consider recent runs with **success**, **failed**, or **pending** status.
