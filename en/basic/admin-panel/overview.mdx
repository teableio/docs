...
The Admin Panel provides centralized management for your Teable instance. As an administrator, you can manage Users, Spaces, Template Admin, Self-hosted License, Settings, and AI Settings.
...
- **[Settings](/en/basic/admin-panel/settings)** - Configure system-wide settings and permissions
