...
上传一个附件到附件字段需要使用独立的 API，详情请查看[上传附件](/kai-fa-zhe/api/ji-lu/shang-chuan-fu-jian)章节
...
[上一页上传附件](/kai-fa-zhe/api/ji-lu/shang-chuan-fu-jian)[下一页获取 ID](/kai-fa-zhe/api/huo-qu-id)
