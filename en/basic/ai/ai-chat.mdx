...
- **Scraper**: Open the **+** menu and choose **Scraper**, then pick a platform and a data type, such as **personal profile** on LinkedIn or **product reviews** on Amazon. Teable prefills the matching instruction in the chat input for you to complete with a link or a keyword. **Any web page** takes a pasted link directly.
