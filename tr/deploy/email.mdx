...
- **Bildirim e-postası**: Kullanıcı doğrulama, parola sıfırlama, davetler, sistem bildirimleri ve benzer e-postalar için kullanılır. Giriş sayfasındaki **E-posta koduyla giriş yap** seçeneğini de bu ayar mümkün kılar.
