...
- **[Operaciones de consulta de Tablas](/es/basic/admin-panel/table-query-ops)**: Configura la cobertura de búsqueda por Tabla, crea índices y sigue los resultados
...
- **[Schema integrity](/es/basic/admin-panel/schema-integrity)**: Ejecuta comprobaciones de esquema en cualquier proyecto y repara lo que encuentren
