...
![](/images/api/sql-query/2026-05-29-sql-query-open-design-page-en.png)
...
![](/images/api/sql-query/2026-05-29-sql-query-database-connection-panel-en.png)

### Connecting to the Database

Use the credentials to connect through your preferred tool. Here's an example:

<img alt="Connection example" src="/images/api/sql-query/2026-05-29-sql-query-connection-example.png" />
...
<img alt="baseId" src="/images/api/sql-query/2026-05-29-sql-query-base-id-url.png" />

**Method 2:** In the Base Design interface, the schema name shown is the BaseId.

<img alt="Design page" src="/images/api/sql-query/2026-05-29-sql-query-design-page-schema.png" />
...
<img alt="table info" src="/images/api/sql-query/2026-05-29-sql-query-table-info.png" />
...
<img alt="db field name" src="/images/api/sql-query/2026-05-29-sql-query-db-field-name.png" />
...
<img alt="base id in TablePlus" src="/images/api/sql-query/2026-05-29-sql-query-tableplus-base-id.png" />
