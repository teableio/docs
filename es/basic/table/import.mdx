...
<Steps>
  ...
  <Step title="Elige cómo crear la Tabla">
    Al crear una Tabla nueva, Teable ofrece **Importar con IA** o **Importar manualmente**. La opción de IA solo aparece si el Chat de IA está disponible para ti en la Base.
  </Step>
