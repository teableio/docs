...
- **Alan**, **Proje**, **Neden** veya **Sonuç** ölçütüne göre filtreleyin; görev, Proje, Alan ya da hata arayın veya yavaş görevleri ortaya çıkarmak için asgari işleme süresi belirleyin.
...
| **Zaman çizelgesi** | Yan yana üç şerit: **Uçtan uca**, kaynak değişiklikten hesaplanan yazımların yakınsamasına kadar; **Bu görev**, claim'den commit'e kadar; **Uyandırma işi** ise görevi çalıştıran uyandırmadır. Görev şeridi kuyruk beklemesi, claim / setup ve hesaplama olarak bölünür. Uyandırma işi aynı veritabanındaki diğer vadesi gelmiş işi de drain ettiğinden normalde uçtan uçadan uzun sürer. |
| **Görev zinciri** | Basamaklı yapıdaki her görev, kendisini kuyruğa alan görevin altında iç içe gösterilir; böylece bir dalın nereden geldiğini görebilirsiniz. Aynı aşamadan ayrılan kısmi gruplar seri bir kuyruktur ve daha derine iç içe girmek yerine tek düzeyde düz durur. Her satır durumunu, plan adımlarını, **Yazma hedefini** (görevin güncellediği Tablo ve Alanlar), **Tahmini karmaşıklığı**, basamak derinliğini, kuyruğa alınma zamanını ve süresini gösterir. |
...
**Anomali yönetimi**, tek bir temel nedenin kolayca fark edilebilmesi için anomalileri her Proje, kaynak Tablo ve hata için bir tane olacak şekilde sorun gruplarında toplar. Herhangi bir şeyi kurtarmadan önce hata nedenini inceleyip temel sorunu giderin. Hata ayrıntılarını ve kapsadığı görevleri okumak için bir grubu genişletin; bu satırlar inceleme amaçlıdır ve kurtarma her zaman grubun tamamında çalışır.
...
**Proje silindi** olarak işaretlenen bir grup, artık mevcut olmayan bir Projeye aittir. Kurtarılması hemen yeniden başarısız olacağından sunulan tek eylem **Grubu at** olur.
...
Duraklatma her zaman kendiliğinden sona erer ve ayarlayabileceğiniz en uzun süre iki saattir. Olay daha uzun sürerse duraklatmanın satırındaki **Uzat**’a tıklayın, ne kadar daha duraklı kalacağını seçin ve onaylayın. Yeni otomatik devam zamanı onayladığınız andan itibaren hesaplanır ve yine en fazla iki saat olur; böylece Alan arada serbest bırakılmaz.

Liste; etkin duraklatmaların tamamını, bunları kimin oluşturduğunu, nedenini ve otomatik olarak ne zaman devam edeceğini gösterir. Ayrıca etkin duraklatmaların kaç bekleyen görevi tuttuğunu da belirtir; böylece devam etmenin serbest bırakacağı birikimi değerlendirebilirsiniz. Duraklatmayı erken kaldırmak için satırındaki **Devam et**'e tıklayıp onaylayın.
...
| **Proje başına görev alma sınırları** | Bir Proje için (**Proje başına**) ve içindeki bir kaynak Tablo için (**Başlangıç Tablosu başına**) aynı anda çalışan hesaplama görevi sayısı. Her ikisinin varsayılan değeri 2'dir ve 1 ile 16 arasında değerleri kabul eder. |

Darboğazı tek bir yoğun Proje oluşturuyorsa görev alma sınırlarını, aynı anda çok sayıda Proje kuyruktaysa işlem başına eş zamanlılığı artırın.
