...
<Steps>
  ...
  <Step title="Tabloyu nasıl oluşturacağınızı seçin">
    Yeni bir tablo oluştururken Teable **AI ile içe aktar** ve **Manuel içe aktar** seçeneklerini sunar. AI seçeneği yalnızca o Base içinde AI Chat size açıksa görünür.
  </Step>
