...
- **Scraper**: Öffnen Sie das Menü **+** und wählen Sie **Scraper**, dann eine Plattform und einen Datentyp, etwa **Persönliches Profil** bei LinkedIn oder **Produktbewertungen** bei Amazon. Teable füllt die passende Anweisung in der Chat-Eingabe vor, die Sie mit einem Link oder einem Stichwort ergänzen. **Beliebige Webseite** nimmt einen eingefügten Link direkt entgegen.
