---
title: "Panoramica"
description: "Crea, importa, condividi e gestisci Tabelle in un Progetto."
---

{/* mintlify-resync: 2026-05-14 */}
Ogni Progetto può contenere più Tabelle per archiviare e gestire dati correlati. Le Tabelle Teable equivalgono alle Tabelle di un database: comprendere [in cosa differiscono dai fogli di calcolo](/it/compare/teable-vs-excel) ti aiuterà a sfruttare al meglio Teable.

## Creare e gestire le Tabelle

### Aggiungere Tabelle

In un Progetto, fai clic sul pulsante `+` nella directory e scegli se:
...
- **Ripristina**: riporta la Tabella nel Progetto con tutti i dati intatti
...
- Disattiva **Campo di ricerca** per eseguire una ricerca fuzzy nei Campi visibili nella Vista corrente; i Campi nascosti in quella Vista non vengono considerati. La ricerca globale non include i Campi data, casella di controllo o pulsante. L'istanza può inoltre limitare il numero di Campi inclusi nella ricerca globale.
