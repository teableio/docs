...
description: "Architecture, sizing, and deployment path selection for self-hosted Teable"
---

## Before You Begin

<CardGroup cols={2}>
  <Card title="Evaluating Teable?" icon="flask" href="/en/deploy/docker">
    Start with **Docker Quick Start** for small teams and testing.
  </Card>
  <Card title="Deploying for Production?" icon="server" href="#architecture-overview">
    Read this page first, then choose your platform below.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="AWS" icon="aws" href="/en/deploy/aws">
    ECS + RDS + ElastiCache + S3. Recommended for 100+ users.
  </Card>
