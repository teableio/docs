...
Teable 私有化版本提供多种部署方案，根据下方文档可以自助完成部署

## 部署方案概览

1. [一键云部署（推荐）](/si-you-hua-bu-shu/kai-shi-bu-shu#yi-jian-yun-bu-shu-tui-jian)

2. [Docker Compose 部署](/si-you-hua-bu-shu/kai-shi-bu-shu#docker-compose)

3. [Kubernetes 集群部署](/si-you-hua-bu-shu/kai-shi-bu-shu#kubernetes-k8s)
...
[配置邮件服务](/si-you-hua-bu-shu/kai-shi-bu-shu#qi-yong-you-jian-fu-wu)
...
[配置外部数据库连接](/si-you-hua-bu-shu/kai-shi-bu-shu#qi-yong-wai-bu-shu-ju-ku-lian-jie-gong-neng)
...
![](/images/si-you-hua-bu-shu/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F3UAxYOALe4vISZRKICva%252Fuploads%252FsNQdnvxOler8YEjTZKhL%252Fimage.png)
...
[上一页Teable 多维表格简介](/)[下一页环境变量](/si-you-hua-bu-shu/huan-jing-bian-liang)
