...
<CardGroup cols={2}>
  ...
  <Card title="Migrate Project Tools & More Sources" icon="plug" href="/en/basic/ai/connect-everything/more-sources">
    Use authorized APIs or exports from Jira, Asana, monday.com, ClickUp, and other systems.
  </Card>
</CardGroup>
