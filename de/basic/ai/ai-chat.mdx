...
Die Erinnerung speichert Informationen, an deren Speicherung Sie Cuppy ausdrücklich bitten. Die Erinnerung ist nach Benutzer und Projekt abgegrenzt: Jede Person hat in jeder Projekt einen unabhängigen Erinnerungskontext, und eine in einer anderen Projekt gespeicherte Erinnerung erscheint nicht automatisch in der aktuellen.
...
- Erinnerung aus einer anderen Projekt wiederverwenden
...
<AccordionGroup>
  ...
  <Accordion title="Kann der KI-Chat in einer anderen Projekt arbeiten?">
    Ja. Die KI ist nicht auf das Projekt beschränkt, zu der der Chat gehört; sie kann andere Projekte, auf die Sie Zugriff haben, suchen und darin arbeiten. Nennen Sie das Projekt in Ihrer Anfrage, zum Beispiel „Vergleiche diese Tabelle mit der Bestelltabelle in der Sales-Projekt“. `@` listet nur Knoten in dem aktuellen Projekt auf, und alles, worauf Sie nicht anders verweisen, geschieht weiterhin in dem eigenen Projekt des Chats.
  </Accordion>
  ...
  <Accordion title="Wird die Erinnerung zwischen Projekte übernommen?">
    Nein. Die Erinnerung ist nach Benutzer und Projekt abgegrenzt. Wenn Sie eine Erinnerung aus einer anderen Projekt wiederverwenden möchten, bitten Sie Cuppy, die Erinnerung diesem Projekt zu lesen und die relevanten Teile in dem aktuellen Projekt zu speichern.
  </Accordion>
