...
Le journal d’audit couvre les activités courantes d’administration et de collaboration, notamment les Espaces, Projets, Tables, Vues, Champs, Enregistrements, le partage, les invitations, les jetons d’accès et la matrice d’autorisations.

Chaque entrée du journal affiche l’heure de l’opération, l’opérateur, le type d’action, le Projet ou l’Espace associé et la source de la requête. Ouvrez une entrée du journal pour afficher ses détails.
...
- **Sélectionner un Projet** : affiche l’activité associée à un Projet spécifique.
- **Sélectionner une action** : filtre par type d’opération, par exemple les Enregistrements, Champs, Vues, Tables, Projets, le partage, la matrice d’autorisations, les rôles de la matrice d’autorisations, les Espaces, les invitations, les utilisateurs et les jetons d’accès.

Si un utilisateur, un Projet ou un Espace a été supprimé, l’entrée reste dans le journal et la ressource est marquée comme supprimée.
