...
- **Model**: Sohbette kullanılacak model katmanını seçmek için model menüsünü kullanın. Menüde en yetenekliden başlayarak **Ultra**, **Smart**, **Standard** ve **Lite** yer alır ve her birinin arkasındaki model gösterilir; yöneticiniz bu modeli istediği zaman değiştirebilir ya da katmanların yalnızca bir kısmını sunabilir, sizin yeniden seçim yapmanız gerekmez. Basit sorgular, temizleme veya yeniden yazma için daha alt; karmaşık planlama, Tablolar arası analiz ve uygulama geliştirme için daha üst bir katman kullanın. Bulut'ta menü ayrıca her katmanın varsayılan katmana göre işlem gücü çarpanını gösterir (örneğin **2.5×**); varsayılan katmanla yaklaşık aynı miktarda veya hiç platform işlem gücü harcamayan katmanlarda çarpan görünmez. Sohbet sürerken katman değiştirmek bir kez onay ister; sohbet korunur ve yeni model bir sonraki mesajınızdan itibaren devralır.
...
- **Gizli anahtarlarım**: **+** → **Daha Fazla** → **Gizli anahtarlarım** yolunu açıp API anahtarlarını veya diğer kimlik bilgilerini **Ayarlar** → **Entegrasyonlar** bölümüne kaydedin. Bu değerler size aittir, AI Chat bunları çalışma sırasında ortam değişkeni olarak okuyabilir ve tek tek uygulama ve otomasyonlara verebilirsiniz. Bkz. [Kimlik Bilgileri ve Entegrasyonlar](/tr/basic/credential).
- **Yetkilendirme kartları**: AI'ın üçüncü taraf bir hesaba veya bir gizli anahtara ihtiyacı olduğunda sohbete bir kart sabitlenir ve siz karşılık verene kadar tur ilerlemez. Hesaba görevi yapmak için Cuppy'nin kendisi ihtiyaç duyuyorsa OAuth akışı için **Bağlan**'a tıklayın; kimlik bilgisine çalışma sırasında bir uygulama ya da otomasyon ihtiyaç duyuyorsa **Hesabımı bağla**'yı seçin veya hâlihazırda sahip olduğunuz bir kimlik bilgisine erişim verin. **Atla**'ya tıklarsanız kimlik bilgisini vermezsiniz; AI, onsuz tamamlayabildiği bölümlerle devam eder. Bkz. [Kimlik Bilgileri ve Entegrasyonlar](/tr/basic/credential).
- **Kazıyıcı**: **+** menüsünü açıp **Kazıyıcı**'yı seçin, ardından bir platform ve veri türü belirleyin. Girişler iki türlüdür: bir kısmı yapıştırdığınız bağlantıdan veri çeker, örneğin LinkedIn'de **kişisel profil** veya Amazon'da **ürün yorumları**; diğerleri anahtar kelime, etiket ya da adla arar, örneğin TikTok'ta **video arama** veya Reddit'te **subreddit'in gönderileri**. Teable ilgili talimatı sohbet girişine önceden doldurur ve tamamlamanız gereken kısmı sonda bırakır. **Herhangi bir web sayfası** seçeneği yapıştırdığınız bağlantıyı doğrudan alır.
- **Skill'ler**: Mevcut sohbette Skill'leri içe aktarmak, etkinleştirmek, devre dışı bırakmak veya denemek için **+** menüsünü açıp **Skill'ler**'i seçin. Bir Skill'i içe aktarırken kimlerin kullanabileceğini seçin: **Kişisel** yalnızca sizin kullanımınıza sunar, **Proje** bu Projedeki işbirlikçilerin, **Alan** ise bu Alandaki herkesin kullanımına sunar. Etkin bir Skill'i seçmek için giriş kutusuna `/` yazın. Harici bir sistemi bağlamak veya taşımak için [Her Şeyi Bağlama ve Taşıma](/tr/basic/ai/connect-everything) bölümüne bakın.
...
- **Mesaj kuyruğu**: AI çalışırken başka bir mesaj göndermek işlemi kesintiye uğratmaz. Mesaj, giriş kutusunun üzerindeki kuyrukta bekler ve mevcut çalışma sona erdiğinde gönderilir. Kuyruktaki öğeler sohbet girişiyle aynı Tablo, Görünüm, ek ve seçim etiketlerini korur; **Kaldır** bir öğeyi siler, **...** → **Mesajı düzenle** öğeyi yeniden giriş kutusuna taşır, yalnızca metin içeren öğelerde bulunan **Yönlendir** ise metni bekletmek yerine çalışan işleme aktarır. Tur, sizi bekleyen bir kartta duruyorsa (yetkilendirme kartı, AI'ın sorusu), yalnızca metin içeren mesaj kuyruğa girmez: kart kapanır ve **Atlandı** olarak işaretlenir, mesajınız da o turun bir sonraki talimatı olarak doğrudan iletilir, yani önce kartla uğraşmanız gerekmez. Ek içeren mesajlar yine kuyruğa girer.

## Sohbetleri yönetme

Sohbet panelinin sağ üstündeki **Geçmiş** düğmesine tıklayarak geçerli projedeki sohbetlerinizi görebilir ve ada göre arayabilirsiniz.

Sohbet adının yanındaki nokta, hangi sohbetlerin sizi beklediğini gösterir. **Yanıtınız bekleniyor**, turun sizi ilgilendiren bir noktada durduğu anlamına gelir: ajanın bir sorusu, bir yetkilendirme, seçilecek bir tablo ya da bir kimlik bilgisi talebi. Siz yanıtlamadan devam etmez. **Yanıt başarısız oldu**, son yanıtın düzgün tamamlanmadığını gösterir; sohbeti açıp yeniden sorun. **Oluşturuluyor…** ve okunmadı noktası yalnızca ilerlemeyi ve yeni yanıtları bildirir, sizden bir şey istemez.

Bir sohbetin **...** menüsünde **Sabitle**, **Yeniden Adlandır**, **Arşivle** ve silme bulunur. Silme işlemi tüm mesajları da kaldırır ve geri alınamaz.

Geçmiş, en son 100 sohbeti gösterir. Sık kullandıklarınızı sabitleyin: sabitlenmiş sohbet listenin başında durur ve bu sınırın dışındadır, dolayısıyla yeni sohbetler biriktikçe dışarı itilmez. Sohbeti sürükleyerek yerini de değiştirebilirsiniz.

Uygulama Oluşturucu sohbetleri kendi uygulamalarının adını taşır ve arşivlenemez.

### Arşivlenen sohbetler

Arşivleme, bir sohbeti hiçbir şeyi silmeden geçmiş listesinden çıkarır. Sol alttaki avatarınız → **Ayarlar** → **Arşivlenen sohbetler** yolundan farklı projelerde arşivlediğiniz sohbetleri görebilirsiniz. **Geri yükle** sohbeti kendi projesinin geçmişine döndürür; artık gerekmediğinden eminseniz burada silebilirsiniz de.
...
Her yanıtın altındaki **Bu turdaki değişiklikler**, turun neyi değiştirdiğini kaynak kaynak listeler: eklenen, güncellenen veya silinen alanlar, görünümler ve kayıt sayıları, ayrıca yayımlanan ya da açılıp kapatılan uygulamalar ve otomasyonlar. Bir satıra tıklayarak ilgili kaynağı açıp kontrol edebilirsiniz.
...
Ürün konsepti, yazı görseli, afiş taslağı gibi işlerde yapay zekâdan doğrudan görsel isteyebilirsiniz:

- Bu ürünün kullanıldığı bir sahne çiz.
- Bu kaydın açıklamasından bir kapak görseli üret.
- Bu görseli örnek al, kış renkleriyle üç tane daha ver.

Sohbete mevcut bir görsel eklerseniz referans olarak kullanılır; yeter ki seçilen model görselden görsele üretimi desteklesin.

Sohbette bir üretim kartı görünür: hangi modelin çalıştığını ve kaç görselin kaldığını gösterir, tamamlananları da tıklayınca büyüyen bir galeri olarak sunar. Görseller sohbetin korumalı alanında saklanır ve **Dosyaları yönetme** üzerinden indirilebilir. Turu durdurduğunuzda tamamlanmamış görseller iptal edilir.

<Info>AI Chat, [App Builder](/tr/basic/ai/app-builder) ve [rutinler](/tr/basic/ai/routine) görsel oluşturabilir; Cuppy ile bir mesajlaşma uygulamasında sohbet ederken bu özellik yoktur.</Info>
...
Bellek, Cuppy'den açıkça hatırlamasını istediğiniz bilgileri saklar. Belleğin kapsamı kullanıcıya ve Projeye göredir: Her kullanıcının her Projede bağımsız bir bellek bağlamı vardır ve başka bir Projeye kaydedilen bellek mevcut Projede otomatik olarak görünmez.

- Belleği mevcut Projeye kaydetme
...
- Başka bir Projedeki belleği yeniden kullanma

Cuppy'den başka bir Projeyi okumasını ve ilgili bölümleri mevcut Projeye kaydetmesini isteyin:

```text
Cuppy, lütfen bsexxxxxxxxxxxx kimlikli Projenin belleğini oku ve ilgili belleği geçerli Projeye kaydet.
```
...
<Steps>
  ...
  <Step title="Parola ekleyin (isteğe bağlı)">
    Gelişmiş ayarlarda **Parola koruması**'nı etkinleştirdiğinizde Teable otomatik olarak bir parola oluşturur. Görüntüleyenlerin yapıt yüklenmeden önce bu parolayı girmesi gerekir. İkisini birlikte kopyalamak için **Bağlantıyı ve şifreyi kopyala**'ya tıklayın.
  </Step>
...
- **Katmanı göreve göre seçin**: Basit sorgular, temizleme ve yeniden yazmada alt katman daha az işlem gücü harcar; karmaşık planlama, Tablolar arası analiz ve uygulama geliştirme için üst katmana geçin.
...
<AccordionGroup>
  ...
  <Accordion title="AI Chat başka bir Projede çalışabilir mi?">
    Evet. AI, sohbetin ait olduğu Projeyle sınırlı değildir; erişebildiğiniz diğer Projeleri bulup bunlarda çalışabilir. İsteğinizde Projenin adını belirtin; örneğin "bu Tabloyu Satış Projedeki siparişler Tablosuyla karşılaştır" yazın. `@` yalnızca mevcut Projedeki düğümleri listeler ve başka bir yer belirtmediğiniz tüm işlemler sohbetin kendi Projede gerçekleşir.
  </Accordion>
  ...
  <Accordion title="Bir istek kaç görsel üretir?">
    Varsayılan olarak beş. Daha fazlası gerekiyorsa yapay zekâdan birkaç turda üretmesini isteyin. Bir alanın aynı anda üretebileceği görsel sayısı da sınırlıdır; aşan kısım sırada bekler.
  </Accordion>

  <Accordion title="Görselleri hangi model üretir?">
    Kullanılabilir görsel modelleri Projenin yapay zekâ yapılandırmasından gelir: önce alanın kendi modelleri, sonra Teable'ın sunduğu modeller. Projede kullanılabilir bir görsel modeli yoksa yapay zekâ görsel oluşturmayı hiç önermez.
  </Accordion>

  <Accordion title="Oluşturulan görseller nasıl ücretlendirilir?">
    Bir görsel ancak kaydedildiğinde kredilerden düşer; başarısız olan ya da iptal edilen görseller ücretsizdir. Faturalandırma sayfasındaki **Kredi Kullanım Bilgileri** bölümünde bu harcamalar **Yapay zeka ile görsel oluşturma** türü altında görünür. Alanın kendi modelleri (BYOK) varsa, krediler bitmiş olsa bile bu modellerle üretim durmaz.
  </Accordion>

  <Accordion title="Bellek Projeleri arasında aktarılır mı?">
    Hayır. Belleğin kapsamı kullanıcıya ve Projeye göredir. Başka bir Projedeki belleği yeniden kullanmak istiyorsanız Cuppy'den o Projenin belleğini okumasını ve ilgili bölümleri mevcut Projeye kaydetmesini isteyin.
  </Accordion>
  ...
  <Accordion title="AI Chat için API anahtarlarını nereye eklemeliyim?">
    Sohbet girişinde **+** → **Daha Fazla** → **Gizli anahtarlarım** yolunu kullanın. AI Chat, düz metni isteminize eklemeden bu değerleri sohbet sırasında kullanabilir.
  </Accordion>
  <Accordion title="İhtiyacım olan platform Kazıyıcı menüsünde yoksa ne yapmalıyım?">
    Menüde yaygın platformlar yer alır. Hangi siteden ne almak istediğinizi kendi cümlelerinizle anlatın; yapay zekâ uygun veri kaynağını bulur.
  </Accordion>
  <Accordion title="Bir kazıma kaç kayıt getirir?">
    Arama sonuçları, akışlar ve yorumlar gibi liste içeriklerinde her bağlantı veya anahtar kelime varsayılan olarak en fazla 10 kayıt getirir. Daha fazlası gerekiyorsa isteğinizde sayıyı belirtin; üst sınır 50'dir. Tek bir sayfanın kazınması o tek kaydı verir ve bu sınırdan etkilenmez.
  </Accordion>
</AccordionGroup>
