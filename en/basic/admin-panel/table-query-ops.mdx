...
The search box accepts table, Base, and Space names or IDs. Sorting is either **Most slow queries** or **Table name**. **Observation window** covers the last 1 hour, 24 hours, or 7 days, and every observation figure in the list follows that window.
