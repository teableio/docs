...
La memoria archivia le informazioni che chiedi esplicitamente a Cuppy di ricordare. La memoria è circoscritta per utente e Progetto: ogni utente in ogni Progetto dispone di un contesto di memoria indipendente e la memoria salvata in un'altra Progetto non appare automaticamente in quella corrente.
...
- Riutilizzare la memoria da un'altra Progetto

Chiedi a Cuppy di leggere un'altra Progetto e salvare le parti pertinenti in quella corrente:
...
<AccordionGroup>
  ...
  <Accordion title="La memoria viene condivisa tra i Progetti?">
    No. La memoria è circoscritta per utente e Progetto. Se vuoi riutilizzare la memoria da un'altra Progetto, chiedi a Cuppy di leggere la memoria di quella Progetto e salvare le parti pertinenti in quella corrente.
  </Accordion>
  ...
  <Accordion title="Come si utilizzano le skill in AI Chat?">
    Apri il menu **+** e scegli **Skill** per importare o gestire le skill oppure digita `/` nella casella di input per sceglierne una abilitata. Durante l'importazione scegli chi può utilizzarla: personale per le tue chat, Progetto quando serve ai collaboratori della stessa Progetto e Spazio quando serve a tutti gli utenti dello Spazio. Gli utenti autorizzati a gestire il Progetto possono aggiungere skill del Progetto, mentre proprietari e creatori dello Spazio possono aggiungere skill dello Spazio. Se AI Chat presenta un file `.skill`, usa **Installa** nella scheda del file per aggiungerlo.
  </Accordion>
