...
- **Solicitudes de credenciales**: Cuando la IA necesita una cuenta externa o un secreto, fija en la conversación una tarjeta de solicitud. Elige **Conectar mi cuenta** para iniciar un flujo de OAuth o concede una credencial que ya tengas. Con **Omitir** no la facilitas; la IA continúa con las partes que puede completar sin ella.
