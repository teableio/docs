...
| Métrica | Descripción |
|--------|-------------|
| **Total de colaboradores** | Número de colaboradores facturables del Espacio actual y sus Proyectos |
...
<Tip>Los datos de la Papelera del Espacio y de la Papelera de los Proyectos se incluyen en las estadísticas del total de Registros. Para reducirlo, elimina datos en «Espacio → Papelera» o «Proyecto → Papelera».</Tip>

Haz clic en **Detalles** en la tarjeta **Total de Registros** para consultar el uso de Registros por Proyecto. El cuadro de diálogo muestra los Registros activos, los Registros de la Papelera y el total de Registros de cada Proyecto. Desde él puedes abrir la página de la Papelera de un Proyecto o eliminar permanentemente un Proyecto que ya esté en la Papelera.

### Cuando se alcanza un límite

Cuando el Espacio alcanza un límite del plan, Teable detiene la acción antes de ejecutarla y abre el cuadro de diálogo para mejorar el plan, que indica el límite alcanzado, muestra cuánto has utilizado y ofrece enlaces al uso por Proyecto. Esto se aplica a pegar, rellenar y duplicar filas, crear Registros en bloque, importar y cargar archivos adjuntos.

Para continuar, mejora el plan o libera espacio eliminando Registros o archivos adjuntos.

### Créditos

Los Créditos son las unidades de uso de Teable para las funciones basadas en IA. El consumo depende de los tokens de IA utilizados por los modelos de lenguaje subyacentes y puedes consultar los detalles en la página Facturación.

En los planes de pago, los Créditos se compran por asiento. Cada tarjeta de plan ofrece un nivel de **Créditos/asiento/mes** y los Créditos mensuales del Espacio equivalen al número de asientos adquiridos multiplicado por ese nivel; todos los usuarios del Espacio los comparten. Los Créditos mensuales se restablecen en cada periodo de facturación y no se acumulan.

| Plan | Créditos |
|------|-----------------|
| **Free** | Regalo único de 200 Créditos |
| **Pro** | De 2000 a 6000 Créditos por asiento al mes |
| **Business** | De 3000 a 1 000 000 de Créditos por asiento al mes |

Los 200 Créditos del plan Free son un **Bono de bienvenida** que se concede al registrarte. No caducan y se suman a los Créditos adicionales de la tarjeta de Créditos.
...
**Qué ocurre cuando se agotan los Créditos:** en los planes de pago, una vez agotados tus Créditos mensuales, las funciones de IA estarán limitadas hasta el siguiente ciclo de facturación o hasta que aumentes el nivel de Créditos. En el plan Free, cuando agotes el Bono de bienvenida, puedes pasar a un plan de pago para obtener más Créditos.
...
Los asientos se compran por adelantado y puedes adquirirlos antes de ampliar tu equipo. Los colaboradores con rol de **Propietario**, **Creador** o **Editor** en el Espacio y sus Proyectos ocupan un asiento. Los roles de **Comentador** y **Espectador** son gratuitos.
...
<AccordionGroup>
  ...
  <Accordion title="¿Para qué se utilizan los Créditos?">
    Las funciones de Teable basadas en IA utilizan Créditos. Consulta los datos de uso de Créditos en la página Facturación para conocer el consumo concreto. Los Espacios gratuitos reciben 200 Créditos una sola vez al registrarse, y no se restablecen cada mes. En Pro y Business, eliges un nivel de Créditos/asiento/mes al suscribirte, y los Créditos mensuales del Espacio equivalen a ese nivel multiplicado por los asientos adquiridos.
  </Accordion>
