...
description: "Gestisci i modelli di flusso di lavoro per la tua organizzazione, consentendo agli utenti di iniziare rapidamente con Progetti preconfigurate."
---
...
* **Solution**: se il modello è contrassegnato così, usarlo apre prima la configurazione delle integrazioni invece di copiare subito il progetto. La colonna **Integrations** elenca le piattaforme a cui si collega
* **Origine**: Progetto originale utilizzata per creare il modello

#### Operazioni sui modelli

* **Nuovo modello**: crea una nuova configurazione di modello
* **Pubblica snapshot**: acquisisce lo stato corrente del Progetto di origine. Devi pubblicare uno snapshot prima di poter inserire il modello nell'elenco.
...
2. **Importa**: importa il file `.tea` come nuovo Progetto nel tuo Spazio
3. **Crea modello**: vai ad Amministrazione modelli > Nuovo modello
4. **Seleziona origine**: scegli il Progetto importata come origine
