...
Eine Automatisierung ruft externe Dienste mit Ihren Zugangsdaten auf: einer OAuth-Verbindung oder einem von Ihnen hinterlegten Secret. Öffnen Sie den Workflow im Bearbeitungs-Tab, klicken Sie neben den Test-Steuerelementen auf **Zugangsdaten & Konfiguration**, geben Sie Zugangsdaten für diese Automatisierung frei und vergeben Sie einen **Variablennamen**.

Skriptaktionen lesen diesen Namen aus einer Umgebungsvariablen wie `process.env.EXTERNAL_API_KEY`; in anderen Aktionen fügen Sie über **Secret einfügen** neben einem Eingabefeld einen Verweis ein. Werte werden nie im Klartext angezeigt, und Testergebnisse maskieren sie.

Die Zugangsdaten selbst liegen unter **Einstellungen** → **Integrationen**, siehe [Zugangsdaten und Integrationen](/de/basic/credential).
...
| Element | Limit |
|---|---|
| E-Mail-Senderate | 5 / Sekunde / Projekt |
| Webhook-Empfangsrate | 50 / Sekunde / Projekt, 2 / Sekunde / Workflow |
