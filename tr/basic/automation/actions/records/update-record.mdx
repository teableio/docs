...
- Farklı bir Projedeki tabloda bulunan kayıtları güncellemek için [Projeler Arası Erişim](/tr/basic/automation/actions/records/cross-base) özelliğini kullanın.
...
- [Projeleri arası erişim](/tr/basic/automation/actions/records/cross-base) — geçerli Projenin dışındaki tablolarda bulunan kayıtları güncelleyin
