...
<Steps>
  ...
  <Step title="Doppelte Werte entfernen (optional)">
    Aktivieren Sie **Doppelte Werte entfernen**, damit jeder Wert nur bei seinem ersten Auftreten erhalten bleibt. Teable entfernt die Duplikate erst nach Filter, Sortierung und Datensatzbegrenzung, die Begrenzung zählt also weiterhin die passenden Datensätze und nicht die verbleibenden Werte.
  </Step>
</Steps>
