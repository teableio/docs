---
title: "[DEPRECATED] Configure Email Service"
description: "This method of email configuration is deprecated. Please use Admin Panel > Settings for visual email configuration instead. Enable email service to activate in-app email notifications, self-service password reset, and other features."
---

<Info>
Deprecated Configuration Method
**This documentation is deprecated.** Environment variable-based email configuration is no longer recommended. 

**Please use the Admin Panel > Settings instead** for a visual and user-friendly email configuration experience.
</Info>
