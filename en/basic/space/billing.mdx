...
<AccordionGroup>
  ...
  <Accordion title="How does Teable's pricing work?">
    ...
    For Business plans with Authority Matrix enabled, users assigned through Authority Matrix rules may also affect seat count based on their highest granted permission.
