...
Se lo script richiede un servizio come Slack, Airtable o Google Sheets, fai clic sui pulsanti delle integrazioni nella parte superiore del pannello IA per collegare i tuoi account. L'IA utilizzerà queste connessioni durante la generazione del codice.
