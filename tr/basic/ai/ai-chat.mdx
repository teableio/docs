...
- **Kimlik bilgisi istekleri**: AI'ın üçüncü taraf bir hesaba veya bir gizli anahtara ihtiyacı olduğunda sohbete bir kimlik bilgisi isteği kartı sabitlenir. OAuth akışı için **Hesabımı bağla**'yı seçin ya da hâlihazırda sahip olduğunuz bir kimlik bilgisine erişim verin. **Atla**'ya tıklarsanız kimlik bilgisini vermezsiniz; AI, onsuz tamamlayabildiği bölümlerle devam eder.
