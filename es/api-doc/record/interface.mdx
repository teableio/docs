...
<Note>El Campo de búsqueda no es un tipo de Campo específico. Se puede buscar cualquier tipo de Campo de un Proyecto enlazado. El tipo de un Campo de búsqueda viene determinado por el Campo original del Proyecto enlazado y tiene la propiedad isLookup. Los Campos de búsqueda no se pueden editar.</Note>
