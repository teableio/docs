...
<Steps>
  ...
  <Step title="Doppelte Werte entfernen">
    Aktivieren Sie **Doppelte Werte entfernen**, und jeder Wert erscheint einmal. Das Entfernen ist der letzte Schritt: Teable holt die Datensätze, die Filter, Sortierung und Datensatzbegrenzung passieren, und entfernt dann Duplikate unter deren Werten. Im Ergebnis können also weniger Werte stehen, als Sie Datensätze zugelassen haben.
  </Step>
</Steps>
