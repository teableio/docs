...
- [Get records action](/basic/automation/actions/records/get-records) — typically the first step after a schedule trigger
- [Send email action](/basic/automation/actions/communication/send-email) — commonly paired with schedules for periodic notifications
- [Loop (batch) action](/basic/automation/actions/logic/loop-run) — useful for processing the array of records returned by Get Records
