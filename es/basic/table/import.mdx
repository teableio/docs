...
Utiliza la importación para inicializar una Tabla nueva, añadir datos a una Tabla existente o incorporar Tablas de Airtable o Google Sheets a un Proyecto de Teable. Airtable y Google Sheets también están disponibles al importar un Proyecto completo.
...
<Steps>
  ...
  <Step title="Elige cómo crear la Tabla">
    Al crear una Tabla nueva, Teable ofrece **Importar con IA** o **Importar manualmente**.
  </Step>
...
Una vez cargado el archivo, Teable ofrece **Optimizar e importar con IA**. **Importar con IA** entrega el archivo al Chat de IA, que analiza los datos, ajusta la estructura de la Tabla, las relaciones y los tipos de Campo, y ejecuta la importación. El cuadro de diálogo de importación se cierra y se abre el panel de chat, así que puedes seguir el progreso y responder para orientar el resultado. Una importación con IA consume créditos de IA y se ofrece al crear una Tabla nueva, no al importar a una existente.

**Importar manualmente** lleva a la vista previa de Campos, y **Volver** en la vista previa devuelve a esta elección.
...
- Para crear un Proyecto de Teable nueva, abre el menú del Espacio de destino, haz clic en **Importar** y elige **Importar desde Airtable**.
- Para importar Tablas en el Proyecto de Teable que estás consultando, utiliza el menú de recursos del Proyecto:

1. Abre el Proyecto de Teable de destino.
...
<img
  ...
  alt="Acceso a la importación desde Airtable en el menú del Proyecto"
  className="docs-screenshot"
/>
...
- Para crear un Proyecto de Teable nueva, abre el menú del Espacio de destino, haz clic en **Importar** y elige **Importar desde Google Sheets**.
- Para añadir Tablas al Proyecto que estás consultando, haz clic en `+` en la parte superior del directorio de la izquierda y elige **Google Sheets** en **Agregar de otras fuentes**.
...
<Steps>
  ...
  <Step title="Inicia la importación">
    Haz clic en **Iniciar importación** y mantén abierto el cuadro de diálogo. Este muestra el progreso Tabla por Tabla y, al finalizar, cuántos Registros ha recibido cada una. Después de importar un Proyecto nueva, usa **Abrir Proyecto** para ir directamente al resultado.
  </Step>
</Steps>
