...
Das Audit-Protokoll umfasst gängige Verwaltungs- und Kollaborationsaktivitäten, einschließlich Spaces, Projekte, Tabellen, Ansichten, Feldern, Datensätzen, Freigaben, Einladungen, Zugriffstokens und der Berechtigungsmatrix.

Jeder Protokolleintrag zeigt Operationszeit, Ausführenden, Aktionstyp, zugehöriges Projekt oder zugehörigen Space sowie die Anfragequelle. Öffnen Sie einen Protokolleintrag, um seine Details anzuzeigen.
...
- **Projekt auswählen**: Aktivitäten für ein bestimmtes Projekt anzeigen.
- **Aktion auswählen**: Nach Operationstyp filtern, etwa Datensätze, Felder, Ansichten, Tabellen, Projekte, Freigaben, Berechtigungsmatrix, Rollen der Berechtigungsmatrix, Spaces, Einladungen, Benutzer und Zugriffstokens.

Wenn ein Benutzer, ein Projekt oder ein Space gelöscht wurde, bleibt der Eintrag im Protokoll erhalten und die Ressource wird als gelöscht markiert.
