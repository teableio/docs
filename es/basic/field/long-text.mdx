...
- Las direcciones web del texto se convierten en enlaces en los que se puede hacer clic, sin necesidad de configurar nada. Al abrir un Registro, un botón junto al campo de entrada muestra todas las direcciones encontradas en la celda.
- Texto largo no admite la visualización interactiva como correo electrónico o teléfono. Usa un Campo **Texto de una línea** cuando quieras hacer clic en una dirección o un número para escribir o llamar.
