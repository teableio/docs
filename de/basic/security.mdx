...
|--------|-------------|----------|
| **[Projekt-Export](/de/basic/base#export-base-backup-&-migration)** | Gesamte Projekt als `.tea`-Datei herunterladen (Struktur, Daten, Automatisierungen) | Vollständige Sicherung, Migration |
...
<Tip>
Sie können Ihre Projekte manuell sichern, indem Sie die gesamte Projekt als `.tea`-Datei exportieren, einzelne Tabellen als CSV-Dateien exportieren oder Ihre Daten über die Teable API abrufen.
</Tip>
