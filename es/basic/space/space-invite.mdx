...
Cuando compartes un Espacio con otro usuario, este se convierte en colaborador del Espacio y obtiene acceso a todas los Proyectos que contiene.
...
4. **Invitación por correo electrónico**: introduce una o varias direcciones de correo electrónico, separadas por comas. Después, establece el nivel de permisos que quieras conceder a los usuarios para todas los Proyectos del Espacio. Por último, haz clic en Enviar correo electrónico para invitarlos a colaborar.
...
<Note>Los colaboradores de un Espacio tienen acceso a todas sus Proyectos. Si alguien solo necesita trabajar en determinadas Proyectos, considera añadirlo como [colaborador de un Proyecto](/es/basic/space/base-invite).</Note>
...
* **Ámbito**: eliminar a una persona del Espacio no retira los permisos que tenga en Proyectos concretas.
...
## Revisar el acceso a los Proyectos {#revisar-el-acceso-a-las-bases}

Cada persona o departamento aparece una sola vez en la lista de colaboradores del Espacio, incluso si también tiene permisos en Proyectos concretas. Una insignia **Permisos de Proyecto** junto al rol indica a cuántas Proyectos se le ha invitado. Las personas que nunca se hayan añadido al propio Espacio aparecen como **Solo tiene acceso a los Proyectos seleccionados**.

Expande una fila para ver esas Proyectos y el rol que tiene en cada una. Desde ahí, **Eliminar acceso al Proyecto** retira un permiso de Proyecto y **Eliminar colaborador**, en una fila correspondiente únicamente a un Proyecto, retira todos los permisos de Proyecto que esa persona tenga en el Espacio.
