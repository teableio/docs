...
Il registro di controllo copre le attività comuni di amministrazione e collaborazione, tra cui Spazi, Progetti, Tabelle, Viste, Campi, Record, condivisioni, inviti, token di accesso e Matrice delle autorizzazioni.

Ogni voce di registro mostra l'ora dell'operazione, l'operatore, il tipo di azione, il Progetto o lo Spazio correlato e l'origine della richiesta. Apri una voce di registro per visualizzarne i dettagli.
...
- **Seleziona Progetto**: mostra le attività relative a un Progetto specifico.
- **Seleziona azione**: filtra per tipo di operazione, ad esempio Record, Campi, Viste, Tabelle, Progetti, condivisione, Matrice delle autorizzazioni, ruoli della Matrice delle autorizzazioni, Spazi, inviti, utenti e token di accesso.

Se un utente, un Progetto o uno Spazio è stato eliminato, la voce rimane nel registro e la risorsa viene contrassegnata come eliminata.
