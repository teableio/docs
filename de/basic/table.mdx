---
title: "Übersicht"
description: "Tabellen in einem Projekt erstellen, importieren, teilen und verwalten."
---

{/* mintlify-resync: 2026-05-14 */}
Jedes Projekt kann mehrere Tabellen zum Speichern und Verwalten zusammengehöriger Daten enthalten. Teable-Tabellen entsprechen Datenbanktabellen — wenn Sie verstehen, [wie sie sich von Tabellenkalkulationen unterscheiden](/de/compare/teable-vs-excel), können Sie Teable optimal nutzen.

## Tabellen erstellen und verwalten

### Tabellen hinzufügen

Klicken Sie in einem Projekt im Verzeichnis auf die Schaltfläche `+` und wählen Sie eine der folgenden Optionen:
...
Wenn andere Tabellen auf die Tabelle verweisen, die Sie löschen, listet der Bestätigungsdialog die Felder auf, die vom Löschen betroffen sind, sowie das jeweilige Projekt und die Tabelle. Beim Löschen der Tabelle werden diese Verknüpfungsfelder in einzeilige Textfelder umgewandelt, die die Titel der verknüpften Datensätze beibehalten; darauf aufbauende Lookup- oder Rollup-Felder funktionieren anschließend nicht mehr.

### Papierkorb

Klicken Sie oben links in dem Projekt auf das Papierkorbsymbol, um gelöschte Tabellen zu verwalten.
...
- **Wiederherstellen**: Bringt die Tabelle mit allen Daten intakt zurück in das Projekt.
...
- Deaktivieren Sie **Suchfeld**, um eine unscharfe Suche über die in der aktuellen Ansicht sichtbaren Felder auszuführen; in dieser Ansicht ausgeblendete Felder werden nicht berücksichtigt. Die globale Suche umfasst keine Datums-, Kontrollkästchen- oder Schaltflächenfelder. Ihre Instanz kann außerdem die Anzahl der Felder begrenzen, die von der globalen Suche abgedeckt werden.
