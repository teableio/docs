...
3. **Go to AI Configuration:** In the settings menu, select and click "AI Configuration."
4. **Add AI Integration:** In the AI Configuration interface, click the "+ Add Model Provider" button.
