...
- Metindeki web adresleri, hiçbir ayar yapmadan tıklanabilir bağlantılara dönüşür. Kaydı genişlettiğinizde, giriş alanının yanındaki bağlantı düğmesi hücredeki tüm adresleri listeler.
- Uzun Metin, E-posta veya Telefon etkileşimli görüntülemesini desteklemez. Bir adrese ya da numaraya tıklayıp yazmak veya aramak istiyorsanız **Tek Satır Metin** alanını kullanın.
