...
- Die ID Ihres Projekts sowie die Tabellen- und Feld-IDs. Siehe [IDs abrufen](/de/api-doc/get-id).
...
- Verwenden Sie das PAT mit den geringstmöglichen Berechtigungen – beschränken Sie es auf die benötigten Spaces und Projekte.
