...
Si votre script a besoin d’un service tel que Slack, Airtable ou Google Sheets, cliquez sur les boutons d’intégration en haut du panneau IA pour connecter vos comptes. L’IA utilisera ces connexions lors de la génération du code.
