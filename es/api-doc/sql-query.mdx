...
1. **Abre una Tabla**: Primero, abre cualquier Tabla del Proyecto a la que quieras conectarte.
2. **Entra en la página de diseño**: Haz clic en el icono ⚙️ de la esquina superior derecha para acceder a la página de diseño del Proyecto.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-open-design-page-en.png"
  alt="Abrir la página de diseño del Proyecto"
...
- **Nombre del esquema (BaseId)**: El identificador del Proyecto que comienza por `bse`
...
Cada Proyecto de Teable corresponde a un **esquema** en PostgreSQL. El BaseId es el nombre de esquema utilizado en las consultas SQL.
...
<img
  ...
  alt="ID del Proyecto en la URL"
  className="docs-screenshot"
/>

**Método 2:** En la interfaz de diseño del Proyecto, el nombre de esquema que se muestra es el BaseId.

<img
  src="/images/api/sql-query/2026-05-29-sql-query-design-page-schema.png"
  alt="Nombre del esquema en la página de diseño del Proyecto"
  className="docs-screenshot"
/>

### Encontrar los nombres de las Tablas

Los nombres de las Tablas en la interfaz de Teable no se sincronizan automáticamente con los nombres físicos de las tablas de la base de datos. Consulta la interfaz de diseño del Proyecto para conocer el nombre real de la tabla en la base de datos.
...
La conexión a la base de datos está limitada únicamente al Proyecto actual. Los esquemas de PostgreSQL aíslan los permisos, lo que garantiza que solo puedas acceder a las Tablas de tu Proyecto.
...
<img
  ...
  alt="ID del Proyecto en TablePlus"
  className="docs-screenshot"
/>
