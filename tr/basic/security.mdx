...
<Tip>
Projenin tamamını `.tea` dosyası olarak, tek tek Tabloları CSV dosyaları olarak dışa aktararak veya verilerinizi Teable API üzerinden alarak Veritabanlarınızı elle yedekleyebilirsiniz.
</Tip>
