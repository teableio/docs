...
2. Scegli la **Tabella** da interrogare. Usa [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) se la Tabella si trova in un Progetto diversa.
...
- [Accesso tra Progetti](/it/basic/automation/actions/records/cross-base) — interroga Tabelle in altre Progetti
