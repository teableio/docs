...
<Steps>
  ...
  <Step title="Doppelte Werte entfernen (optional)">
    Wenn die Verknüpfung auf mehrere Datensätze zeigt, aktivieren Sie **Doppelte Werte entfernen**. Ein mehrfach vorkommender Wert bleibt dann nur an seiner ersten Position erhalten.
  </Step>
</Steps>
