---
title: "Genel Bakış"
description: "Bir Projede tablolar oluşturun, içe aktarın, paylaşın ve yönetin."
---

{/* mintlify-resync: 2026-05-14 */}
Her Proje, ilişkili verileri saklamak ve yönetmek için birden fazla tablo içerebilir. Teable tabloları veritabanı tablolarıyla eşdeğerdir; [elektronik tablolardan farklarını](/tr/compare/teable-vs-excel) anlamak Teable'dan en iyi şekilde yararlanmanıza yardımcı olur.

## Tablo Oluşturma ve Yönetme

### Tablo Ekleme

Bir Projede dizindeki `+` düğmesine tıklayın ve şunlardan birini seçin:
...
Diğer tablolar silmekte olduğunuz tabloya bağlanıyorsa onay iletişim kutusu, silme işleminden etkilenen alanları ait oldukları Proje ve tabloyla birlikte listeler. Tablo silindiğinde bu bağlantı alanları, bağlantılı kayıt başlıklarını koruyan tek satırlı metin alanlarına dönüştürülür; bunların üzerine kurulmuş arama veya toplama alanları ise çalışmayı durdurur.

### Çöp Kutusu

Silinen tabloları yönetmek için Projenin sol üst köşesindeki çöp kutusu simgesine tıklayın.
...
- **Geri yükle**: Tüm verileri korunmuş hâlde tabloyu Projeye geri getirir
...
- Geçerli görünümde görünen alanlarda yaklaşık arama yapmak için **Arama alanı** seçeneğini kapatın; o görünümde gizlenen alanlar eşleşmeye katılmaz. Genel arama tarih, onay kutusu veya düğme alanlarını içermez. Örneğiniz, genel aramanın kapsayabileceği alan sayısını da sınırlayabilir.
